...
-- VGA_R[8]	=>  Location: PIN_C9,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- VGA_G[8]	=>  Location: PIN_D7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- VGA_SYNC	=>  Location: PIN_AH29,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \current_state.00~feeder_combout\ : std_logic;
...
SIGNAL \next_state.01~0_combout\ : std_logic;
SIGNAL \current_state.01~q\ : std_logic;
SIGNAL \initx~2_combout\ : std_logic;
...
SIGNAL \xdone~DUPLICATE_q\ : std_logic;
...
SIGNAL \ALT_INV_xdone~DUPLICATE_q\ : std_logic;
...
\vga_u0|controller|controller_translator|Add1~9_sumout\ & \vga_u0|controller|xCounter[6]~DUPLICATE_q\ & \vga_u0|controller|xCounter[5]~DUPLICATE_q\ & \vga_u0|controller|xCounter\(4) & \vga_u0|controller|xCounter[3]~DUPLICATE_q\ & 
...
\vga_u0|controller|xCounter[6]~DUPLICATE_q\ & \vga_u0|controller|xCounter[5]~DUPLICATE_q\ & \vga_u0|controller|xCounter\(4) & \vga_u0|controller|xCounter[3]~DUPLICATE_q\ & \vga_u0|controller|xCounter\(2));
...
\ALT_INV_xdone~DUPLICATE_q\ <= NOT \xdone~DUPLICATE_q\;
...
\current_state.00~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \current_state.00~feeder_combout\ = VCC
...
-- pragma translate_on
PORT MAP (
	combout => \current_state.00~feeder_combout\);
...
PORT MAP (
	...
	d => \current_state.00~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \CLOCK_50~inputCLKENA0_outclk\,
	d => \Add0~1_sumout\,
	sclr => \ALT_INV_current_state.00~q\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => y(6));
...
-- Equation(s):
-- \Add0~21_sumout\ = SUM(( y(0) ) + ( \current_state.01~q\ ) + ( !VCC ))
-- \Add0~22\ = CARRY(( y(0) ) + ( \current_state.01~q\ ) + ( !VCC ))
...
-- Equation(s):
-- \Equal0~0_combout\ = ( \Add0~21_sumout\ & ( (\Add0~25_sumout\ & \current_state.00~q\) ) )
...
-- Equation(s):
-- \Equal0~1_combout\ = ( \Add0~5_sumout\ & ( !\Add0~13_sumout\ & ( (\Add0~1_sumout\ & (\Add0~17_sumout\ & (\Equal0~0_combout\ & \Add0~9_sumout\))) ) ) )
...
\next_state.01~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \next_state.01~0_combout\ = ( !\ydone~q\ & ( (\xdone~q\ & \current_state.10~q\) ) )
...
PORT MAP (
	...
	dataf => \ALT_INV_ydone~q\,
	combout => \next_state.01~0_combout\);

-- Location: FF_X37_Y80_N20
...
\initx~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \initx~2_combout\ = ( \current_state.01~q\ ) # ( !\current_state.01~q\ & ( !\current_state.00~q\ ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_current_state.00~q\,
	dataf => \ALT_INV_current_state.01~q\,
	combout => \initx~2_combout\);

-- Location: FF_X37_Y80_N50
\x[6]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Equation(s):
-- \Equal1~0_combout\ = ( !\current_state.01~q\ & ( (\current_state.00~q\ & (\Add1~13_sumout\ & (\Add1~17_sumout\ & \Add1~21_sumout\))) ) )
...
-- Equation(s):
-- \Equal1~1_combout\ = ( !\Add1~9_sumout\ & ( \Add1~25_sumout\ & ( (!\Add1~5_sumout\ & (\Add1~1_sumout\ & (\Equal1~0_combout\ & \Add1~29_sumout\))) ) ) )
...
-- Equation(s):
-- \Selector0~0_combout\ = ( !\xdone~DUPLICATE_q\ & ( \current_state.10~q\ ) )
...
PORT MAP (
	...
	dataf => \ALT_INV_xdone~DUPLICATE_q\,
...
-- Equation(s):
-- \vga_u0|writeEn~0_combout\ = ( y(6) & ( (\current_state.10~q\ & ((!y(4)) # ((!y(3)) # (!y(5))))) ) ) # ( !y(6) & ( \current_state.10~q\ ) )
...
-- Equation(s):
-- \vga_u0|user_input_translator|Add1~17_sumout\ = SUM(( !y(0) $ (!x(7) $ (y(2))) ) + ( \vga_u0|user_input_translator|Add1~15\ ) + ( \vga_u0|user_input_translator|Add1~14\ ))
-- \vga_u0|user_input_translator|Add1~18\ = CARRY(( !y(0) $ (!x(7) $ (y(2))) ) + ( \vga_u0|user_input_translator|Add1~15\ ) + ( \vga_u0|user_input_translator|Add1~14\ ))
-- \vga_u0|user_input_translator|Add1~19\ = SHARE((!y(0) & (x(7) & y(2))) # (y(0) & ((y(2)) # (x(7)))))
...
-- Equation(s):
-- \vga_u0|user_input_translator|Add1~29_sumout\ = SUM(( !y(3) $ (!y(5)) ) + ( \vga_u0|user_input_translator|Add1~27\ ) + ( \vga_u0|user_input_translator|Add1~26\ ))
-- \vga_u0|user_input_translator|Add1~30\ = CARRY(( !y(3) $ (!y(5)) ) + ( \vga_u0|user_input_translator|Add1~27\ ) + ( \vga_u0|user_input_translator|Add1~26\ ))
-- \vga_u0|user_input_translator|Add1~31\ = SHARE((y(3) & y(5)))
...
-- Equation(s):
-- \vga_u0|user_input_translator|Add1~33_sumout\ = SUM(( !y(6) $ (!y(4)) ) + ( \vga_u0|user_input_translator|Add1~31\ ) + ( \vga_u0|user_input_translator|Add1~30\ ))
-- \vga_u0|user_input_translator|Add1~34\ = CARRY(( !y(6) $ (!y(4)) ) + ( \vga_u0|user_input_translator|Add1~31\ ) + ( \vga_u0|user_input_translator|Add1~30\ ))
-- \vga_u0|user_input_translator|Add1~35\ = SHARE((y(6) & y(4)))
...
-- Equation(s):
-- \vga_u0|VideoMemory|auto_generated|decode2|w_anode105w\(2) = ( !x(5) & ( x(7) & ( (\vga_u0|writeEn~0_combout\ & (!\vga_u0|user_input_translator|Add1~5_sumout\ & (!\vga_u0|user_input_translator|Add1~1_sumout\ & !x(6)))) ) ) ) # ( x(5) & ( !x(7) & ( 
-- (\vga_u0|writeEn~0_combout\ & (!\vga_u0|user_input_translator|Add1~5_sumout\ & !\vga_u0|user_input_translator|Add1~1_sumout\)) ) ) ) # ( !x(5) & ( !x(7) & ( (\vga_u0|writeEn~0_combout\ & (!\vga_u0|user_input_translator|Add1~5_sumout\ & 
-- !\vga_u0|user_input_translator|Add1~1_sumout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100000001000000010000000100000001000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \vga_u0|controller|Equal0~1_combout\ = ( \vga_u0|controller|xCounter\(1) & ( !\vga_u0|controller|xCounter\(6) & ( (!\vga_u0|controller|xCounter\(5) & \vga_u0|controller|xCounter\(0)) ) ) )
...
-- Equation(s):
-- \vga_u0|controller|Equal0~2_combout\ = ( \vga_u0|controller|Equal0~0_combout\ & ( (\vga_u0|controller|Equal0~1_combout\ & \vga_u0|controller|xCounter\(2)) ) )
...
-- Equation(s):
-- \vga_u0|controller|Add0~25_sumout\ = SUM(( \vga_u0|controller|xCounter\(1) ) + ( GND ) + ( \vga_u0|controller|Add0~38\ ))
-- \vga_u0|controller|Add0~26\ = CARRY(( \vga_u0|controller|xCounter\(1) ) + ( GND ) + ( \vga_u0|controller|Add0~38\ ))
...
-- Equation(s):
-- \vga_u0|controller|Add0~5_sumout\ = SUM(( \vga_u0|controller|xCounter\(2) ) + ( GND ) + ( \vga_u0|controller|Add0~26\ ))
-- \vga_u0|controller|Add0~6\ = CARRY(( \vga_u0|controller|xCounter\(2) ) + ( GND ) + ( \vga_u0|controller|Add0~26\ ))
...
-- Equation(s):
-- \vga_u0|controller|Add0~21_sumout\ = SUM(( \vga_u0|controller|xCounter\(4) ) + ( GND ) + ( \vga_u0|controller|Add0~2\ ))
-- \vga_u0|controller|Add0~22\ = CARRY(( \vga_u0|controller|xCounter\(4) ) + ( GND ) + ( \vga_u0|controller|Add0~2\ ))
...
-- Equation(s):
-- \vga_u0|controller|Add0~33_sumout\ = SUM(( \vga_u0|controller|xCounter\(5) ) + ( GND ) + ( \vga_u0|controller|Add0~22\ ))
-- \vga_u0|controller|Add0~34\ = CARRY(( \vga_u0|controller|xCounter\(5) ) + ( GND ) + ( \vga_u0|controller|Add0~22\ ))
...
-- Equation(s):
-- \vga_u0|controller|Equal0~0_combout\ = ( \vga_u0|controller|xCounter\(3) & ( (\vga_u0|controller|xCounter\(8) & (\vga_u0|controller|xCounter\(9) & (\vga_u0|controller|xCounter\(4) & !\vga_u0|controller|xCounter\(7)))) ) )
...
-- Equation(s):
-- \vga_u0|controller|always1~1_combout\ = ( !\vga_u0|controller|yCounter\(1) & ( (\vga_u0|controller|yCounter\(2) & (!\vga_u0|controller|yCounter\(0) & (!\vga_u0|controller|yCounter\(4) & \vga_u0|controller|yCounter\(3)))) ) )
...
PORT MAP (
	...
	datad => \vga_u0|controller|ALT_INV_yCounter\(3),
	dataf => \vga_u0|controller|ALT_INV_yCounter\(1),
...
-- Equation(s):
-- \vga_u0|controller|always1~0_combout\ = ( \vga_u0|controller|yCounter\(9) & ( (!\vga_u0|controller|yCounter\(8) & (!\vga_u0|controller|yCounter[6]~DUPLICATE_q\ & (!\vga_u0|controller|yCounter[7]~DUPLICATE_q\ & 
-- !\vga_u0|controller|yCounter[5]~DUPLICATE_q\))) ) )
...
PORT MAP (
	...
	dataf => \vga_u0|controller|ALT_INV_yCounter\(9),
	combout => \vga_u0|controller|always1~0_combout\);

-- Location: LABCELL_X36_Y79_N24
\vga_u0|controller|always1~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \vga_u0|controller|always1~2_combout\ = ( \vga_u0|controller|always1~0_combout\ & ( (\vga_u0|controller|Equal0~0_combout\ & (\vga_u0|controller|Equal0~1_combout\ & (\vga_u0|controller|xCounter\(2) & \vga_u0|controller|always1~1_combout\))) ) )
...
PORT MAP (
	...
	datab => \vga_u0|controller|ALT_INV_Equal0~1_combout\,
	datac => \vga_u0|controller|ALT_INV_xCounter\(2),
	datad => \vga_u0|controller|ALT_INV_always1~1_combout\,
	dataf => \vga_u0|controller|ALT_INV_always1~0_combout\,
...
-- Equation(s):
-- \vga_u0|controller|controller_translator|Add1~17_sumout\ = SUM(( !\vga_u0|controller|yCounter[2]~DUPLICATE_q\ $ (!\vga_u0|controller|xCounter\(9) $ (\vga_u0|controller|yCounter[4]~DUPLICATE_q\)) ) + ( \vga_u0|controller|controller_translator|Add1~15\ ) + 
-- ( \vga_u0|controller|controller_translator|Add1~14\ ))
-- \vga_u0|controller|controller_translator|Add1~18\ = CARRY(( !\vga_u0|controller|yCounter[2]~DUPLICATE_q\ $ (!\vga_u0|controller|xCounter\(9) $ (\vga_u0|controller|yCounter[4]~DUPLICATE_q\)) ) + ( \vga_u0|controller|controller_translator|Add1~15\ ) + ( 
-- \vga_u0|controller|controller_translator|Add1~14\ ))
-- \vga_u0|controller|controller_translator|Add1~19\ = SHARE((!\vga_u0|controller|yCounter[2]~DUPLICATE_q\ & (\vga_u0|controller|xCounter\(9) & \vga_u0|controller|yCounter[4]~DUPLICATE_q\)) # (\vga_u0|controller|yCounter[2]~DUPLICATE_q\ & 
-- ((\vga_u0|controller|yCounter[4]~DUPLICATE_q\) # (\vga_u0|controller|xCounter\(9)))))
...
-- Equation(s):
-- \vga_u0|controller|controller_translator|Add1~25_sumout\ = SUM(( !\vga_u0|controller|yCounter[4]~DUPLICATE_q\ $ (!\vga_u0|controller|yCounter\(6)) ) + ( \vga_u0|controller|controller_translator|Add1~23\ ) + ( 
-- \vga_u0|controller|controller_translator|Add1~22\ ))
-- \vga_u0|controller|controller_translator|Add1~26\ = CARRY(( !\vga_u0|controller|yCounter[4]~DUPLICATE_q\ $ (!\vga_u0|controller|yCounter\(6)) ) + ( \vga_u0|controller|controller_translator|Add1~23\ ) + ( \vga_u0|controller|controller_translator|Add1~22\ 
-- ))
-- \vga_u0|controller|controller_translator|Add1~27\ = SHARE((\vga_u0|controller|yCounter[4]~DUPLICATE_q\ & \vga_u0|controller|yCounter\(6)))
...
-- Equation(s):
-- \vga_u0|controller|controller_translator|Add1~29_sumout\ = SUM(( !\vga_u0|controller|yCounter[5]~DUPLICATE_q\ $ (!\vga_u0|controller|yCounter\(7)) ) + ( \vga_u0|controller|controller_translator|Add1~27\ ) + ( 
-- \vga_u0|controller|controller_translator|Add1~26\ ))
-- \vga_u0|controller|controller_translator|Add1~30\ = CARRY(( !\vga_u0|controller|yCounter[5]~DUPLICATE_q\ $ (!\vga_u0|controller|yCounter\(7)) ) + ( \vga_u0|controller|controller_translator|Add1~27\ ) + ( \vga_u0|controller|controller_translator|Add1~26\ 
-- ))
-- \vga_u0|controller|controller_translator|Add1~31\ = SHARE((\vga_u0|controller|yCounter[5]~DUPLICATE_q\ & \vga_u0|controller|yCounter\(7)))
...
-- Equation(s):
-- \vga_u0|VideoMemory|auto_generated|decode2|w_anode126w\(2) = ( \vga_u0|user_input_translator|Add1~1_sumout\ & ( !\vga_u0|user_input_translator|Add1~5_sumout\ & ( (\vga_u0|writeEn~0_combout\ & ((!x(7)) # ((!x(5) & !x(6))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000011100000101000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => ALT_INV_x(7),
...
-- Equation(s):
-- \vga_u0|controller|on_screen~0_combout\ = ( \vga_u0|controller|xCounter[7]~DUPLICATE_q\ & ( \vga_u0|controller|xCounter\(9) ) ) # ( !\vga_u0|controller|xCounter[7]~DUPLICATE_q\ & ( (\vga_u0|controller|xCounter\(8) & \vga_u0|controller|xCounter\(9)) ) )
...
PORT MAP (
	dataa => \vga_u0|controller|ALT_INV_xCounter\(8),
	datab => \vga_u0|controller|ALT_INV_xCounter\(9),
	dataf => \vga_u0|controller|ALT_INV_xCounter[7]~DUPLICATE_q\,
...
-- Equation(s):
-- \vga_u0|controller|LessThan7~0_combout\ = ( \vga_u0|controller|yCounter[7]~DUPLICATE_q\ & ( (!\vga_u0|controller|yCounter\(9) & ((!\vga_u0|controller|yCounter[6]~DUPLICATE_q\) # ((!\vga_u0|controller|yCounter\(8)) # 
-- (!\vga_u0|controller|yCounter[5]~DUPLICATE_q\)))) ) ) # ( !\vga_u0|controller|yCounter[7]~DUPLICATE_q\ & ( !\vga_u0|controller|yCounter\(9) ) )
...
-- Equation(s):
-- \vga_u0|controller|on_screen~1_combout\ = ( !\vga_u0|controller|xCounter\(8) & ( (!\vga_u0|controller|xCounter\(1) & (!\vga_u0|controller|xCounter\(4) & (!\vga_u0|controller|xCounter\(5) & !\vga_u0|controller|xCounter[6]~DUPLICATE_q\))) ) )
...
-- Equation(s):
-- \vga_u0|controller|on_screen~2_combout\ = ( \vga_u0|controller|xCounter\(3) & ( (!\vga_u0|controller|on_screen~0_combout\ & \vga_u0|controller|LessThan7~0_combout\) ) ) # ( !\vga_u0|controller|xCounter\(3) & ( (\vga_u0|controller|LessThan7~0_combout\ & 
-- ((!\vga_u0|controller|on_screen~0_combout\) # ((!\vga_u0|controller|xCounter\(2) & \vga_u0|controller|on_screen~1_combout\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010001000110010001000100011001000100010001000100010001000100010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \vga_u0|VideoMemory|auto_generated|decode2|w_anode118w\(2) = ( \vga_u0|user_input_translator|Add1~5_sumout\ & ( !\vga_u0|user_input_translator|Add1~1_sumout\ & ( (\vga_u0|writeEn~0_combout\ & ((!x(7)) # ((!x(5) & !x(6))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000001110101000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => ALT_INV_x(7),
	...
	datae => \vga_u0|user_input_translator|ALT_INV_Add1~5_sumout\,
...
-- Equation(s):
-- \vga_u0|controller|VGA_R[0]~0_combout\ = ( \vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ( \vga_u0|VideoMemory|auto_generated|ram_block1a5~portbdataout\ & ( (\vga_u0|VideoMemory|auto_generated|ram_block1a8\ & 
-- \vga_u0|controller|on_screen~2_combout\) ) ) ) # ( !\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ( \vga_u0|VideoMemory|auto_generated|ram_block1a5~portbdataout\ & ( (\vga_u0|controller|on_screen~2_combout\ & 
-- ((\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0)) # (\vga_u0|VideoMemory|auto_generated|ram_block1a2~portbdataout\))) ) ) ) # ( \vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ( 
-- !\vga_u0|VideoMemory|auto_generated|ram_block1a5~portbdataout\ & ( (\vga_u0|VideoMemory|auto_generated|ram_block1a8\ & \vga_u0|controller|on_screen~2_combout\) ) ) ) # ( !\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ( 
-- !\vga_u0|VideoMemory|auto_generated|ram_block1a5~portbdataout\ & ( (\vga_u0|VideoMemory|auto_generated|ram_block1a2~portbdataout\ & (\vga_u0|controller|on_screen~2_combout\ & !\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010100000000000000110000001100000101000011110000001100000011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \vga_u0|VideoMemory|auto_generated|ALT_INV_ram_block1a2~portbdataout\,
	datab => \vga_u0|VideoMemory|auto_generated|ALT_INV_ram_block1a8\,
	datac => \vga_u0|controller|ALT_INV_on_screen~2_combout\,
...
-- Equation(s):
-- \vga_u0|controller|VGA_G[0]~0_combout\ = ( \vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ( \vga_u0|VideoMemory|auto_generated|ram_block1a1~portbdataout\ & ( (\vga_u0|controller|on_screen~2_combout\ & 
-- \vga_u0|VideoMemory|auto_generated|ram_block1a7~portbdataout\) ) ) ) # ( !\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ( \vga_u0|VideoMemory|auto_generated|ram_block1a1~portbdataout\ & ( (\vga_u0|controller|on_screen~2_combout\ & 
...
-- !\vga_u0|VideoMemory|auto_generated|ram_block1a1~portbdataout\ & ( (\vga_u0|controller|on_screen~2_combout\ & \vga_u0|VideoMemory|auto_generated|ram_block1a7~portbdataout\) ) ) ) # ( !\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ( 
-- !\vga_u0|VideoMemory|auto_generated|ram_block1a1~portbdataout\ & ( (\vga_u0|controller|on_screen~2_combout\ & (\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & \vga_u0|VideoMemory|auto_generated|ram_block1a4~portbdataout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000100000001000000000101010101000101010001010000000001010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \vga_u0|controller|ALT_INV_on_screen~2_combout\,
...
-- Equation(s):
-- \vga_u0|controller|VGA_B[0]~0_combout\ = ( \vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & ( \vga_u0|VideoMemory|auto_generated|ram_block1a3~portbdataout\ & ( (\vga_u0|controller|on_screen~2_combout\ & 
...
-- \vga_u0|VideoMemory|auto_generated|ram_block1a3~portbdataout\ & ( (\vga_u0|controller|on_screen~2_combout\ & ((!\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ((\vga_u0|VideoMemory|auto_generated|ram_block1a0~portbdataout\))) # 
-- (\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & (\vga_u0|VideoMemory|auto_generated|ram_block1a6~portbdataout\)))) ) ) ) # ( \vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & ( 
-- !\vga_u0|VideoMemory|auto_generated|ram_block1a3~portbdataout\ & ( (\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & (\vga_u0|VideoMemory|auto_generated|ram_block1a6~portbdataout\ & \vga_u0|controller|on_screen~2_combout\)) ) ) ) # ( 
-- !\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & ( !\vga_u0|VideoMemory|auto_generated|ram_block1a3~portbdataout\ & ( (\vga_u0|controller|on_screen~2_combout\ & ((!\vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000100001011000000010000000100000001000010110000101100001011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datac => \vga_u0|controller|ALT_INV_on_screen~2_combout\,
	datad => \vga_u0|VideoMemory|auto_generated|ALT_INV_ram_block1a0~portbdataout\,
...
-- Equation(s):
-- \vga_u0|controller|VGA_HS1~1_combout\ = ( \vga_u0|controller|xCounter[8]~DUPLICATE_q\ & ( \vga_u0|controller|xCounter\(9) ) ) # ( !\vga_u0|controller|xCounter[8]~DUPLICATE_q\ & ( \vga_u0|controller|xCounter\(9) & ( 
-- (!\vga_u0|controller|xCounter[7]~DUPLICATE_q\) # ((!\vga_u0|controller|xCounter\(6) & (!\vga_u0|controller|xCounter\(5) & !\vga_u0|controller|VGA_HS1~0_combout\)) # (\vga_u0|controller|xCounter\(6) & (\vga_u0|controller|xCounter\(5) & 
-- \vga_u0|controller|VGA_HS1~0_combout\))) ) ) ) # ( \vga_u0|controller|xCounter[8]~DUPLICATE_q\ & ( !\vga_u0|controller|xCounter\(9) ) ) # ( !\vga_u0|controller|xCounter[8]~DUPLICATE_q\ & ( !\vga_u0|controller|xCounter\(9) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111111111111111111111111111100000011111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \vga_u0|controller|ALT_INV_xCounter[8]~DUPLICATE_q\,
...
-- Equation(s):
-- \vga_u0|controller|VGA_VS1~0_combout\ = ( \vga_u0|controller|yCounter\(3) & ( \vga_u0|controller|yCounter\(1) & ( (!\vga_u0|controller|yCounter\(9) & (!\vga_u0|controller|yCounter\(0) & (\vga_u0|controller|yCounter\(2) & 
-- !\vga_u0|controller|yCounter\(4)))) ) ) ) # ( \vga_u0|controller|yCounter\(3) & ( !\vga_u0|controller|yCounter\(1) & ( (!\vga_u0|controller|yCounter\(9) & (\vga_u0|controller|yCounter\(0) & (\vga_u0|controller|yCounter\(2) & 
...
-- Equation(s):
-- \vga_u0|controller|VGA_VS1~1_combout\ = ( \vga_u0|controller|VGA_VS1~0_combout\ & ( (!\vga_u0|controller|yCounter[8]~DUPLICATE_q\) # ((!\vga_u0|controller|yCounter[6]~DUPLICATE_q\) # ((!\vga_u0|controller|yCounter[5]~DUPLICATE_q\) # 
-- (!\vga_u0|controller|yCounter\(7)))) ) ) # ( !\vga_u0|controller|VGA_VS1~0_combout\ )
...
PORT MAP (
	...
	datad => \vga_u0|controller|ALT_INV_yCounter\(7),
	dataf => \vga_u0|controller|ALT_INV_VGA_VS1~0_combout\,
