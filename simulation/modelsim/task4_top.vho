...
-- VGA_R[8]	=>  Location: PIN_AC30,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- VGA_R[9]	=>  Location: PIN_Y27,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- VGA_SYNC	=>  Location: PIN_K8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \colour[2]~0_combout\ : std_logic;
...
SIGNAL \DUT|x[2]~1_combout\ : std_logic;
...
SIGNAL \DUT|vga_u0|controller|xCounter[2]~DUPLICATE_q\ : std_logic;
...
SIGNAL \DUT|vga_u0|controller|xCounter[7]~DUPLICATE_q\ : std_logic;
...
SIGNAL \colour[2]~_wirecell_combout\ : std_logic;
...
SIGNAL \DUT|vga_u0|controller|ALT_INV_xCounter[2]~DUPLICATE_q\ : std_logic;
SIGNAL \DUT|vga_u0|controller|ALT_INV_xCounter[7]~DUPLICATE_q\ : std_logic;
...
SIGNAL ALT_INV_centerx : std_logic_vector(4 DOWNTO 4);
...
SIGNAL \DUT|ALT_INV_x[2]~1_combout\ : std_logic;
...
SIGNAL ALT_INV_colour : std_logic_vector(2 DOWNTO 1);
...
\DUT|vga_u0|controller|controller_translator|Add1~13_sumout\ & \DUT|vga_u0|controller|controller_translator|Add1~9_sumout\ & \DUT|vga_u0|controller|xCounter[6]~DUPLICATE_q\ & \DUT|vga_u0|controller|xCounter\(5) & \DUT|vga_u0|controller|xCounter\(4) & 
\DUT|vga_u0|controller|xCounter\(3) & \DUT|vga_u0|controller|xCounter[2]~DUPLICATE_q\);
...
\DUT|vga_u0|controller|controller_translator|Add1~9_sumout\ & \DUT|vga_u0|controller|xCounter[6]~DUPLICATE_q\ & \DUT|vga_u0|controller|xCounter\(5) & \DUT|vga_u0|controller|xCounter\(4) & \DUT|vga_u0|controller|xCounter\(3) & 
\DUT|vga_u0|controller|xCounter[2]~DUPLICATE_q\);
...
\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a6_PORTADATAIN_bus\ <= (gnd & \colour[2]~_wirecell_combout\);
...
\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a3_PORTADATAIN_bus\(0) <= \colour[2]~_wirecell_combout\;
...
\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a0_PORTADATAIN_bus\(0) <= \colour[2]~_wirecell_combout\;
...
\DUT|vga_u0|controller|ALT_INV_xCounter[2]~DUPLICATE_q\ <= NOT \DUT|vga_u0|controller|xCounter[2]~DUPLICATE_q\;
\DUT|vga_u0|controller|ALT_INV_xCounter[7]~DUPLICATE_q\ <= NOT \DUT|vga_u0|controller|xCounter[7]~DUPLICATE_q\;
...
ALT_INV_centerx(4) <= NOT centerx(4);
...
\DUT|ALT_INV_x[2]~1_combout\ <= NOT \DUT|x[2]~1_combout\;
...
-- Equation(s):
-- \DUT|loady~1_combout\ = ( \DUT|current_state.01~q\ ) # ( !\DUT|current_state.01~q\ & ( !\DUT|current_state.00~q\ ) )
...
-- Equation(s):
-- \DUT|Add10~5_sumout\ = SUM(( (\DUT|offset_y\(0) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( !VCC ))
-- \DUT|Add10~6\ = CARRY(( (\DUT|offset_y\(0) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|offset_y~2_combout\ = (\DUT|offset_y\(0) & ((!\DUT|loady~q\) # (!\DUT|initx~q\)))
...
-- Equation(s):
-- \DUT|Add10~9_sumout\ = SUM(( (\DUT|offset_y\(1) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add10~6\ ))
-- \DUT|Add10~10\ = CARRY(( (\DUT|offset_y\(1) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add10~6\ ))
...
-- Equation(s):
-- \DUT|offset_y~3_combout\ = (\DUT|offset_y\(1) & ((!\DUT|initx~q\) # (!\DUT|loady~q\)))
...
-- Equation(s):
-- \DUT|Add10~21_sumout\ = SUM(( (\DUT|offset_y\(2) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add10~10\ ))
-- \DUT|Add10~22\ = CARRY(( (\DUT|offset_y\(2) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add10~10\ ))
...
-- Equation(s):
-- \DUT|offset_y~4_combout\ = (\DUT|offset_y\(2) & ((!\DUT|loady~q\) # (!\DUT|initx~q\)))
...
-- Equation(s):
-- \DUT|Add10~1_sumout\ = SUM(( (\DUT|offset_y\(3) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add10~22\ ))
-- \DUT|Add10~2\ = CARRY(( (\DUT|offset_y\(3) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add10~22\ ))
...
-- Equation(s):
-- \DUT|offset_y~1_combout\ = (\DUT|offset_y\(3) & ((!\DUT|loady~q\) # (!\DUT|initx~q\)))
...
-- Equation(s):
-- \DUT|Add10~17_sumout\ = SUM(( (\DUT|offset_y\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add10~2\ ))
-- \DUT|Add10~18\ = CARRY(( (\DUT|offset_y\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add10~2\ ))
...
-- Equation(s):
-- \DUT|offset_y~6_combout\ = ( \DUT|offset_y\(4) & ( (!\DUT|initx~q\) # (!\DUT|loady~q\) ) )
...
-- Equation(s):
-- \DUT|Add10~25_sumout\ = SUM(( (\DUT|offset_y\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add10~18\ ))
-- \DUT|Add10~26\ = CARRY(( (\DUT|offset_y\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add10~18\ ))
...
-- Equation(s):
-- \DUT|offset_y~7_combout\ = (\DUT|offset_y\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\)))
...
-- Equation(s):
-- \DUT|Add10~13_sumout\ = SUM(( (\DUT|offset_y\(6) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( GND ) + ( \DUT|Add10~26\ ))
...
-- Equation(s):
-- \DUT|Add15~5_sumout\ = SUM(( VCC ) + ( (\DUT|crit\(0)) # (\DUT|initx~q\) ) + ( !VCC ))
-- \DUT|Add15~6\ = CARRY(( VCC ) + ( (\DUT|crit\(0)) # (\DUT|initx~q\) ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|crit~1_combout\ = ( \DUT|crit\(0) & ( \DUT|initx~q\ & ( (!\DUT|current_state.10~q\) # ((!\DUT|LessThan0~3_combout\ & ((\DUT|Add11~5_sumout\))) # (\DUT|LessThan0~3_combout\ & (\DUT|Add15~5_sumout\))) ) ) ) # ( !\DUT|crit\(0) & ( \DUT|initx~q\ & ( 
-- (!\DUT|current_state.10~q\) # ((!\DUT|LessThan0~3_combout\ & ((\DUT|Add11~5_sumout\))) # (\DUT|LessThan0~3_combout\ & (\DUT|Add15~5_sumout\))) ) ) ) # ( \DUT|crit\(0) & ( !\DUT|initx~q\ & ( (!\DUT|current_state.10~q\) # ((!\DUT|LessThan0~3_combout\ & 
-- ((\DUT|Add11~5_sumout\))) # (\DUT|LessThan0~3_combout\ & (\DUT|Add15~5_sumout\))) ) ) ) # ( !\DUT|crit\(0) & ( !\DUT|initx~q\ & ( (\DUT|current_state.10~q\ & ((!\DUT|LessThan0~3_combout\ & ((\DUT|Add11~5_sumout\))) # (\DUT|LessThan0~3_combout\ & 
-- (\DUT|Add15~5_sumout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000011101111111110001110111111111000111011111111100011101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add15~5_sumout\,
...
-- Equation(s):
-- \DUT|LessThan0~1_combout\ = ( !\DUT|crit\(3) & ( !\DUT|crit\(7) & ( (!\DUT|crit\(6) & (!\DUT|crit\(2) & (!\DUT|crit\(0) & !\DUT|crit\(5)))) ) ) )
...
-- Equation(s):
-- \DUT|offset_x~5_combout\ = ( \DUT|Add13~9_sumout\ & ( ((\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~2_combout\) # (!\DUT|LessThan0~1_combout\)))) # (\DUT|offset_x~2_combout\) ) ) # ( !\DUT|Add13~9_sumout\ & ( (\DUT|offset_x~2_combout\ & 
...
-- Equation(s):
-- \DUT|Add13~5_sumout\ = SUM(( VCC ) + ( (\DUT|offset_x\(0) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( !VCC ))
-- \DUT|Add13~6\ = CARRY(( VCC ) + ( (\DUT|offset_x\(0) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|offset_x~1_combout\ = ( \DUT|offset_x\(0) & ( (!\DUT|initx~q\) # (!\DUT|loady~q\) ) )
...
-- Equation(s):
-- \DUT|offset_x~4_combout\ = ( \DUT|LessThan0~1_combout\ & ( (!\DUT|LessThan0~2_combout\ & ((!\DUT|LessThan0~0_combout\ & ((\DUT|offset_x~1_combout\))) # (\DUT|LessThan0~0_combout\ & (\DUT|Add13~5_sumout\)))) # (\DUT|LessThan0~2_combout\ & 
-- (((\DUT|offset_x~1_combout\)))) ) ) # ( !\DUT|LessThan0~1_combout\ & ( (!\DUT|LessThan0~0_combout\ & ((\DUT|offset_x~1_combout\))) # (\DUT|LessThan0~0_combout\ & (\DUT|Add13~5_sumout\)) ) )
...
-- Equation(s):
-- \DUT|Add13~9_sumout\ = SUM(( VCC ) + ( (\DUT|offset_x\(1) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add13~6\ ))
-- \DUT|Add13~10\ = CARRY(( VCC ) + ( (\DUT|offset_x\(1) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add13~6\ ))
...
-- Equation(s):
-- \DUT|Add14~29_sumout\ = SUM(( !\DUT|Add10~5_sumout\ $ (!\DUT|Add13~5_sumout\) ) + ( !VCC ) + ( !VCC ))
-- \DUT|Add14~30\ = CARRY(( !\DUT|Add10~5_sumout\ $ (!\DUT|Add13~5_sumout\) ) + ( !VCC ) + ( !VCC ))
-- \DUT|Add14~31\ = SHARE((!\DUT|Add13~5_sumout\) # (\DUT|Add10~5_sumout\))
...
-- Equation(s):
-- \DUT|Add14~5_sumout\ = SUM(( !\DUT|Add10~9_sumout\ $ (\DUT|Add13~9_sumout\) ) + ( \DUT|Add14~31\ ) + ( \DUT|Add14~30\ ))
-- \DUT|Add14~6\ = CARRY(( !\DUT|Add10~9_sumout\ $ (\DUT|Add13~9_sumout\) ) + ( \DUT|Add14~31\ ) + ( \DUT|Add14~30\ ))
...
-- Equation(s):
-- \DUT|Add15~33_sumout\ = SUM(( \DUT|Add14~29_sumout\ ) + ( (!\DUT|initx~q\ & \DUT|crit[1]~DUPLICATE_q\) ) + ( \DUT|Add15~6\ ))
-- \DUT|Add15~34\ = CARRY(( \DUT|Add14~29_sumout\ ) + ( (!\DUT|initx~q\ & \DUT|crit[1]~DUPLICATE_q\) ) + ( \DUT|Add15~6\ ))
...
-- Equation(s):
-- \DUT|Add11~33_sumout\ = SUM(( \DUT|Add10~5_sumout\ ) + ( (!\DUT|initx~q\ & \DUT|crit[1]~DUPLICATE_q\) ) + ( \DUT|Add11~6\ ))
-- \DUT|Add11~34\ = CARRY(( \DUT|Add10~5_sumout\ ) + ( (!\DUT|initx~q\ & \DUT|crit[1]~DUPLICATE_q\) ) + ( \DUT|Add11~6\ ))
...
-- Equation(s):
-- \DUT|Add11~9_sumout\ = SUM(( \DUT|Add10~9_sumout\ ) + ( (\DUT|crit\(2)) # (\DUT|initx~q\) ) + ( \DUT|Add11~34\ ))
-- \DUT|Add11~10\ = CARRY(( \DUT|Add10~9_sumout\ ) + ( (\DUT|crit\(2)) # (\DUT|initx~q\) ) + ( \DUT|Add11~34\ ))
...
-- Equation(s):
-- \DUT|crit~2_combout\ = ( \DUT|crit\(2) & ( \DUT|current_state.10~q\ & ( (!\DUT|LessThan0~3_combout\ & ((\DUT|Add11~9_sumout\))) # (\DUT|LessThan0~3_combout\ & (\DUT|Add15~9_sumout\)) ) ) ) # ( !\DUT|crit\(2) & ( \DUT|current_state.10~q\ & ( 
-- (!\DUT|LessThan0~3_combout\ & ((\DUT|Add11~9_sumout\))) # (\DUT|LessThan0~3_combout\ & (\DUT|Add15~9_sumout\)) ) ) ) # ( \DUT|crit\(2) & ( !\DUT|current_state.10~q\ ) ) # ( !\DUT|crit\(2) & ( !\DUT|current_state.10~q\ & ( \DUT|initx~q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011111111111111111111111100011101000111010001110100011101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add15~9_sumout\,
	datab => \DUT|ALT_INV_LessThan0~3_combout\,
	datac => \DUT|ALT_INV_Add11~9_sumout\,
...
-- Equation(s):
-- \DUT|Add11~13_sumout\ = SUM(( \DUT|Add10~21_sumout\ ) + ( (\DUT|crit\(3)) # (\DUT|initx~q\) ) + ( \DUT|Add11~10\ ))
-- \DUT|Add11~14\ = CARRY(( \DUT|Add10~21_sumout\ ) + ( (\DUT|crit\(3)) # (\DUT|initx~q\) ) + ( \DUT|Add11~10\ ))
...
-- Equation(s):
-- \DUT|offset_x~6_combout\ = ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x\(2))
...
-- Equation(s):
-- \DUT|Add13~21_sumout\ = SUM(( VCC ) + ( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x\(2)) ) + ( \DUT|Add13~10\ ))
-- \DUT|Add13~22\ = CARRY(( VCC ) + ( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x\(2)) ) + ( \DUT|Add13~10\ ))
...
-- Equation(s):
-- \DUT|Add14~9_sumout\ = SUM(( !\DUT|Add13~21_sumout\ $ (\DUT|Add10~21_sumout\) ) + ( \DUT|Add14~7\ ) + ( \DUT|Add14~6\ ))
-- \DUT|Add14~10\ = CARRY(( !\DUT|Add13~21_sumout\ $ (\DUT|Add10~21_sumout\) ) + ( \DUT|Add14~7\ ) + ( \DUT|Add14~6\ ))
-- \DUT|Add14~11\ = SHARE((!\DUT|Add13~21_sumout\ & \DUT|Add10~21_sumout\))
...
-- pragma translate_on
PORT MAP (
	datab => \DUT|ALT_INV_Add13~21_sumout\,
...
-- Equation(s):
-- \DUT|crit~3_combout\ = ( \DUT|crit\(3) & ( \DUT|current_state.10~q\ & ( (!\DUT|LessThan0~3_combout\ & (\DUT|Add11~13_sumout\)) # (\DUT|LessThan0~3_combout\ & ((\DUT|Add15~13_sumout\))) ) ) ) # ( !\DUT|crit\(3) & ( \DUT|current_state.10~q\ & ( 
-- (!\DUT|LessThan0~3_combout\ & (\DUT|Add11~13_sumout\)) # (\DUT|LessThan0~3_combout\ & ((\DUT|Add15~13_sumout\))) ) ) ) # ( \DUT|crit\(3) & ( !\DUT|current_state.10~q\ ) ) # ( !\DUT|crit\(3) & ( !\DUT|current_state.10~q\ & ( \DUT|initx~q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101111111111111111100110011000011110011001100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datab => \DUT|ALT_INV_Add11~13_sumout\,
	datac => \DUT|ALT_INV_Add15~13_sumout\,
...
-- Equation(s):
-- \DUT|Add11~29_sumout\ = SUM(( \DUT|Add10~1_sumout\ ) + ( (!\DUT|initx~q\ & \DUT|crit[4]~DUPLICATE_q\) ) + ( \DUT|Add11~14\ ))
-- \DUT|Add11~30\ = CARRY(( \DUT|Add10~1_sumout\ ) + ( (!\DUT|initx~q\ & \DUT|crit[4]~DUPLICATE_q\) ) + ( \DUT|Add11~14\ ))
...
PORT MAP (
	...
	datad => \DUT|ALT_INV_Add10~1_sumout\,
	cin => \DUT|Add11~14\,
...
-- Equation(s):
-- \DUT|offset_x~0_combout\ = ( \DUT|offset_x\(3) & ( (!\DUT|initx~q\) # (!\DUT|loady~q\) ) )
...
-- Equation(s):
-- \DUT|offset_x~3_combout\ = ( \DUT|LessThan0~2_combout\ & ( (!\DUT|LessThan0~0_combout\ & (((\DUT|offset_x~0_combout\)))) # (\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~1_combout\ & (\DUT|Add13~1_sumout\)) # (\DUT|LessThan0~1_combout\ & 
-- ((\DUT|offset_x~0_combout\))))) ) ) # ( !\DUT|LessThan0~2_combout\ & ( (!\DUT|LessThan0~0_combout\ & ((\DUT|offset_x~0_combout\))) # (\DUT|LessThan0~0_combout\ & (\DUT|Add13~1_sumout\)) ) )
...
-- Equation(s):
-- \DUT|Add13~1_sumout\ = SUM(( VCC ) + ( (\DUT|offset_x\(3) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add13~22\ ))
-- \DUT|Add13~2\ = CARRY(( VCC ) + ( (\DUT|offset_x\(3) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add13~22\ ))
...
-- Equation(s):
-- \DUT|Add14~25_sumout\ = SUM(( !\DUT|Add10~1_sumout\ $ (\DUT|Add13~1_sumout\) ) + ( \DUT|Add14~11\ ) + ( \DUT|Add14~10\ ))
-- \DUT|Add14~26\ = CARRY(( !\DUT|Add10~1_sumout\ $ (\DUT|Add13~1_sumout\) ) + ( \DUT|Add14~11\ ) + ( \DUT|Add14~10\ ))
-- \DUT|Add14~27\ = SHARE((\DUT|Add10~1_sumout\ & !\DUT|Add13~1_sumout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add10~1_sumout\,
	datac => \DUT|ALT_INV_Add13~1_sumout\,
	cin => \DUT|Add14~10\,
...
-- Equation(s):
-- \DUT|Add11~17_sumout\ = SUM(( \DUT|Add10~17_sumout\ ) + ( (\DUT|crit\(5)) # (\DUT|initx~q\) ) + ( \DUT|Add11~30\ ))
-- \DUT|Add11~18\ = CARRY(( \DUT|Add10~17_sumout\ ) + ( (\DUT|crit\(5)) # (\DUT|initx~q\) ) + ( \DUT|Add11~30\ ))
...
-- Equation(s):
-- \DUT|offset_x~9_combout\ = ( \DUT|initx~q\ & ( (\DUT|offset_x\(4)) # (\DUT|loady~q\) ) ) # ( !\DUT|initx~q\ & ( \DUT|offset_x\(4) ) )
...
-- Equation(s):
-- \DUT|offset_x~10_combout\ = ( \DUT|LessThan0~1_combout\ & ( (!\DUT|LessThan0~2_combout\ & ((!\DUT|LessThan0~0_combout\ & ((\DUT|offset_x~9_combout\))) # (\DUT|LessThan0~0_combout\ & (\DUT|Add13~17_sumout\)))) # (\DUT|LessThan0~2_combout\ & 
-- (((\DUT|offset_x~9_combout\)))) ) ) # ( !\DUT|LessThan0~1_combout\ & ( (!\DUT|LessThan0~0_combout\ & ((\DUT|offset_x~9_combout\))) # (\DUT|LessThan0~0_combout\ & (\DUT|Add13~17_sumout\)) ) )
...
PORT MAP (
	...
	datad => \DUT|ALT_INV_offset_x~9_combout\,
	dataf => \DUT|ALT_INV_LessThan0~1_combout\,
...
PORT MAP (
	clk => \CLOCK_50~inputCLKENA0_outclk\,
	d => \DUT|offset_x~10_combout\,
	asdata => \DUT|offset_x~9_combout\,
	sload => \DUT|ALT_INV_current_state.10~q\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|offset_x\(4));
...
-- Equation(s):
-- \DUT|Add13~17_sumout\ = SUM(( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x\(4)) ) + ( VCC ) + ( \DUT|Add13~2\ ))
-- \DUT|Add13~18\ = CARRY(( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x\(4)) ) + ( VCC ) + ( \DUT|Add13~2\ ))
...
-- Equation(s):
-- \DUT|Add14~13_sumout\ = SUM(( !\DUT|Add10~17_sumout\ $ (\DUT|Add13~17_sumout\) ) + ( \DUT|Add14~27\ ) + ( \DUT|Add14~26\ ))
-- \DUT|Add14~14\ = CARRY(( !\DUT|Add10~17_sumout\ $ (\DUT|Add13~17_sumout\) ) + ( \DUT|Add14~27\ ) + ( \DUT|Add14~26\ ))
-- \DUT|Add14~15\ = SHARE((\DUT|Add10~17_sumout\ & !\DUT|Add13~17_sumout\))
...
-- Equation(s):
-- \DUT|Add15~17_sumout\ = SUM(( \DUT|Add14~13_sumout\ ) + ( (\DUT|crit[5]~DUPLICATE_q\) # (\DUT|initx~q\) ) + ( \DUT|Add15~30\ ))
-- \DUT|Add15~18\ = CARRY(( \DUT|Add14~13_sumout\ ) + ( (\DUT|crit[5]~DUPLICATE_q\) # (\DUT|initx~q\) ) + ( \DUT|Add15~30\ ))
...
PORT MAP (
	...
	datac => \DUT|ALT_INV_Add15~17_sumout\,
	datad => \DUT|ALT_INV_LessThan0~3_combout\,
...
-- Equation(s):
-- \DUT|Add11~21_sumout\ = SUM(( \DUT|Add10~25_sumout\ ) + ( (\DUT|crit\(6)) # (\DUT|initx~q\) ) + ( \DUT|Add11~18\ ))
-- \DUT|Add11~22\ = CARRY(( \DUT|Add10~25_sumout\ ) + ( (\DUT|crit\(6)) # (\DUT|initx~q\) ) + ( \DUT|Add11~18\ ))
...
-- Equation(s):
-- \DUT|offset_x~11_combout\ = ( \DUT|initx~q\ & ( (\DUT|offset_x\(5) & !\DUT|loady~q\) ) ) # ( !\DUT|initx~q\ & ( \DUT|offset_x\(5) ) )
...
-- Equation(s):
-- \DUT|offset_x~12_combout\ = ( \DUT|Add13~25_sumout\ & ( ((\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~1_combout\) # (!\DUT|LessThan0~2_combout\)))) # (\DUT|offset_x~11_combout\) ) ) # ( !\DUT|Add13~25_sumout\ & ( (\DUT|offset_x~11_combout\ & 
...
PORT MAP (
	...
	datad => \DUT|ALT_INV_offset_x~11_combout\,
...
PORT MAP (
	clk => \CLOCK_50~inputCLKENA0_outclk\,
	d => \DUT|offset_x~12_combout\,
	asdata => \DUT|offset_x~11_combout\,
	sload => \DUT|ALT_INV_current_state.10~q\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|offset_x\(5));
...
-- Equation(s):
-- \DUT|Add13~25_sumout\ = SUM(( VCC ) + ( (\DUT|offset_x\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add13~18\ ))
-- \DUT|Add13~26\ = CARRY(( VCC ) + ( (\DUT|offset_x\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add13~18\ ))
...
-- Equation(s):
-- \DUT|Add14~17_sumout\ = SUM(( !\DUT|Add10~25_sumout\ $ (\DUT|Add13~25_sumout\) ) + ( \DUT|Add14~15\ ) + ( \DUT|Add14~14\ ))
-- \DUT|Add14~18\ = CARRY(( !\DUT|Add10~25_sumout\ $ (\DUT|Add13~25_sumout\) ) + ( \DUT|Add14~15\ ) + ( \DUT|Add14~14\ ))
-- \DUT|Add14~19\ = SHARE((\DUT|Add10~25_sumout\ & !\DUT|Add13~25_sumout\))
...
-- Equation(s):
-- \DUT|crit~5_combout\ = ( \DUT|crit\(6) & ( \DUT|Add15~21_sumout\ & ( ((!\DUT|current_state.10~q\) # (\DUT|Add11~21_sumout\)) # (\DUT|LessThan0~3_combout\) ) ) ) # ( !\DUT|crit\(6) & ( \DUT|Add15~21_sumout\ & ( (!\DUT|current_state.10~q\ & (\DUT|initx~q\)) 
-- # (\DUT|current_state.10~q\ & (((\DUT|Add11~21_sumout\) # (\DUT|LessThan0~3_combout\)))) ) ) ) # ( \DUT|crit\(6) & ( !\DUT|Add15~21_sumout\ & ( (!\DUT|current_state.10~q\) # ((!\DUT|LessThan0~3_combout\ & \DUT|Add11~21_sumout\)) ) ) ) # ( !\DUT|crit\(6) & 
-- ( !\DUT|Add15~21_sumout\ & ( (!\DUT|current_state.10~q\ & (\DUT|initx~q\)) # (\DUT|current_state.10~q\ & (((!\DUT|LessThan0~3_combout\ & \DUT|Add11~21_sumout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010100001100111111110000110001010101001111111111111100111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	...
	dataf => \DUT|ALT_INV_Add15~21_sumout\,
...
-- Equation(s):
-- \DUT|Add11~25_sumout\ = SUM(( \DUT|Add10~13_sumout\ ) + ( (\DUT|crit\(7)) # (\DUT|initx~q\) ) + ( \DUT|Add11~22\ ))
-- \DUT|Add11~26\ = CARRY(( \DUT|Add10~13_sumout\ ) + ( (\DUT|crit\(7)) # (\DUT|initx~q\) ) + ( \DUT|Add11~22\ ))
...
-- Equation(s):
-- \DUT|offset_x~7_combout\ = ( \DUT|initx~q\ & ( (!\DUT|loady~q\ & \DUT|offset_x\(6)) ) ) # ( !\DUT|initx~q\ & ( \DUT|offset_x\(6) ) )
...
-- Equation(s):
-- \DUT|offset_x~8_combout\ = ( \DUT|Add13~13_sumout\ & ( ((\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~2_combout\) # (!\DUT|LessThan0~1_combout\)))) # (\DUT|offset_x~7_combout\) ) ) # ( !\DUT|Add13~13_sumout\ & ( (\DUT|offset_x~7_combout\ & 
-- ((!\DUT|LessThan0~0_combout\) # ((\DUT|LessThan0~2_combout\ & \DUT|LessThan0~1_combout\)))) ) )
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_LessThan0~0_combout\,
	datac => \DUT|ALT_INV_LessThan0~1_combout\,
	datad => \DUT|ALT_INV_offset_x~7_combout\,
	dataf => \DUT|ALT_INV_Add13~13_sumout\,
...
PORT MAP (
	clk => \CLOCK_50~inputCLKENA0_outclk\,
	d => \DUT|offset_x~8_combout\,
	asdata => \DUT|offset_x~7_combout\,
	sload => \DUT|ALT_INV_current_state.10~q\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|offset_x\(6));
...
-- Equation(s):
-- \DUT|Add13~13_sumout\ = SUM(( (\DUT|offset_x\(6) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( \DUT|Add13~26\ ))
-- \DUT|Add13~14\ = CARRY(( (\DUT|offset_x\(6) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( \DUT|Add13~26\ ))
...
-- Equation(s):
-- \DUT|Add14~21_sumout\ = SUM(( !\DUT|Add10~13_sumout\ $ (\DUT|Add13~13_sumout\) ) + ( \DUT|Add14~19\ ) + ( \DUT|Add14~18\ ))
-- \DUT|Add14~22\ = CARRY(( !\DUT|Add10~13_sumout\ $ (\DUT|Add13~13_sumout\) ) + ( \DUT|Add14~19\ ) + ( \DUT|Add14~18\ ))
-- \DUT|Add14~23\ = SHARE((\DUT|Add10~13_sumout\ & !\DUT|Add13~13_sumout\))
...
-- Equation(s):
-- \DUT|crit~6_combout\ = ( \DUT|crit\(7) & ( \DUT|Add15~25_sumout\ & ( ((!\DUT|current_state.10~q\) # (\DUT|LessThan0~3_combout\)) # (\DUT|Add11~25_sumout\) ) ) ) # ( !\DUT|crit\(7) & ( \DUT|Add15~25_sumout\ & ( (!\DUT|current_state.10~q\ & 
-- (((\DUT|initx~q\)))) # (\DUT|current_state.10~q\ & (((\DUT|LessThan0~3_combout\)) # (\DUT|Add11~25_sumout\))) ) ) ) # ( \DUT|crit\(7) & ( !\DUT|Add15~25_sumout\ & ( (!\DUT|current_state.10~q\) # ((\DUT|Add11~25_sumout\ & !\DUT|LessThan0~3_combout\)) ) ) ) 
-- # ( !\DUT|crit\(7) & ( !\DUT|Add15~25_sumout\ & ( (!\DUT|current_state.10~q\ & (((\DUT|initx~q\)))) # (\DUT|current_state.10~q\ & (\DUT|Add11~25_sumout\ & (!\DUT|LessThan0~3_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010011110100111101001111010000000111111101111111011111110111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add11~25_sumout\,
	datab => \DUT|ALT_INV_LessThan0~3_combout\,
	datac => \DUT|ALT_INV_current_state.10~q\,
	datad => \DUT|ALT_INV_initx~q\,
...
-- Equation(s):
-- \DUT|offset_x~13_combout\ = ( \DUT|offset_x\(7) & ( (!\DUT|initx~q\) # (!\DUT|loady~q\) ) )
...
-- Equation(s):
-- \DUT|offset_x~14_combout\ = ( \DUT|Add13~29_sumout\ & ( ((\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~2_combout\) # (!\DUT|LessThan0~1_combout\)))) # (\DUT|offset_x~13_combout\) ) ) # ( !\DUT|Add13~29_sumout\ & ( (\DUT|offset_x~13_combout\ & 
-- ((!\DUT|LessThan0~0_combout\) # ((\DUT|LessThan0~2_combout\ & \DUT|LessThan0~1_combout\)))) ) )
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_LessThan0~0_combout\,
	datac => \DUT|ALT_INV_LessThan0~1_combout\,
	datad => \DUT|ALT_INV_offset_x~13_combout\,
...
PORT MAP (
	...
	asdata => \DUT|offset_x~13_combout\,
	sload => \DUT|ALT_INV_current_state.10~q\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|offset_x\(7));
...
-- Equation(s):
-- \DUT|Add13~29_sumout\ = SUM(( VCC ) + ( (\DUT|offset_x\(7) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add13~14\ ))
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_initx~q\,
	dataf => \DUT|ALT_INV_Add14~1_sumout\,
	cin => \DUT|Add15~26\,
...
-- Equation(s):
-- \DUT|LessThan0~3_combout\ = ( \DUT|crit[1]~DUPLICATE_q\ & ( \DUT|LessThan0~0_combout\ ) ) # ( !\DUT|crit[1]~DUPLICATE_q\ & ( (\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~1_combout\) # (\DUT|crit\(4)))) ) )
...
-- Equation(s):
-- \DUT|crit~9_combout\ = ( \DUT|Add11~33_sumout\ & ( (!\DUT|LessThan0~3_combout\) # (\DUT|Add15~33_sumout\) ) ) # ( !\DUT|Add11~33_sumout\ & ( (\DUT|LessThan0~3_combout\ & \DUT|Add15~33_sumout\) ) )
...
PORT MAP (
	...
	dataf => \DUT|ALT_INV_Add11~33_sumout\,
...
-- Equation(s):
-- \DUT|LessThan0~2_combout\ = (!\DUT|crit\(1) & !\DUT|crit\(4))
...
-- Equation(s):
-- \DUT|offset_x~15_combout\ = ( \DUT|Add13~21_sumout\ & ( ((\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~2_combout\) # (!\DUT|LessThan0~1_combout\)))) # (\DUT|offset_x~6_combout\) ) ) # ( !\DUT|Add13~21_sumout\ & ( (\DUT|offset_x~6_combout\ & 
-- ((!\DUT|LessThan0~0_combout\) # ((\DUT|LessThan0~2_combout\ & \DUT|LessThan0~1_combout\)))) ) )
...
-- Equation(s):
-- \DUT|LessThan1~1_combout\ = ( \DUT|LessThan0~0_combout\ & ( \DUT|LessThan0~2_combout\ & ( (\DUT|Add10~5_sumout\ & ((!\DUT|LessThan0~1_combout\ & ((!\DUT|Add13~5_sumout\))) # (\DUT|LessThan0~1_combout\ & (!\DUT|offset_x~1_combout\)))) ) ) ) # ( 
-- !\DUT|LessThan0~0_combout\ & ( \DUT|LessThan0~2_combout\ & ( (!\DUT|offset_x~1_combout\ & \DUT|Add10~5_sumout\) ) ) ) # ( \DUT|LessThan0~0_combout\ & ( !\DUT|LessThan0~2_combout\ & ( (\DUT|Add10~5_sumout\ & !\DUT|Add13~5_sumout\) ) ) ) # ( 
-- !\DUT|LessThan0~0_combout\ & ( !\DUT|LessThan0~2_combout\ & ( (!\DUT|offset_x~1_combout\ & \DUT|Add10~5_sumout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110000001100000011110000000000001100000011000000111000000100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \DUT|ALT_INV_Add13~5_sumout\,
	datae => \DUT|ALT_INV_LessThan0~0_combout\,
	dataf => \DUT|ALT_INV_LessThan0~2_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~0_combout\ = ( \DUT|offset_x~0_combout\ & ( \DUT|LessThan0~0_combout\ & ( !\DUT|Add10~1_sumout\ $ (((!\DUT|Add13~1_sumout\ & ((!\DUT|LessThan0~2_combout\) # (!\DUT|LessThan0~1_combout\))))) ) ) ) # ( !\DUT|offset_x~0_combout\ & ( 
-- \DUT|LessThan0~0_combout\ & ( !\DUT|Add10~1_sumout\ $ (((!\DUT|Add13~1_sumout\) # ((\DUT|LessThan0~2_combout\ & \DUT|LessThan0~1_combout\)))) ) ) ) # ( \DUT|offset_x~0_combout\ & ( !\DUT|LessThan0~0_combout\ & ( !\DUT|Add10~1_sumout\ ) ) ) # ( 
-- !\DUT|offset_x~0_combout\ & ( !\DUT|LessThan0~0_combout\ & ( \DUT|Add10~1_sumout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110011110011001100110000111100001110010011110001101100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_LessThan0~2_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~2_combout\ = ( !\DUT|LessThan1~0_combout\ & ( \DUT|Add10~21_sumout\ & ( (\DUT|offset_x~15_combout\ & ((!\DUT|offset_x~5_combout\ & ((\DUT|Add10~9_sumout\) # (\DUT|LessThan1~1_combout\))) # (\DUT|offset_x~5_combout\ & 
-- (\DUT|LessThan1~1_combout\ & \DUT|Add10~9_sumout\)))) ) ) ) # ( !\DUT|LessThan1~0_combout\ & ( !\DUT|Add10~21_sumout\ & ( (!\DUT|offset_x~15_combout\ & ((!\DUT|offset_x~5_combout\ & ((\DUT|Add10~9_sumout\) # (\DUT|LessThan1~1_combout\))) # 
-- (\DUT|offset_x~5_combout\ & (\DUT|LessThan1~1_combout\ & \DUT|Add10~9_sumout\)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_offset_x~15_combout\,
	datab => \DUT|ALT_INV_offset_x~5_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~3_combout\ = ( \DUT|offset_x~0_combout\ & ( \DUT|Add10~21_sumout\ & ( (!\DUT|offset_x~15_combout\ & (((!\DUT|Add13~1_sumout\ & \DUT|LessThan0~3_combout\)) # (\DUT|Add10~1_sumout\))) # (\DUT|offset_x~15_combout\ & (!\DUT|Add13~1_sumout\ & 
-- (\DUT|LessThan0~3_combout\ & \DUT|Add10~1_sumout\))) ) ) ) # ( !\DUT|offset_x~0_combout\ & ( \DUT|Add10~21_sumout\ & ( (!\DUT|offset_x~15_combout\ & ((!\DUT|Add13~1_sumout\) # ((!\DUT|LessThan0~3_combout\) # (\DUT|Add10~1_sumout\)))) # 
-- (\DUT|offset_x~15_combout\ & (\DUT|Add10~1_sumout\ & ((!\DUT|Add13~1_sumout\) # (!\DUT|LessThan0~3_combout\)))) ) ) ) # ( \DUT|offset_x~0_combout\ & ( !\DUT|Add10~21_sumout\ & ( (!\DUT|Add13~1_sumout\ & (\DUT|LessThan0~3_combout\ & \DUT|Add10~1_sumout\)) 
-- ) ) ) # ( !\DUT|offset_x~0_combout\ & ( !\DUT|Add10~21_sumout\ & ( (\DUT|Add10~1_sumout\ & ((!\DUT|Add13~1_sumout\) # (!\DUT|LessThan0~3_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011101110000000000010001011100000111111100010000011110010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add13~1_sumout\,
	datab => \DUT|ALT_INV_LessThan0~3_combout\,
	datac => \DUT|ALT_INV_offset_x~15_combout\,
	datad => \DUT|ALT_INV_Add10~1_sumout\,
	datae => \DUT|ALT_INV_offset_x~0_combout\,
	dataf => \DUT|ALT_INV_Add10~21_sumout\,
...
-- Equation(s):
-- \DUT|LessThan1~5_combout\ = ( \DUT|LessThan0~0_combout\ & ( \DUT|offset_x~9_combout\ & ( !\DUT|Add10~17_sumout\ $ (((!\DUT|Add13~17_sumout\ & ((!\DUT|LessThan0~1_combout\) # (!\DUT|LessThan0~2_combout\))))) ) ) ) # ( !\DUT|LessThan0~0_combout\ & ( 
-- \DUT|offset_x~9_combout\ & ( !\DUT|Add10~17_sumout\ ) ) ) # ( \DUT|LessThan0~0_combout\ & ( !\DUT|offset_x~9_combout\ & ( !\DUT|Add10~17_sumout\ $ (((!\DUT|Add13~17_sumout\) # ((\DUT|LessThan0~1_combout\ & \DUT|LessThan0~2_combout\)))) ) ) ) # ( 
-- !\DUT|LessThan0~0_combout\ & ( !\DUT|offset_x~9_combout\ & ( \DUT|Add10~17_sumout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011111111001100101100110111111111000000000011011111001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_LessThan0~1_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~4_combout\ = ( \DUT|offset_x~11_combout\ & ( \DUT|LessThan0~0_combout\ & ( !\DUT|Add10~25_sumout\ $ (((!\DUT|Add13~25_sumout\ & ((!\DUT|LessThan0~1_combout\) # (!\DUT|LessThan0~2_combout\))))) ) ) ) # ( !\DUT|offset_x~11_combout\ & ( 
-- \DUT|LessThan0~0_combout\ & ( !\DUT|Add10~25_sumout\ $ (((!\DUT|Add13~25_sumout\) # ((\DUT|LessThan0~1_combout\ & \DUT|LessThan0~2_combout\)))) ) ) ) # ( \DUT|offset_x~11_combout\ & ( !\DUT|LessThan0~0_combout\ & ( !\DUT|Add10~25_sumout\ ) ) ) # ( 
-- !\DUT|offset_x~11_combout\ & ( !\DUT|LessThan0~0_combout\ & ( \DUT|Add10~25_sumout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011111111111111110000000000110010110011010011011111001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_LessThan0~1_combout\,
	...
	datac => \DUT|ALT_INV_LessThan0~2_combout\,
	datad => \DUT|ALT_INV_Add10~25_sumout\,
	datae => \DUT|ALT_INV_offset_x~11_combout\,
	dataf => \DUT|ALT_INV_LessThan0~0_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~6_combout\ = ( \DUT|Add10~13_sumout\ & ( !\DUT|LessThan1~4_combout\ & ( (!\DUT|LessThan1~5_combout\ & ((!\DUT|LessThan0~3_combout\ & ((\DUT|offset_x~7_combout\))) # (\DUT|LessThan0~3_combout\ & (\DUT|Add13~13_sumout\)))) ) ) ) # ( 
-- !\DUT|Add10~13_sumout\ & ( !\DUT|LessThan1~4_combout\ & ( (!\DUT|LessThan1~5_combout\ & ((!\DUT|LessThan0~3_combout\ & ((!\DUT|offset_x~7_combout\))) # (\DUT|LessThan0~3_combout\ & (!\DUT|Add13~13_sumout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1110000000100000000100001101000000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \DUT|ALT_INV_offset_x~7_combout\,
	datae => \DUT|ALT_INV_Add10~13_sumout\,
...
-- Equation(s):
-- \DUT|Selector2~0_combout\ = ( \DUT|current_state.01~q\ & ( (\DUT|current_state.11~q\) # (\DUT|done~q\) ) ) # ( !\DUT|current_state.01~q\ & ( ((\DUT|done~q\ & \DUT|current_state.10~q\)) # (\DUT|current_state.11~q\) ) )
...
-- Equation(s):
-- \DUT|current_state~15_combout\ = ( \DUT|next_state.11~q\ & ( !\DUT|donedrawingonecircle~q\ ) )
...
PORT MAP (
	...
	dataf => \DUT|ALT_INV_next_state.11~q\,
...
-- Equation(s):
-- \DUT|done~1_combout\ = ( \DUT|current_state.10~q\ & ( !\DUT|current_state.11~q\ ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_current_state.11~q\,
	dataf => \DUT|ALT_INV_current_state.10~q\,
...
-- Equation(s):
-- \DUT|done~2_combout\ = ( \DUT|LessThan0~0_combout\ & ( \DUT|LessThan0~1_combout\ & ( (\DUT|done~1_combout\ & ((!\DUT|LessThan0~2_combout\ & (!\DUT|Add13~29_sumout\)) # (\DUT|LessThan0~2_combout\ & ((!\DUT|offset_x~13_combout\))))) ) ) ) # ( 
-- !\DUT|LessThan0~0_combout\ & ( \DUT|LessThan0~1_combout\ & ( (\DUT|done~1_combout\ & !\DUT|offset_x~13_combout\) ) ) ) # ( \DUT|LessThan0~0_combout\ & ( !\DUT|LessThan0~1_combout\ & ( (!\DUT|Add13~29_sumout\ & \DUT|done~1_combout\) ) ) ) # ( 
-- !\DUT|LessThan0~0_combout\ & ( !\DUT|LessThan0~1_combout\ & ( (\DUT|done~1_combout\ & !\DUT|offset_x~13_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111100000000000010100000101000001111000000000000101100001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add13~29_sumout\,
	datab => \DUT|ALT_INV_LessThan0~2_combout\,
	datac => \DUT|ALT_INV_done~1_combout\,
	datad => \DUT|ALT_INV_offset_x~13_combout\,
	datae => \DUT|ALT_INV_LessThan0~0_combout\,
	dataf => \DUT|ALT_INV_LessThan0~1_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~7_combout\ = ( \DUT|offset_x~12_combout\ & ( \DUT|Add10~17_sumout\ & ( (!\DUT|Add10~13_sumout\ & (\DUT|Add10~25_sumout\ & (!\DUT|offset_x~10_combout\ & !\DUT|offset_x~8_combout\))) # (\DUT|Add10~13_sumout\ & ((!\DUT|offset_x~8_combout\) # 
-- ((\DUT|Add10~25_sumout\ & !\DUT|offset_x~10_combout\)))) ) ) ) # ( !\DUT|offset_x~12_combout\ & ( \DUT|Add10~17_sumout\ & ( (!\DUT|Add10~13_sumout\ & (!\DUT|offset_x~8_combout\ & ((!\DUT|offset_x~10_combout\) # (\DUT|Add10~25_sumout\)))) # 
-- (\DUT|Add10~13_sumout\ & (((!\DUT|offset_x~10_combout\) # (!\DUT|offset_x~8_combout\)) # (\DUT|Add10~25_sumout\))) ) ) ) # ( \DUT|offset_x~12_combout\ & ( !\DUT|Add10~17_sumout\ & ( (\DUT|Add10~13_sumout\ & !\DUT|offset_x~8_combout\) ) ) ) # ( 
-- !\DUT|offset_x~12_combout\ & ( !\DUT|Add10~17_sumout\ & ( (!\DUT|Add10~25_sumout\ & (\DUT|Add10~13_sumout\ & !\DUT|offset_x~8_combout\)) # (\DUT|Add10~25_sumout\ & ((!\DUT|offset_x~8_combout\) # (\DUT|Add10~13_sumout\))) ) ) )
...
PORT MAP (
	...
	datae => \DUT|ALT_INV_offset_x~12_combout\,
...
-- Equation(s):
-- \DUT|done~3_combout\ = ( !\DUT|current_state.11~q\ & ( (\DUT|done~q\ & !\DUT|current_state.10~q\) ) )
...
-- Equation(s):
-- \DUT|done~4_combout\ = ( \DUT|LessThan1~7_combout\ & ( \DUT|done~3_combout\ ) ) # ( !\DUT|LessThan1~7_combout\ & ( \DUT|done~3_combout\ ) ) # ( \DUT|LessThan1~7_combout\ & ( !\DUT|done~3_combout\ & ( \DUT|done~2_combout\ ) ) ) # ( 
-- !\DUT|LessThan1~7_combout\ & ( !\DUT|done~3_combout\ & ( (\DUT|LessThan1~6_combout\ & (\DUT|done~2_combout\ & ((\DUT|LessThan1~3_combout\) # (\DUT|LessThan1~2_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000111000000001111111111111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \DUT|ALT_INV_done~2_combout\,
	datae => \DUT|ALT_INV_LessThan1~7_combout\,
	dataf => \DUT|ALT_INV_done~3_combout\,
...
-- Equation(s):
-- \DUT|Selector1~0_combout\ = ( \DUT|current_state.10~q\ & ( (!\DUT|current_state.00~q\) # (!\DUT|done~q\) ) ) # ( !\DUT|current_state.10~q\ & ( (!\DUT|current_state.00~q\) # ((!\DUT|drawdone~q\ & (\DUT|current_state.01~q\ & !\DUT|done~q\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111001011110000111100101111000011111111111100001111111111110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_drawdone~q\,
	datab => \DUT|ALT_INV_current_state.01~q\,
	datac => \DUT|ALT_INV_current_state.00~q\,
	datad => \DUT|ALT_INV_done~q\,
	dataf => \DUT|ALT_INV_current_state.10~q\,
...
-- Equation(s):
-- \DUT|current_state~12_combout\ = ( \DUT|next_state.01~q\ & ( !\DUT|donedrawingonecircle~DUPLICATE_q\ ) )
...
-- pragma translate_on
PORT MAP (
	datae => \DUT|ALT_INV_next_state.01~q\,
...
-- Equation(s):
-- \DUT|octant~3_combout\ = ( \DUT|octant\(0) & ( \DUT|current_state.01~q\ & ( \DUT|initx~q\ ) ) ) # ( !\DUT|octant\(0) & ( \DUT|current_state.01~q\ ) ) # ( \DUT|octant\(0) & ( !\DUT|current_state.01~q\ & ( !\DUT|initx~q\ ) ) )
...
-- Equation(s):
-- \DUT|octant~4_combout\ = !\DUT|octant[0]~DUPLICATE_q\ $ (!\DUT|octant\(1))
...
-- pragma translate_on
PORT MAP (
	datac => \DUT|ALT_INV_octant[0]~DUPLICATE_q\,
...
-- Equation(s):
-- \DUT|drawdone~0_combout\ = ( \DUT|octant[2]~DUPLICATE_q\ & ( (\DUT|octant[0]~DUPLICATE_q\ & (\DUT|octant\(1) & (!\DUT|initx~q\ & \DUT|current_state.01~q\))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_octant[0]~DUPLICATE_q\,
	datab => \DUT|ALT_INV_octant\(1),
	datac => \DUT|ALT_INV_initx~q\,
...
-- Equation(s):
-- \DUT|next_state~8_combout\ = (\DUT|drawdone~q\ & (\DUT|current_state.01~q\ & !\DUT|done~q\))
...
-- Equation(s):
-- \DUT|Selector0~0_combout\ = ( \DUT|donedrawingonecircle~q\ & ( \DUT|current_state.11~q\ ) ) # ( !\DUT|donedrawingonecircle~q\ & ( \DUT|current_state.11~q\ ) ) # ( \DUT|donedrawingonecircle~q\ & ( !\DUT|current_state.11~q\ & ( (\DUT|current_state.01~q\) # 
-- (\DUT|current_state.10~q\) ) ) )
...
PORT MAP (
	datab => \DUT|ALT_INV_current_state.10~q\,
	datac => \DUT|ALT_INV_current_state.01~q\,
	datae => \DUT|ALT_INV_donedrawingonecircle~q\,
	dataf => \DUT|ALT_INV_current_state.11~q\,
	combout => \DUT|Selector0~0_combout\);

-- Location: FF_X34_Y79_N58
...
-- Equation(s):
-- \DUT|current_state~13_combout\ = ( !\DUT|donedrawingonecircle~DUPLICATE_q\ & ( \DUT|next_state.00~q\ ) )
...
-- Equation(s):
-- \DUT|octant~1_combout\ = ( \DUT|octant[0]~DUPLICATE_q\ & ( !\DUT|initx~q\ ) )
...
\next_state~7\ : cyclonev_lcell_comb
-- Equation(s):
-- \next_state~7_combout\ = ( \DUT|donedrawingonecircle~DUPLICATE_q\ ) # ( !\DUT|donedrawingonecircle~DUPLICATE_q\ & ( \current_state.000~q\ ) )
...
-- pragma translate_on
PORT MAP (
	datad => \ALT_INV_current_state.000~q\,
	dataf => \DUT|ALT_INV_donedrawingonecircle~DUPLICATE_q\,
	combout => \next_state~7_combout\);
...
-- Equation(s):
-- \Selector0~0_combout\ = ( !\current_state.000~q\ & ( \DUT|donedrawingonecircle~DUPLICATE_q\ ) ) # ( \current_state.000~q\ & ( !\DUT|donedrawingonecircle~DUPLICATE_q\ & ( \current_state.001~q\ ) ) ) # ( !\current_state.000~q\ & ( 
-- !\DUT|donedrawingonecircle~DUPLICATE_q\ & ( \current_state.001~q\ ) ) )
...
PORT MAP (
	...
	datae => \ALT_INV_current_state.000~q\,
	dataf => \DUT|ALT_INV_donedrawingonecircle~DUPLICATE_q\,
...
\colour[2]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \colour[2]~0_combout\ = ( !\current_state.001~q\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \ALT_INV_current_state.001~q\,
	combout => \colour[2]~0_combout\);

-- Location: FF_X34_Y79_N32
\colour[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Equation(s):
-- \Selector1~0_combout\ = ( \current_state.010~q\ ) # ( !\current_state.010~q\ & ( (\current_state.001~q\ & \DUT|donedrawingonecircle~q\) ) )
...
PORT MAP (
	clk => \CLOCK_50~inputCLKENA0_outclk\,
	asdata => \current_state.010~DUPLICATE_q\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => colour(1));
...
-- Equation(s):
-- \DUT|Add3~13_sumout\ = SUM(( colour(2) ) + ( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x\(2)) ) + ( !VCC ))
-- \DUT|Add3~14\ = CARRY(( colour(2) ) + ( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x\(2)) ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|Add3~17_sumout\ = SUM(( colour(1) ) + ( (\DUT|offset_x\(3) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add3~14\ ))
-- \DUT|Add3~18\ = CARRY(( colour(1) ) + ( (\DUT|offset_x\(3) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add3~14\ ))
...
-- Equation(s):
-- \DUT|Add3~21_sumout\ = SUM(( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x\(4)) ) + ( centerx(4) ) + ( \DUT|Add3~18\ ))
-- \DUT|Add3~22\ = CARRY(( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x\(4)) ) + ( centerx(4) ) + ( \DUT|Add3~18\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000000000000000000000000001111100011111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
...
-- Equation(s):
-- \DUT|Add3~9_sumout\ = SUM(( colour(2) ) + ( (\DUT|offset_x\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add3~22\ ))
-- \DUT|Add3~10\ = CARRY(( colour(2) ) + ( (\DUT|offset_x\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add3~22\ ))
...
-- Equation(s):
-- \DUT|Add3~5_sumout\ = SUM(( (\DUT|offset_x\(6) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( centerx(4) ) + ( \DUT|Add3~10\ ))
-- \DUT|Add3~6\ = CARRY(( (\DUT|offset_x\(6) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( centerx(4) ) + ( \DUT|Add3~10\ ))
...
-- Equation(s):
-- \DUT|Add1~21_sumout\ = SUM(( colour(2) ) + ( (!\DUT|offset_x\(2) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add1~18\ ))
-- \DUT|Add1~22\ = CARRY(( colour(2) ) + ( (!\DUT|offset_x\(2) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add1~18\ ))
...
-- Equation(s):
-- \DUT|Add1~25_sumout\ = SUM(( colour(1) ) + ( (!\DUT|offset_x\(3)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add1~22\ ))
-- \DUT|Add1~26\ = CARRY(( colour(1) ) + ( (!\DUT|offset_x\(3)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add1~22\ ))
...
-- Equation(s):
-- \DUT|Add1~29_sumout\ = SUM(( centerx(4) ) + ( (!\DUT|offset_x\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add1~26\ ))
-- \DUT|Add1~30\ = CARRY(( centerx(4) ) + ( (!\DUT|offset_x\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add1~26\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000100011111111100000000000000000000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datab => \DUT|ALT_INV_loady~q\,
	datad => ALT_INV_centerx(4),
...
-- Equation(s):
-- \DUT|Add1~9_sumout\ = SUM(( colour(2) ) + ( (!\DUT|offset_x\(5)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add1~30\ ))
-- \DUT|Add1~10\ = CARRY(( colour(2) ) + ( (!\DUT|offset_x\(5)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add1~30\ ))
...
-- Equation(s):
-- \DUT|Add1~5_sumout\ = SUM(( (!\DUT|offset_x\(6)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( centerx(4) ) + ( \DUT|Add1~10\ ))
-- \DUT|Add1~6\ = CARRY(( (!\DUT|offset_x\(6)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( centerx(4) ) + ( \DUT|Add1~10\ ))
...
\DUT|x[2]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \DUT|x[2]~1_combout\ = ( !\DUT|initx~q\ & ( \DUT|octant\(2) & ( !\DUT|octant\(1) ) ) ) # ( !\DUT|initx~q\ & ( !\DUT|octant\(2) & ( \DUT|octant\(1) ) ) )
...
-- Equation(s):
-- \DUT|Add2~17_sumout\ = SUM(( GND ) + ( (!\DUT|offset_y\(1)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add2~14\ ))
-- \DUT|Add2~18\ = CARRY(( GND ) + ( (!\DUT|offset_y\(1)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add2~14\ ))
...
-- Equation(s):
-- \DUT|Add2~21_sumout\ = SUM(( (!\DUT|offset_y\(2)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( colour(2) ) + ( \DUT|Add2~18\ ))
-- \DUT|Add2~22\ = CARRY(( (!\DUT|offset_y\(2)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( colour(2) ) + ( \DUT|Add2~18\ ))
...
-- Equation(s):
-- \DUT|Add2~25_sumout\ = SUM(( colour(1) ) + ( (!\DUT|offset_y\(3)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( \DUT|Add2~22\ ))
-- \DUT|Add2~26\ = CARRY(( colour(1) ) + ( (!\DUT|offset_y\(3)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( \DUT|Add2~22\ ))
...
-- Equation(s):
-- \DUT|Add2~29_sumout\ = SUM(( centerx(4) ) + ( (!\DUT|offset_y\(4)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add2~26\ ))
-- \DUT|Add2~30\ = CARRY(( centerx(4) ) + ( (!\DUT|offset_y\(4)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add2~26\ ))
...
-- Equation(s):
-- \DUT|Add2~9_sumout\ = SUM(( colour(2) ) + ( (!\DUT|offset_y\(5)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add2~30\ ))
-- \DUT|Add2~10\ = CARRY(( colour(2) ) + ( (!\DUT|offset_y\(5)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add2~30\ ))
...
-- Equation(s):
-- \DUT|Add2~5_sumout\ = SUM(( centerx(4) ) + ( (!\DUT|offset_y\(6)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( \DUT|Add2~10\ ))
-- \DUT|Add2~6\ = CARRY(( centerx(4) ) + ( (!\DUT|offset_y\(6)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( \DUT|Add2~10\ ))
...
-- Equation(s):
-- \DUT|Add4~13_sumout\ = SUM(( (\DUT|offset_y\(2) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( colour(2) ) + ( !VCC ))
-- \DUT|Add4~14\ = CARRY(( (\DUT|offset_y\(2) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( colour(2) ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|Add4~17_sumout\ = SUM(( colour(1) ) + ( (\DUT|offset_y\(3) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( \DUT|Add4~14\ ))
-- \DUT|Add4~18\ = CARRY(( colour(1) ) + ( (\DUT|offset_y\(3) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( \DUT|Add4~14\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000001100000000000000000101010101010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => ALT_INV_colour(1),
...
-- Equation(s):
-- \DUT|Add4~21_sumout\ = SUM(( centerx(4) ) + ( (\DUT|offset_y\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add4~18\ ))
-- \DUT|Add4~22\ = CARRY(( centerx(4) ) + ( (\DUT|offset_y\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add4~18\ ))
...
-- Equation(s):
-- \DUT|Add4~9_sumout\ = SUM(( colour(2) ) + ( (\DUT|offset_y\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add4~22\ ))
-- \DUT|Add4~10\ = CARRY(( colour(2) ) + ( (\DUT|offset_y\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add4~22\ ))
...
-- Equation(s):
-- \DUT|Add4~5_sumout\ = SUM(( centerx(4) ) + ( (\DUT|offset_y\(6) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( \DUT|Add4~10\ ))
-- \DUT|Add4~6\ = CARRY(( centerx(4) ) + ( (\DUT|offset_y\(6) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( \DUT|Add4~10\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000101010111010101100000000000000000000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_offset_y\(6),
...
-- Equation(s):
-- \DUT|Mux0~0_combout\ = ( \DUT|Add2~1_sumout\ & ( \DUT|Add4~1_sumout\ & ( ((!\DUT|x[2]~1_combout\ & (\DUT|Add3~1_sumout\)) # (\DUT|x[2]~1_combout\ & ((\DUT|Add1~1_sumout\)))) # (\DUT|octant~1_combout\) ) ) ) # ( !\DUT|Add2~1_sumout\ & ( \DUT|Add4~1_sumout\ 
-- & ( (!\DUT|octant~1_combout\ & ((!\DUT|x[2]~1_combout\ & (\DUT|Add3~1_sumout\)) # (\DUT|x[2]~1_combout\ & ((\DUT|Add1~1_sumout\))))) # (\DUT|octant~1_combout\ & (((!\DUT|x[2]~1_combout\)))) ) ) ) # ( \DUT|Add2~1_sumout\ & ( !\DUT|Add4~1_sumout\ & ( 
-- (!\DUT|octant~1_combout\ & ((!\DUT|x[2]~1_combout\ & (\DUT|Add3~1_sumout\)) # (\DUT|x[2]~1_combout\ & ((\DUT|Add1~1_sumout\))))) # (\DUT|octant~1_combout\ & (((\DUT|x[2]~1_combout\)))) ) ) ) # ( !\DUT|Add2~1_sumout\ & ( !\DUT|Add4~1_sumout\ & ( 
-- (!\DUT|octant~1_combout\ & ((!\DUT|x[2]~1_combout\ & (\DUT|Add3~1_sumout\)) # (\DUT|x[2]~1_combout\ & ((\DUT|Add1~1_sumout\))))) ) ) )
...
PORT MAP (
	...
	datac => \DUT|ALT_INV_Add1~1_sumout\,
	datad => \DUT|ALT_INV_x[2]~1_combout\,
...
-- Equation(s):
-- \DUT|Mux1~0_combout\ = ( \DUT|Add4~5_sumout\ & ( \DUT|Add2~5_sumout\ & ( ((!\DUT|x[2]~1_combout\ & ((\DUT|Add3~5_sumout\))) # (\DUT|x[2]~1_combout\ & (\DUT|Add1~5_sumout\))) # (\DUT|octant~1_combout\) ) ) ) # ( !\DUT|Add4~5_sumout\ & ( \DUT|Add2~5_sumout\ 
-- & ( (!\DUT|octant~1_combout\ & ((!\DUT|x[2]~1_combout\ & ((\DUT|Add3~5_sumout\))) # (\DUT|x[2]~1_combout\ & (\DUT|Add1~5_sumout\)))) # (\DUT|octant~1_combout\ & (((\DUT|x[2]~1_combout\)))) ) ) ) # ( \DUT|Add4~5_sumout\ & ( !\DUT|Add2~5_sumout\ & ( 
-- (!\DUT|octant~1_combout\ & ((!\DUT|x[2]~1_combout\ & ((\DUT|Add3~5_sumout\))) # (\DUT|x[2]~1_combout\ & (\DUT|Add1~5_sumout\)))) # (\DUT|octant~1_combout\ & (((!\DUT|x[2]~1_combout\)))) ) ) ) # ( !\DUT|Add4~5_sumout\ & ( !\DUT|Add2~5_sumout\ & ( 
-- (!\DUT|octant~1_combout\ & ((!\DUT|x[2]~1_combout\ & ((\DUT|Add3~5_sumout\))) # (\DUT|x[2]~1_combout\ & (\DUT|Add1~5_sumout\)))) ) ) )
...
-- Equation(s):
-- \DUT|Mux2~0_combout\ = ( \DUT|octant~1_combout\ & ( \DUT|Add2~9_sumout\ & ( (\DUT|x[2]~1_combout\) # (\DUT|Add4~9_sumout\) ) ) ) # ( !\DUT|octant~1_combout\ & ( \DUT|Add2~9_sumout\ & ( (!\DUT|x[2]~1_combout\ & ((\DUT|Add3~9_sumout\))) # 
-- (\DUT|x[2]~1_combout\ & (\DUT|Add1~9_sumout\)) ) ) ) # ( \DUT|octant~1_combout\ & ( !\DUT|Add2~9_sumout\ & ( (\DUT|Add4~9_sumout\ & !\DUT|x[2]~1_combout\) ) ) ) # ( !\DUT|octant~1_combout\ & ( !\DUT|Add2~9_sumout\ & ( (!\DUT|x[2]~1_combout\ & 
-- ((\DUT|Add3~9_sumout\))) # (\DUT|x[2]~1_combout\ & (\DUT|Add1~9_sumout\)) ) ) )
...
-- Equation(s):
-- \DUT|vga_u0|writeEn~0_combout\ = ( \DUT|x\(5) & ( (!\DUT|x\(7) & \DUT|plot~q\) ) ) # ( !\DUT|x\(5) & ( (\DUT|plot~q\ & ((!\DUT|x\(7)) # (!\DUT|x\(6)))) ) )
...
-- Equation(s):
-- \DUT|Add6~5_sumout\ = SUM(( ((\DUT|loady~q\ & \DUT|initx~q\)) # (\DUT|offset_x\(4)) ) + ( VCC ) + ( !VCC ))
-- \DUT|Add6~6\ = CARRY(( ((\DUT|loady~q\ & \DUT|initx~q\)) # (\DUT|offset_x\(4)) ) + ( VCC ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|Add6~9_sumout\ = SUM(( (\DUT|offset_x\(5) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( GND ) + ( \DUT|Add6~6\ ))
-- \DUT|Add6~10\ = CARRY(( (\DUT|offset_x\(5) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( GND ) + ( \DUT|Add6~6\ ))
...
-- Equation(s):
-- \DUT|Add6~1_sumout\ = SUM(( (\DUT|offset_x\(6) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( VCC ) + ( \DUT|Add6~10\ ))
...
-- Equation(s):
-- \DUT|Add8~17_sumout\ = SUM(( (!\DUT|offset_x\(2) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( GND ) + ( \DUT|Add8~26\ ))
-- \DUT|Add8~18\ = CARRY(( (!\DUT|offset_x\(2) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( GND ) + ( \DUT|Add8~26\ ))
...
-- Equation(s):
-- \DUT|Add8~9_sumout\ = SUM(( GND ) + ( (!\DUT|offset_x\(3)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( \DUT|Add8~18\ ))
-- \DUT|Add8~10\ = CARRY(( GND ) + ( (!\DUT|offset_x\(3)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( \DUT|Add8~18\ ))
...
-- Equation(s):
-- \DUT|Add8~5_sumout\ = SUM(( (!\DUT|offset_x\(4) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( VCC ) + ( \DUT|Add8~10\ ))
-- \DUT|Add8~6\ = CARRY(( (!\DUT|offset_x\(4) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( VCC ) + ( \DUT|Add8~10\ ))
...
-- Equation(s):
-- \DUT|Add8~13_sumout\ = SUM(( (!\DUT|offset_x\(5)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add8~6\ ))
-- \DUT|Add8~14\ = CARRY(( (!\DUT|offset_x\(5)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add8~6\ ))
...
-- Equation(s):
-- \DUT|Add8~1_sumout\ = SUM(( (!\DUT|offset_x\(6)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( VCC ) + ( \DUT|Add8~14\ ))
...
-- Equation(s):
-- \DUT|Add7~21_sumout\ = SUM(( VCC ) + ( (!\DUT|offset_y\(0)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( !VCC ))
-- \DUT|Add7~22\ = CARRY(( VCC ) + ( (!\DUT|offset_y\(0)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|Add7~25_sumout\ = SUM(( GND ) + ( (!\DUT|offset_y\(1)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( \DUT|Add7~22\ ))
-- \DUT|Add7~26\ = CARRY(( GND ) + ( (!\DUT|offset_y\(1)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( \DUT|Add7~22\ ))
...
-- Equation(s):
-- \DUT|Add7~17_sumout\ = SUM(( (!\DUT|offset_y\(2)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add7~26\ ))
-- \DUT|Add7~18\ = CARRY(( (!\DUT|offset_y\(2)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add7~26\ ))
...
-- Equation(s):
-- \DUT|Add7~9_sumout\ = SUM(( (!\DUT|offset_y\(3)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add7~18\ ))
-- \DUT|Add7~10\ = CARRY(( (!\DUT|offset_y\(3)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add7~18\ ))
...
-- Equation(s):
-- \DUT|Add7~5_sumout\ = SUM(( (!\DUT|offset_y\(4)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( VCC ) + ( \DUT|Add7~10\ ))
-- \DUT|Add7~6\ = CARRY(( (!\DUT|offset_y\(4)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( VCC ) + ( \DUT|Add7~10\ ))
...
-- Equation(s):
-- \DUT|Add7~13_sumout\ = SUM(( (!\DUT|offset_y\(5)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add7~6\ ))
-- \DUT|Add7~14\ = CARRY(( (!\DUT|offset_y\(5)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add7~6\ ))
...
-- Equation(s):
-- \DUT|Add7~1_sumout\ = SUM(( (!\DUT|offset_y\(6)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( VCC ) + ( \DUT|Add7~14\ ))
...
-- Equation(s):
-- \DUT|Add5~5_sumout\ = SUM(( (\DUT|offset_y\(4) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( VCC ) + ( !VCC ))
-- \DUT|Add5~6\ = CARRY(( (\DUT|offset_y\(4) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( VCC ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|Add5~9_sumout\ = SUM(( (\DUT|offset_y\(5) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( GND ) + ( \DUT|Add5~6\ ))
-- \DUT|Add5~10\ = CARRY(( (\DUT|offset_y\(5) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( GND ) + ( \DUT|Add5~6\ ))
...
-- Equation(s):
-- \DUT|Add5~1_sumout\ = SUM(( (\DUT|offset_y\(6) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( \DUT|Add5~10\ ))
...
-- Equation(s):
-- \DUT|Mux8~0_combout\ = ( \DUT|Add5~1_sumout\ & ( \DUT|octant~1_combout\ & ( (!\DUT|octant~0_combout\ & (\DUT|Add6~1_sumout\)) # (\DUT|octant~0_combout\ & ((\DUT|Add8~1_sumout\))) ) ) ) # ( !\DUT|Add5~1_sumout\ & ( \DUT|octant~1_combout\ & ( 
-- (!\DUT|octant~0_combout\ & (\DUT|Add6~1_sumout\)) # (\DUT|octant~0_combout\ & ((\DUT|Add8~1_sumout\))) ) ) ) # ( \DUT|Add5~1_sumout\ & ( !\DUT|octant~1_combout\ & ( (!\DUT|octant~0_combout\) # (\DUT|Add7~1_sumout\) ) ) ) # ( !\DUT|Add5~1_sumout\ & ( 
-- !\DUT|octant~1_combout\ & ( (\DUT|octant~0_combout\ & \DUT|Add7~1_sumout\) ) ) )
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_Add6~1_sumout\,
	datac => \DUT|ALT_INV_Add8~1_sumout\,
	datad => \DUT|ALT_INV_Add7~1_sumout\,
...
-- Equation(s):
-- \DUT|Mux10~0_combout\ = ( \DUT|Add8~5_sumout\ & ( \DUT|Add5~5_sumout\ & ( (!\DUT|octant~0_combout\ & (((!\DUT|octant~1_combout\) # (\DUT|Add6~5_sumout\)))) # (\DUT|octant~0_combout\ & (((\DUT|octant~1_combout\)) # (\DUT|Add7~5_sumout\))) ) ) ) # ( 
-- !\DUT|Add8~5_sumout\ & ( \DUT|Add5~5_sumout\ & ( (!\DUT|octant~0_combout\ & (((!\DUT|octant~1_combout\) # (\DUT|Add6~5_sumout\)))) # (\DUT|octant~0_combout\ & (\DUT|Add7~5_sumout\ & (!\DUT|octant~1_combout\))) ) ) ) # ( \DUT|Add8~5_sumout\ & ( 
-- !\DUT|Add5~5_sumout\ & ( (!\DUT|octant~0_combout\ & (((\DUT|octant~1_combout\ & \DUT|Add6~5_sumout\)))) # (\DUT|octant~0_combout\ & (((\DUT|octant~1_combout\)) # (\DUT|Add7~5_sumout\))) ) ) ) # ( !\DUT|Add8~5_sumout\ & ( !\DUT|Add5~5_sumout\ & ( 
-- (!\DUT|octant~0_combout\ & (((\DUT|octant~1_combout\ & \DUT|Add6~5_sumout\)))) # (\DUT|octant~0_combout\ & (\DUT|Add7~5_sumout\ & (!\DUT|octant~1_combout\))) ) ) )
...
PORT MAP (
	...
	datae => \DUT|ALT_INV_Add8~5_sumout\,
	dataf => \DUT|ALT_INV_Add5~5_sumout\,
...
-- Equation(s):
-- \DUT|Mux11~0_combout\ = ( \DUT|offset_x~0_combout\ & ( \DUT|octant~1_combout\ & ( (!\DUT|octant~0_combout\) # (\DUT|Add8~9_sumout\) ) ) ) # ( !\DUT|offset_x~0_combout\ & ( \DUT|octant~1_combout\ & ( (\DUT|octant~0_combout\ & \DUT|Add8~9_sumout\) ) ) ) # ( 
-- \DUT|offset_x~0_combout\ & ( !\DUT|octant~1_combout\ & ( (!\DUT|octant~0_combout\ & (\DUT|offset_y~1_combout\)) # (\DUT|octant~0_combout\ & ((\DUT|Add7~9_sumout\))) ) ) ) # ( !\DUT|offset_x~0_combout\ & ( !\DUT|octant~1_combout\ & ( 
-- (!\DUT|octant~0_combout\ & (\DUT|offset_y~1_combout\)) # (\DUT|octant~0_combout\ & ((\DUT|Add7~9_sumout\))) ) ) )
...
PORT MAP (
	...
	datad => \DUT|ALT_INV_Add7~9_sumout\,
	datae => \DUT|ALT_INV_offset_x~0_combout\,
	dataf => \DUT|ALT_INV_octant~1_combout\,
...
-- Equation(s):
-- \DUT|Mux12~0_combout\ = ( \DUT|offset_x~6_combout\ & ( \DUT|octant~1_combout\ & ( (!\DUT|octant~0_combout\) # (\DUT|Add8~17_sumout\) ) ) ) # ( !\DUT|offset_x~6_combout\ & ( \DUT|octant~1_combout\ & ( (\DUT|octant~0_combout\ & \DUT|Add8~17_sumout\) ) ) ) # 
-- ( \DUT|offset_x~6_combout\ & ( !\DUT|octant~1_combout\ & ( (!\DUT|octant~0_combout\ & (\DUT|offset_y~4_combout\)) # (\DUT|octant~0_combout\ & ((\DUT|Add7~17_sumout\))) ) ) ) # ( !\DUT|offset_x~6_combout\ & ( !\DUT|octant~1_combout\ & ( 
-- (!\DUT|octant~0_combout\ & (\DUT|offset_y~4_combout\)) # (\DUT|octant~0_combout\ & ((\DUT|Add7~17_sumout\))) ) ) )
...
-- Equation(s):
-- \DUT|Mux9~0_combout\ = ( \DUT|Add7~13_sumout\ & ( \DUT|octant~1_combout\ & ( (!\DUT|octant~0_combout\ & ((\DUT|Add6~9_sumout\))) # (\DUT|octant~0_combout\ & (\DUT|Add8~13_sumout\)) ) ) ) # ( !\DUT|Add7~13_sumout\ & ( \DUT|octant~1_combout\ & ( 
-- (!\DUT|octant~0_combout\ & ((\DUT|Add6~9_sumout\))) # (\DUT|octant~0_combout\ & (\DUT|Add8~13_sumout\)) ) ) ) # ( \DUT|Add7~13_sumout\ & ( !\DUT|octant~1_combout\ & ( (\DUT|octant~0_combout\) # (\DUT|Add5~9_sumout\) ) ) ) # ( !\DUT|Add7~13_sumout\ & ( 
-- !\DUT|octant~1_combout\ & ( (\DUT|Add5~9_sumout\ & !\DUT|octant~0_combout\) ) ) )
...
-- Equation(s):
-- \rtl~1_combout\ = ( \DUT|octant~1_combout\ & ( \DUT|Add8~25_sumout\ & ( (\DUT|offset_x~2_combout\) # (\DUT|octant~0_combout\) ) ) ) # ( !\DUT|octant~1_combout\ & ( \DUT|Add8~25_sumout\ & ( (!\DUT|octant~0_combout\ & ((\DUT|offset_y~3_combout\))) # 
-- (\DUT|octant~0_combout\ & (\DUT|Add7~25_sumout\)) ) ) ) # ( \DUT|octant~1_combout\ & ( !\DUT|Add8~25_sumout\ & ( (!\DUT|octant~0_combout\ & \DUT|offset_x~2_combout\) ) ) ) # ( !\DUT|octant~1_combout\ & ( !\DUT|Add8~25_sumout\ & ( (!\DUT|octant~0_combout\ 
-- & ((\DUT|offset_y~3_combout\))) # (\DUT|octant~0_combout\ & (\DUT|Add7~25_sumout\)) ) ) )
...
PORT MAP (
	...
	datad => \DUT|ALT_INV_offset_y~3_combout\,
	datae => \DUT|ALT_INV_octant~1_combout\,
	dataf => \DUT|ALT_INV_Add8~25_sumout\,
...
-- Equation(s):
-- \rtl~0_combout\ = ( \DUT|octant~1_combout\ & ( \DUT|octant~0_combout\ & ( \DUT|Add8~21_sumout\ ) ) ) # ( !\DUT|octant~1_combout\ & ( \DUT|octant~0_combout\ & ( \DUT|Add7~21_sumout\ ) ) ) # ( \DUT|octant~1_combout\ & ( !\DUT|octant~0_combout\ & ( 
-- \DUT|offset_x~1_combout\ ) ) ) # ( !\DUT|octant~1_combout\ & ( !\DUT|octant~0_combout\ & ( \DUT|offset_y~2_combout\ ) ) )
...
-- Equation(s):
-- \DUT|vga_u0|user_input_translator|Add0~17_sumout\ = SUM(( !\DUT|y\(2) $ (!\DUT|x\(7)) ) + ( \DUT|y\(0) ) + ( \DUT|vga_u0|user_input_translator|Add0~14\ ))
-- \DUT|vga_u0|user_input_translator|Add0~18\ = CARRY(( !\DUT|y\(2) $ (!\DUT|x\(7)) ) + ( \DUT|y\(0) ) + ( \DUT|vga_u0|user_input_translator|Add0~14\ ))
...
-- Equation(s):
-- \DUT|vga_u0|user_input_translator|Add0~21_sumout\ = SUM(( !\DUT|y\(3) $ (((!\DUT|y\(2)) # (!\DUT|x\(7)))) ) + ( \DUT|y\(1) ) + ( \DUT|vga_u0|user_input_translator|Add0~18\ ))
-- \DUT|vga_u0|user_input_translator|Add0~22\ = CARRY(( !\DUT|y\(3) $ (((!\DUT|y\(2)) # (!\DUT|x\(7)))) ) + ( \DUT|y\(1) ) + ( \DUT|vga_u0|user_input_translator|Add0~18\ ))
...
-- Equation(s):
-- \DUT|vga_u0|user_input_translator|Add0~25_sumout\ = SUM(( !\DUT|y\(4) $ (((!\DUT|y\(3)) # ((!\DUT|y\(2)) # (!\DUT|x\(7))))) ) + ( \DUT|y\(2) ) + ( \DUT|vga_u0|user_input_translator|Add0~22\ ))
-- \DUT|vga_u0|user_input_translator|Add0~26\ = CARRY(( !\DUT|y\(4) $ (((!\DUT|y\(3)) # ((!\DUT|y\(2)) # (!\DUT|x\(7))))) ) + ( \DUT|y\(2) ) + ( \DUT|vga_u0|user_input_translator|Add0~22\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111100001111000000000000000000000101010101010110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \DUT|vga_u0|user_input_translator|Add0~29_sumout\ = SUM(( (\DUT|y\(3) & ((!\DUT|y\(4)) # ((!\DUT|y\(2)) # (!\DUT|x\(7))))) ) + ( \DUT|y\(5) ) + ( \DUT|vga_u0|user_input_translator|Add0~26\ ))
-- \DUT|vga_u0|user_input_translator|Add0~30\ = CARRY(( (\DUT|y\(3) & ((!\DUT|y\(4)) # ((!\DUT|y\(2)) # (!\DUT|x\(7))))) ) + ( \DUT|y\(5) ) + ( \DUT|vga_u0|user_input_translator|Add0~26\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000000000000000000000000011001100110010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_y\(4),
...
-- Equation(s):
-- \DUT|vga_u0|user_input_translator|Add0~33_sumout\ = SUM(( (\DUT|y\(4) & ((!\DUT|y\(3)) # ((!\DUT|y\(2)) # (!\DUT|x\(7))))) ) + ( \DUT|y\(6) ) + ( \DUT|vga_u0|user_input_translator|Add0~30\ ))
-- \DUT|vga_u0|user_input_translator|Add0~34\ = CARRY(( (\DUT|y\(4) & ((!\DUT|y\(3)) # ((!\DUT|y\(2)) # (!\DUT|x\(7))))) ) + ( \DUT|y\(6) ) + ( \DUT|vga_u0|user_input_translator|Add0~30\ ))
...
-- Equation(s):
-- \DUT|vga_u0|user_input_translator|Add0~37_sumout\ = SUM(( (\DUT|y\(4) & (\DUT|y\(3) & (\DUT|y\(2) & \DUT|x\(7)))) ) + ( \DUT|y\(5) ) + ( \DUT|vga_u0|user_input_translator|Add0~34\ ))
-- \DUT|vga_u0|user_input_translator|Add0~38\ = CARRY(( (\DUT|y\(4) & (\DUT|y\(3) & (\DUT|y\(2) & \DUT|x\(7)))) ) + ( \DUT|y\(5) ) + ( \DUT|vga_u0|user_input_translator|Add0~34\ ))
...
-- Equation(s):
-- \DUT|vga_u0|LessThan3~0_combout\ = ( \DUT|y\(4) & ( (\DUT|y\(6) & (\DUT|y\(5) & \DUT|y\(3))) ) )
...
-- Equation(s):
-- \DUT|vga_u0|VideoMemory|auto_generated|decode2|w_anode118w\(2) = ( !\DUT|vga_u0|LessThan3~0_combout\ & ( (\DUT|vga_u0|writeEn~0_combout\ & (\DUT|vga_u0|user_input_translator|Add0~5_sumout\ & !\DUT|vga_u0|user_input_translator|Add0~1_sumout\)) ) )
...
-- Equation(s):
-- \DUT|vga_u0|controller|always1~1_combout\ = ( !\DUT|vga_u0|controller|yCounter\(4) & ( (\DUT|vga_u0|controller|yCounter\(2) & (!\DUT|vga_u0|controller|yCounter\(0) & (!\DUT|vga_u0|controller|yCounter\(1) & \DUT|vga_u0|controller|yCounter\(3)))) ) )
...
-- Equation(s):
-- \DUT|vga_u0|controller|always1~0_combout\ = ( !\DUT|vga_u0|controller|yCounter\(8) & ( (!\DUT|vga_u0|controller|yCounter[6]~DUPLICATE_q\ & (\DUT|vga_u0|controller|yCounter\(9) & (!\DUT|vga_u0|controller|yCounter\(5) & 
-- !\DUT|vga_u0|controller|yCounter\(7)))) ) )
...
PORT MAP (
	...
	datab => \DUT|vga_u0|controller|ALT_INV_yCounter\(9),
	datac => \DUT|vga_u0|controller|ALT_INV_yCounter\(5),
	datad => \DUT|vga_u0|controller|ALT_INV_yCounter\(7),
	dataf => \DUT|vga_u0|controller|ALT_INV_yCounter\(8),
	combout => \DUT|vga_u0|controller|always1~0_combout\);

-- Location: FF_X37_Y79_N7
\DUT|vga_u0|controller|xCounter[2]~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|vga_u0|controller|xCounter[2]~DUPLICATE_q\);

-- Location: LABCELL_X36_Y79_N12
\DUT|vga_u0|controller|always1~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \DUT|vga_u0|controller|always1~2_combout\ = ( \DUT|vga_u0|controller|always1~0_combout\ & ( \DUT|vga_u0|controller|xCounter[2]~DUPLICATE_q\ & ( (\DUT|vga_u0|controller|Equal0~1_combout\ & (\DUT|vga_u0|controller|Equal0~0_combout\ & 
-- \DUT|vga_u0|controller|always1~1_combout\)) ) ) )
...
PORT MAP (
	...
	datae => \DUT|vga_u0|controller|ALT_INV_always1~0_combout\,
	dataf => \DUT|vga_u0|controller|ALT_INV_xCounter[2]~DUPLICATE_q\,
...
\DUT|vga_u0|controller|xCounter[7]~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|vga_u0|controller|xCounter[7]~DUPLICATE_q\);

-- Location: LABCELL_X35_Y79_N0
\DUT|vga_u0|controller|controller_translator|Add1~9\ : cyclonev_lcell_comb
-- Equation(s):
-- \DUT|vga_u0|controller|controller_translator|Add1~9_sumout\ = SUM(( !\DUT|vga_u0|controller|yCounter\(2) $ (!\DUT|vga_u0|controller|xCounter[7]~DUPLICATE_q\) ) + ( !VCC ) + ( !VCC ))
-- \DUT|vga_u0|controller|controller_translator|Add1~10\ = CARRY(( !\DUT|vga_u0|controller|yCounter\(2) $ (!\DUT|vga_u0|controller|xCounter[7]~DUPLICATE_q\) ) + ( !VCC ) + ( !VCC ))
-- \DUT|vga_u0|controller|controller_translator|Add1~11\ = SHARE((\DUT|vga_u0|controller|yCounter\(2) & \DUT|vga_u0|controller|xCounter[7]~DUPLICATE_q\))
...
PORT MAP (
	...
	datad => \DUT|vga_u0|controller|ALT_INV_xCounter[7]~DUPLICATE_q\,
	cin => GND,
	sharein => GND,
...
-- Equation(s):
-- \DUT|vga_u0|controller|controller_translator|Add1~13_sumout\ = SUM(( !\DUT|vga_u0|controller|xCounter[8]~DUPLICATE_q\ $ (!\DUT|vga_u0|controller|yCounter\(3)) ) + ( \DUT|vga_u0|controller|controller_translator|Add1~11\ ) + ( 
-- \DUT|vga_u0|controller|controller_translator|Add1~10\ ))
-- \DUT|vga_u0|controller|controller_translator|Add1~14\ = CARRY(( !\DUT|vga_u0|controller|xCounter[8]~DUPLICATE_q\ $ (!\DUT|vga_u0|controller|yCounter\(3)) ) + ( \DUT|vga_u0|controller|controller_translator|Add1~11\ ) + ( 
-- \DUT|vga_u0|controller|controller_translator|Add1~10\ ))
-- \DUT|vga_u0|controller|controller_translator|Add1~15\ = SHARE((\DUT|vga_u0|controller|xCounter[8]~DUPLICATE_q\ & \DUT|vga_u0|controller|yCounter\(3)))
...
-- Equation(s):
-- \DUT|vga_u0|controller|controller_translator|Add1~21_sumout\ = SUM(( !\DUT|vga_u0|controller|yCounter\(5) $ (!\DUT|vga_u0|controller|yCounter\(3)) ) + ( \DUT|vga_u0|controller|controller_translator|Add1~19\ ) + ( 
-- \DUT|vga_u0|controller|controller_translator|Add1~18\ ))
-- \DUT|vga_u0|controller|controller_translator|Add1~22\ = CARRY(( !\DUT|vga_u0|controller|yCounter\(5) $ (!\DUT|vga_u0|controller|yCounter\(3)) ) + ( \DUT|vga_u0|controller|controller_translator|Add1~19\ ) + ( 
-- \DUT|vga_u0|controller|controller_translator|Add1~18\ ))
-- \DUT|vga_u0|controller|controller_translator|Add1~23\ = SHARE((\DUT|vga_u0|controller|yCounter\(5) & \DUT|vga_u0|controller|yCounter\(3)))
...
-- Equation(s):
-- \DUT|Mux7~0_combout\ = ( \DUT|Add1~13_sumout\ & ( \DUT|Add2~13_sumout\ & ( ((!\DUT|octant~1_combout\ & (\DUT|offset_x~1_combout\)) # (\DUT|octant~1_combout\ & ((\DUT|offset_y~2_combout\)))) # (\DUT|x[2]~1_combout\) ) ) ) # ( !\DUT|Add1~13_sumout\ & ( 
-- \DUT|Add2~13_sumout\ & ( (!\DUT|octant~1_combout\ & (\DUT|offset_x~1_combout\ & ((!\DUT|x[2]~1_combout\)))) # (\DUT|octant~1_combout\ & (((\DUT|x[2]~1_combout\) # (\DUT|offset_y~2_combout\)))) ) ) ) # ( \DUT|Add1~13_sumout\ & ( !\DUT|Add2~13_sumout\ & ( 
-- (!\DUT|octant~1_combout\ & (((\DUT|x[2]~1_combout\)) # (\DUT|offset_x~1_combout\))) # (\DUT|octant~1_combout\ & (((\DUT|offset_y~2_combout\ & !\DUT|x[2]~1_combout\)))) ) ) ) # ( !\DUT|Add1~13_sumout\ & ( !\DUT|Add2~13_sumout\ & ( (!\DUT|x[2]~1_combout\ & 
-- ((!\DUT|octant~1_combout\ & (\DUT|offset_x~1_combout\)) # (\DUT|octant~1_combout\ & ((\DUT|offset_y~2_combout\))))) ) ) )
...
PORT MAP (
	dataa => \DUT|ALT_INV_octant~1_combout\,
	datab => \DUT|ALT_INV_offset_x~1_combout\,
	datac => \DUT|ALT_INV_offset_y~2_combout\,
	datad => \DUT|ALT_INV_x[2]~1_combout\,
	datae => \DUT|ALT_INV_Add1~13_sumout\,
	dataf => \DUT|ALT_INV_Add2~13_sumout\,
...
-- Equation(s):
-- \DUT|Mux6~0_combout\ = ( \DUT|Add2~17_sumout\ & ( \DUT|Add1~17_sumout\ & ( ((!\DUT|octant~1_combout\ & (\DUT|offset_x~2_combout\)) # (\DUT|octant~1_combout\ & ((\DUT|offset_y~3_combout\)))) # (\DUT|x[2]~1_combout\) ) ) ) # ( !\DUT|Add2~17_sumout\ & ( 
-- \DUT|Add1~17_sumout\ & ( (!\DUT|x[2]~1_combout\ & ((!\DUT|octant~1_combout\ & (\DUT|offset_x~2_combout\)) # (\DUT|octant~1_combout\ & ((\DUT|offset_y~3_combout\))))) # (\DUT|x[2]~1_combout\ & (((!\DUT|octant~1_combout\)))) ) ) ) # ( \DUT|Add2~17_sumout\ & 
-- ( !\DUT|Add1~17_sumout\ & ( (!\DUT|x[2]~1_combout\ & ((!\DUT|octant~1_combout\ & (\DUT|offset_x~2_combout\)) # (\DUT|octant~1_combout\ & ((\DUT|offset_y~3_combout\))))) # (\DUT|x[2]~1_combout\ & (((\DUT|octant~1_combout\)))) ) ) ) # ( 
-- !\DUT|Add2~17_sumout\ & ( !\DUT|Add1~17_sumout\ & ( (!\DUT|x[2]~1_combout\ & ((!\DUT|octant~1_combout\ & (\DUT|offset_x~2_combout\)) # (\DUT|octant~1_combout\ & ((\DUT|offset_y~3_combout\))))) ) ) )
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_offset_y~3_combout\,
	datac => \DUT|ALT_INV_x[2]~1_combout\,
	datad => \DUT|ALT_INV_octant~1_combout\,
	datae => \DUT|ALT_INV_Add2~17_sumout\,
	dataf => \DUT|ALT_INV_Add1~17_sumout\,
...
-- Equation(s):
-- \DUT|Mux5~0_combout\ = ( \DUT|Add2~21_sumout\ & ( \DUT|Add1~21_sumout\ & ( ((!\DUT|octant~1_combout\ & ((\DUT|Add3~13_sumout\))) # (\DUT|octant~1_combout\ & (\DUT|Add4~13_sumout\))) # (\DUT|x[2]~1_combout\) ) ) ) # ( !\DUT|Add2~21_sumout\ & ( 
-- \DUT|Add1~21_sumout\ & ( (!\DUT|x[2]~1_combout\ & ((!\DUT|octant~1_combout\ & ((\DUT|Add3~13_sumout\))) # (\DUT|octant~1_combout\ & (\DUT|Add4~13_sumout\)))) # (\DUT|x[2]~1_combout\ & (((!\DUT|octant~1_combout\)))) ) ) ) # ( \DUT|Add2~21_sumout\ & ( 
-- !\DUT|Add1~21_sumout\ & ( (!\DUT|x[2]~1_combout\ & ((!\DUT|octant~1_combout\ & ((\DUT|Add3~13_sumout\))) # (\DUT|octant~1_combout\ & (\DUT|Add4~13_sumout\)))) # (\DUT|x[2]~1_combout\ & (((\DUT|octant~1_combout\)))) ) ) ) # ( !\DUT|Add2~21_sumout\ & ( 
-- !\DUT|Add1~21_sumout\ & ( (!\DUT|x[2]~1_combout\ & ((!\DUT|octant~1_combout\ & ((\DUT|Add3~13_sumout\))) # (\DUT|octant~1_combout\ & (\DUT|Add4~13_sumout\)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add4~13_sumout\,
	datab => \DUT|ALT_INV_x[2]~1_combout\,
	datac => \DUT|ALT_INV_octant~1_combout\,
	datad => \DUT|ALT_INV_Add3~13_sumout\,
...
-- Equation(s):
-- \DUT|Mux4~0_combout\ = ( \DUT|octant~1_combout\ & ( \DUT|Add2~25_sumout\ & ( (\DUT|x[2]~1_combout\) # (\DUT|Add4~17_sumout\) ) ) ) # ( !\DUT|octant~1_combout\ & ( \DUT|Add2~25_sumout\ & ( (!\DUT|x[2]~1_combout\ & ((\DUT|Add3~17_sumout\))) # 
-- (\DUT|x[2]~1_combout\ & (\DUT|Add1~25_sumout\)) ) ) ) # ( \DUT|octant~1_combout\ & ( !\DUT|Add2~25_sumout\ & ( (\DUT|Add4~17_sumout\ & !\DUT|x[2]~1_combout\) ) ) ) # ( !\DUT|octant~1_combout\ & ( !\DUT|Add2~25_sumout\ & ( (!\DUT|x[2]~1_combout\ & 
-- ((\DUT|Add3~17_sumout\))) # (\DUT|x[2]~1_combout\ & (\DUT|Add1~25_sumout\)) ) ) )
...
-- Equation(s):
-- \DUT|Mux3~0_combout\ = ( \DUT|Add4~21_sumout\ & ( \DUT|Add2~29_sumout\ & ( ((!\DUT|x[2]~1_combout\ & (\DUT|Add3~21_sumout\)) # (\DUT|x[2]~1_combout\ & ((\DUT|Add1~29_sumout\)))) # (\DUT|octant~1_combout\) ) ) ) # ( !\DUT|Add4~21_sumout\ & ( 
-- \DUT|Add2~29_sumout\ & ( (!\DUT|x[2]~1_combout\ & (\DUT|Add3~21_sumout\ & ((!\DUT|octant~1_combout\)))) # (\DUT|x[2]~1_combout\ & (((\DUT|octant~1_combout\) # (\DUT|Add1~29_sumout\)))) ) ) ) # ( \DUT|Add4~21_sumout\ & ( !\DUT|Add2~29_sumout\ & ( 
-- (!\DUT|x[2]~1_combout\ & (((\DUT|octant~1_combout\)) # (\DUT|Add3~21_sumout\))) # (\DUT|x[2]~1_combout\ & (((\DUT|Add1~29_sumout\ & !\DUT|octant~1_combout\)))) ) ) ) # ( !\DUT|Add4~21_sumout\ & ( !\DUT|Add2~29_sumout\ & ( (!\DUT|octant~1_combout\ & 
-- ((!\DUT|x[2]~1_combout\ & (\DUT|Add3~21_sumout\)) # (\DUT|x[2]~1_combout\ & ((\DUT|Add1~29_sumout\))))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add3~21_sumout\,
	datab => \DUT|ALT_INV_x[2]~1_combout\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|on_screen~0_combout\ = ( !\DUT|vga_u0|controller|xCounter\(1) & ( !\DUT|vga_u0|controller|xCounter\(2) & ( (!\DUT|vga_u0|controller|xCounter\(3) & (!\DUT|vga_u0|controller|xCounter\(4) & (!\DUT|vga_u0|controller|xCounter\(6) & 
...
-- Equation(s):
-- \DUT|vga_u0|controller|LessThan7~0_combout\ = ( \DUT|vga_u0|controller|yCounter\(8) & ( (!\DUT|vga_u0|controller|yCounter\(9) & ((!\DUT|vga_u0|controller|yCounter[6]~DUPLICATE_q\) # ((!\DUT|vga_u0|controller|yCounter\(7)) # 
-- (!\DUT|vga_u0|controller|yCounter\(5))))) ) ) # ( !\DUT|vga_u0|controller|yCounter\(8) & ( !\DUT|vga_u0|controller|yCounter\(9) ) )
...
-- Equation(s):
-- \DUT|vga_u0|VideoMemory|auto_generated|decode2|w_anode105w\(2) = ( !\DUT|vga_u0|LessThan3~0_combout\ & ( (\DUT|vga_u0|writeEn~0_combout\ & (!\DUT|vga_u0|user_input_translator|Add0~5_sumout\ & !\DUT|vga_u0|user_input_translator|Add0~1_sumout\)) ) )
...
-- Equation(s):
-- \DUT|vga_u0|VideoMemory|auto_generated|decode2|w_anode126w\(2) = ( !\DUT|vga_u0|LessThan3~0_combout\ & ( (!\DUT|vga_u0|user_input_translator|Add0~5_sumout\ & (\DUT|vga_u0|user_input_translator|Add0~1_sumout\ & \DUT|vga_u0|writeEn~0_combout\)) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|vga_u0|user_input_translator|ALT_INV_Add0~5_sumout\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|VGA_R[0]~0_combout\ = ( \DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & ( \DUT|vga_u0|VideoMemory|auto_generated|ram_block1a8\ & ( (\DUT|vga_u0|controller|on_screen~1_combout\ & 
-- ((\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1)) # (\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a5~portbdataout\))) ) ) ) # ( !\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & ( 
...
-- \DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & ( !\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a8\ & ( (\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a5~portbdataout\ & (!\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) 
-- & \DUT|vga_u0|controller|on_screen~1_combout\)) ) ) ) # ( !\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & ( !\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a8\ & ( (!\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & 
-- (\DUT|vga_u0|controller|on_screen~1_combout\ & \DUT|vga_u0|VideoMemory|auto_generated|ram_block1a2~portbdataout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000001100000001000000010000000011000011110000011100000111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \DUT|vga_u0|VideoMemory|auto_generated|ALT_INV_ram_block1a2~portbdataout\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|VGA_G[0]~0_combout\ = ( \DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ( \DUT|vga_u0|controller|on_screen~1_combout\ & ( \DUT|vga_u0|VideoMemory|auto_generated|ram_block1a7~portbdataout\ ) ) ) # ( 
-- !\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ( \DUT|vga_u0|controller|on_screen~1_combout\ & ( (!\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & (\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a1~portbdataout\)) # 
-- (\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & ((\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a4~portbdataout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000001010000010111110011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|vga_u0|VideoMemory|auto_generated|ALT_INV_ram_block1a1~portbdataout\,
	...
	dataf => \DUT|vga_u0|controller|ALT_INV_on_screen~1_combout\,
	combout => \DUT|vga_u0|controller|VGA_G[0]~0_combout\);

-- Location: MLABCELL_X34_Y79_N33
\colour[2]~_wirecell\ : cyclonev_lcell_comb
-- Equation(s):
-- \colour[2]~_wirecell_combout\ = ( !colour(2) )
...
PORT MAP (
	dataf => ALT_INV_colour(2),
	combout => \colour[2]~_wirecell_combout\);
...
-- !\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & ( !\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a0~portbdataout\ & ( (\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & (\DUT|vga_u0|controller|on_screen~1_combout\ & 
-- \DUT|vga_u0|VideoMemory|auto_generated|ram_block1a6~portbdataout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000011000001000000011100001100000011110000010000000111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|vga_u0|VideoMemory|auto_generated|ALT_INV_ram_block1a3~portbdataout\,
	datab => \DUT|vga_u0|VideoMemory|auto_generated|ALT_INV_out_address_reg_b\(1),
	datac => \DUT|vga_u0|controller|ALT_INV_on_screen~1_combout\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|VGA_HS1~0_combout\ = ( \DUT|vga_u0|controller|xCounter\(2) & ( \DUT|vga_u0|controller|xCounter\(4) ) ) # ( !\DUT|vga_u0|controller|xCounter\(2) & ( (\DUT|vga_u0|controller|xCounter\(4) & (((\DUT|vga_u0|controller|xCounter\(1) & 
-- \DUT|vga_u0|controller|xCounter\(0))) # (\DUT|vga_u0|controller|xCounter\(3)))) ) )
...
-- Equation(s):
-- \DUT|vga_u0|controller|VGA_HS1~1_combout\ = ( \DUT|vga_u0|controller|xCounter[8]~DUPLICATE_q\ & ( \DUT|vga_u0|controller|xCounter[7]~DUPLICATE_q\ ) ) # ( !\DUT|vga_u0|controller|xCounter[8]~DUPLICATE_q\ & ( \DUT|vga_u0|controller|xCounter[7]~DUPLICATE_q\ 
-- & ( (!\DUT|vga_u0|controller|xCounter\(9)) # ((!\DUT|vga_u0|controller|xCounter\(6) & (!\DUT|vga_u0|controller|VGA_HS1~0_combout\ & !\DUT|vga_u0|controller|xCounter\(5))) # (\DUT|vga_u0|controller|xCounter\(6) & (\DUT|vga_u0|controller|VGA_HS1~0_combout\ 
-- & \DUT|vga_u0|controller|xCounter\(5)))) ) ) ) # ( \DUT|vga_u0|controller|xCounter[8]~DUPLICATE_q\ & ( !\DUT|vga_u0|controller|xCounter[7]~DUPLICATE_q\ ) ) # ( !\DUT|vga_u0|controller|xCounter[8]~DUPLICATE_q\ & ( 
-- !\DUT|vga_u0|controller|xCounter[7]~DUPLICATE_q\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111111111111111111111101100110011011111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \DUT|vga_u0|controller|ALT_INV_xCounter\(5),
	datae => \DUT|vga_u0|controller|ALT_INV_xCounter[8]~DUPLICATE_q\,
	dataf => \DUT|vga_u0|controller|ALT_INV_xCounter[7]~DUPLICATE_q\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|VGA_VS1~0_combout\ = ( \DUT|vga_u0|controller|yCounter\(3) & ( !\DUT|vga_u0|controller|yCounter\(4) & ( (\DUT|vga_u0|controller|yCounter\(2) & (!\DUT|vga_u0|controller|yCounter\(9) & (!\DUT|vga_u0|controller|yCounter\(0) $ 
...
PORT MAP (
	...
	datac => \DUT|vga_u0|controller|ALT_INV_yCounter\(1),
	datad => \DUT|vga_u0|controller|ALT_INV_yCounter\(9),
	datae => \DUT|vga_u0|controller|ALT_INV_yCounter\(3),
	dataf => \DUT|vga_u0|controller|ALT_INV_yCounter\(4),
...
-- Equation(s):
-- \DUT|vga_u0|controller|VGA_VS1~1_combout\ = ( \DUT|vga_u0|controller|yCounter\(5) & ( (!\DUT|vga_u0|controller|yCounter[6]~DUPLICATE_q\) # ((!\DUT|vga_u0|controller|yCounter\(7)) # ((!\DUT|vga_u0|controller|yCounter\(8)) # 
-- (!\DUT|vga_u0|controller|VGA_VS1~0_combout\))) ) ) # ( !\DUT|vga_u0|controller|yCounter\(5) )
