...
-- VGA_SYNC	=>  Location: PIN_AD30,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \DUT|offset_x[5]~DUPLICATE_q\ : std_logic;
...
SIGNAL \DUT|x[5]~DUPLICATE_q\ : std_logic;
...
SIGNAL \DUT|vga_u0|controller|yCounter[5]~DUPLICATE_q\ : std_logic;
...
SIGNAL \DUT|vga_u0|controller|xCounter[6]~DUPLICATE_q\ : std_logic;
...
SIGNAL \DUT|vga_u0|controller|yCounter[0]~DUPLICATE_q\ : std_logic;
...
SIGNAL \DUT|ALT_INV_x[5]~DUPLICATE_q\ : std_logic;
SIGNAL \DUT|ALT_INV_crit[1]~DUPLICATE_q\ : std_logic;
SIGNAL \DUT|ALT_INV_crit[2]~DUPLICATE_q\ : std_logic;
SIGNAL \DUT|ALT_INV_offset_x[5]~DUPLICATE_q\ : std_logic;
SIGNAL \DUT|ALT_INV_offset_x[3]~DUPLICATE_q\ : std_logic;
SIGNAL \DUT|ALT_INV_offset_x[0]~DUPLICATE_q\ : std_logic;
SIGNAL \DUT|vga_u0|controller|ALT_INV_yCounter[0]~DUPLICATE_q\ : std_logic;
SIGNAL \DUT|vga_u0|controller|ALT_INV_xCounter[6]~DUPLICATE_q\ : std_logic;
SIGNAL \DUT|vga_u0|controller|ALT_INV_yCounter[5]~DUPLICATE_q\ : std_logic;
...
\DUT|vga_u0|controller|controller_translator|Add1~13_sumout\ & \DUT|vga_u0|controller|controller_translator|Add1~9_sumout\ & \DUT|vga_u0|controller|xCounter[6]~DUPLICATE_q\ & \DUT|vga_u0|controller|xCounter[5]~DUPLICATE_q\ & 
\DUT|vga_u0|controller|xCounter\(4) & \DUT|vga_u0|controller|xCounter[3]~DUPLICATE_q\ & \DUT|vga_u0|controller|xCounter\(2));
...
\DUT|vga_u0|controller|controller_translator|Add1~9_sumout\ & \DUT|vga_u0|controller|xCounter[6]~DUPLICATE_q\ & \DUT|vga_u0|controller|xCounter[5]~DUPLICATE_q\ & \DUT|vga_u0|controller|xCounter\(4) & \DUT|vga_u0|controller|xCounter[3]~DUPLICATE_q\ & 
...
\DUT|ALT_INV_x[5]~DUPLICATE_q\ <= NOT \DUT|x[5]~DUPLICATE_q\;
\DUT|ALT_INV_crit[1]~DUPLICATE_q\ <= NOT \DUT|crit[1]~DUPLICATE_q\;
\DUT|ALT_INV_crit[2]~DUPLICATE_q\ <= NOT \DUT|crit[2]~DUPLICATE_q\;
\DUT|ALT_INV_offset_x[5]~DUPLICATE_q\ <= NOT \DUT|offset_x[5]~DUPLICATE_q\;
...
\DUT|vga_u0|controller|ALT_INV_yCounter[0]~DUPLICATE_q\ <= NOT \DUT|vga_u0|controller|yCounter[0]~DUPLICATE_q\;
\DUT|vga_u0|controller|ALT_INV_xCounter[6]~DUPLICATE_q\ <= NOT \DUT|vga_u0|controller|xCounter[6]~DUPLICATE_q\;
\DUT|vga_u0|controller|ALT_INV_yCounter[5]~DUPLICATE_q\ <= NOT \DUT|vga_u0|controller|yCounter[5]~DUPLICATE_q\;
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001111001100001100111100110000110011001100110011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \DUT|ALT_INV_current_state.01~q\,
...
-- Equation(s):
-- \DUT|octant[1]~5_combout\ = (\DUT|current_state.01~q\) # (\DUT|initx~q\)
...
-- Equation(s):
-- \DUT|octant~2_combout\ = ( \DUT|octant\(0) & ( !\DUT|octant\(2) $ (((!\DUT|octant\(1)) # (!\DUT|current_state.01~q\))) ) ) # ( !\DUT|octant\(0) & ( \DUT|octant\(2) ) )
...
-- Equation(s):
-- \DUT|drawdone~0_combout\ = ( \DUT|octant\(0) & ( (!\DUT|initx~q\ & (\DUT|octant\(1) & (\DUT|current_state.01~q\ & \DUT|octant\(2)))) ) )
...
-- Equation(s):
-- \DUT|next_state~8_combout\ = ( \DUT|drawdone~q\ & ( \DUT|current_state.01~q\ ) )
...
-- Equation(s):
-- \DUT|offset_y~1_combout\ = ( \DUT|offset_y\(0) & ( (!\DUT|initx~q\) # (!\DUT|loady~q\) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101010001000100010001010101010101010100010001000100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_offset_y\(1),
	datab => \DUT|ALT_INV_loady~q\,
...
-- Equation(s):
-- \DUT|offset_y~3_combout\ = (\DUT|offset_y\(2) & ((!\DUT|initx~q\) # (!\DUT|loady~q\)))
...
-- Equation(s):
-- \DUT|offset_x~0_combout\ = ( \DUT|offset_x\(0) & ( (!\DUT|loady~q\) # (!\DUT|initx~q\) ) )
...
-- Equation(s):
-- \DUT|offset_x~4_combout\ = ( \DUT|LessThan0~1_combout\ & ( (!\DUT|LessThan0~0_combout\ & (((\DUT|offset_x~0_combout\)))) # (\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~2_combout\ & (\DUT|Add13~1_sumout\)) # (\DUT|LessThan0~2_combout\ & 
-- ((\DUT|offset_x~0_combout\))))) ) ) # ( !\DUT|LessThan0~1_combout\ & ( (!\DUT|LessThan0~0_combout\ & ((\DUT|offset_x~0_combout\))) # (\DUT|LessThan0~0_combout\ & (\DUT|Add13~1_sumout\)) ) )
...
-- Equation(s):
-- \DUT|Add14~29_sumout\ = SUM(( !\DUT|Add13~1_sumout\ $ (!\DUT|Add10~1_sumout\) ) + ( !VCC ) + ( !VCC ))
-- \DUT|Add14~30\ = CARRY(( !\DUT|Add13~1_sumout\ $ (!\DUT|Add10~1_sumout\) ) + ( !VCC ) + ( !VCC ))
...
PORT MAP (
	datac => \DUT|ALT_INV_Add13~5_sumout\,
	datad => \DUT|ALT_INV_Add10~5_sumout\,
	cin => \DUT|Add14~30\,
...
-- Equation(s):
-- \DUT|Add11~33_sumout\ = SUM(( (!\DUT|initx~q\ & \DUT|crit[1]~DUPLICATE_q\) ) + ( \DUT|Add10~1_sumout\ ) + ( \DUT|Add11~6\ ))
-- \DUT|Add11~34\ = CARRY(( (!\DUT|initx~q\ & \DUT|crit[1]~DUPLICATE_q\) ) + ( \DUT|Add10~1_sumout\ ) + ( \DUT|Add11~6\ ))
...
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datac => \DUT|ALT_INV_crit[1]~DUPLICATE_q\,
...
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datac => \DUT|ALT_INV_crit[2]~DUPLICATE_q\,
	datad => \DUT|ALT_INV_Add10~5_sumout\,
	cin => \DUT|Add11~34\,
...
-- Equation(s):
-- \DUT|crit~7_combout\ = (!\DUT|LessThan0~3_combout\ & ((\DUT|Add11~29_sumout\))) # (\DUT|LessThan0~3_combout\ & (\DUT|Add15~29_sumout\))
...
PORT MAP (
	...
	datac => \DUT|ALT_INV_Add15~29_sumout\,
...
-- Equation(s):
-- \DUT|LessThan0~3_combout\ = ( \DUT|crit\(2) & ( \DUT|LessThan0~0_combout\ ) ) # ( !\DUT|crit\(2) & ( (\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~1_combout\) # (\DUT|crit\(1)))) ) )
...
-- Equation(s):
-- \DUT|crit~9_combout\ = (!\DUT|LessThan0~3_combout\ & (\DUT|Add11~33_sumout\)) # (\DUT|LessThan0~3_combout\ & ((\DUT|Add15~33_sumout\)))
...
PORT MAP (
	...
	datad => \DUT|ALT_INV_Add15~33_sumout\,
...
-- Equation(s):
-- \DUT|LessThan0~2_combout\ = (!\DUT|crit\(1) & !\DUT|crit\(2))
...
-- Equation(s):
-- \DUT|offset_x~10_combout\ = ( \DUT|offset_x[5]~DUPLICATE_q\ ) # ( !\DUT|offset_x[5]~DUPLICATE_q\ & ( (\DUT|initx~q\ & \DUT|loady~q\) ) )
...
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datac => \DUT|ALT_INV_loady~q\,
	dataf => \DUT|ALT_INV_offset_x[5]~DUPLICATE_q\,
	combout => \DUT|offset_x~10_combout\);

-- Location: LABCELL_X29_Y78_N12
\DUT|offset_x~11\ : cyclonev_lcell_comb
-- Equation(s):
-- \DUT|offset_x~11_combout\ = ( \DUT|Add13~21_sumout\ & ( ((\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~2_combout\) # (!\DUT|LessThan0~1_combout\)))) # (\DUT|offset_x~10_combout\) ) ) # ( !\DUT|Add13~21_sumout\ & ( (\DUT|offset_x~10_combout\ & 
-- ((!\DUT|LessThan0~0_combout\) # ((\DUT|LessThan0~2_combout\ & \DUT|LessThan0~1_combout\)))) ) )
...
PORT MAP (
	...
	dataf => \DUT|ALT_INV_Add13~21_sumout\,
	combout => \DUT|offset_x~11_combout\);

-- Location: FF_X29_Y78_N14
\DUT|offset_x[5]~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
-- Equation(s):
-- \DUT|offset_x~2_combout\ = ( \DUT|offset_x\(2) & ( (!\DUT|initx~q\) # (!\DUT|loady~q\) ) )
...
-- Equation(s):
-- \DUT|offset_x~6_combout\ = ( \DUT|LessThan0~0_combout\ & ( (!\DUT|LessThan0~1_combout\ & (((\DUT|Add13~9_sumout\)))) # (\DUT|LessThan0~1_combout\ & ((!\DUT|LessThan0~2_combout\ & (\DUT|Add13~9_sumout\)) # (\DUT|LessThan0~2_combout\ & 
-- ((\DUT|offset_x~2_combout\))))) ) ) # ( !\DUT|LessThan0~0_combout\ & ( \DUT|offset_x~2_combout\ ) )
...
-- Equation(s):
-- \DUT|Add13~13_sumout\ = SUM(( VCC ) + ( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x[3]~DUPLICATE_q\) ) + ( \DUT|Add13~10\ ))
-- \DUT|Add13~14\ = CARRY(( VCC ) + ( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x[3]~DUPLICATE_q\) ) + ( \DUT|Add13~10\ ))
...
-- Equation(s):
-- \DUT|Add13~25_sumout\ = SUM(( (\DUT|offset_x\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( \DUT|Add13~14\ ))
-- \DUT|Add13~26\ = CARRY(( (\DUT|offset_x\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( \DUT|Add13~14\ ))
...
-- Equation(s):
-- \DUT|offset_x~12_combout\ = ( \DUT|offset_x\(4) & ( (!\DUT|initx~q\) # (!\DUT|loady~q\) ) )
...
-- Equation(s):
-- \DUT|Add13~21_sumout\ = SUM(( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x[5]~DUPLICATE_q\) ) + ( VCC ) + ( \DUT|Add13~26\ ))
-- \DUT|Add13~22\ = CARRY(( ((\DUT|initx~q\ & \DUT|loady~q\)) # (\DUT|offset_x[5]~DUPLICATE_q\) ) + ( VCC ) + ( \DUT|Add13~26\ ))
...
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datab => \DUT|ALT_INV_loady~q\,
	datac => \DUT|ALT_INV_offset_x[5]~DUPLICATE_q\,
	cin => \DUT|Add13~26\,
...
-- Equation(s):
-- \DUT|Add14~5_sumout\ = SUM(( !\DUT|Add10~9_sumout\ $ (\DUT|Add13~9_sumout\) ) + ( \DUT|Add14~27\ ) + ( \DUT|Add14~26\ ))
-- \DUT|Add14~6\ = CARRY(( !\DUT|Add10~9_sumout\ $ (\DUT|Add13~9_sumout\) ) + ( \DUT|Add14~27\ ) + ( \DUT|Add14~26\ ))
-- \DUT|Add14~7\ = SHARE((\DUT|Add10~9_sumout\ & !\DUT|Add13~9_sumout\))
...
-- Equation(s):
-- \DUT|Add14~9_sumout\ = SUM(( !\DUT|Add13~13_sumout\ $ (\DUT|Add10~13_sumout\) ) + ( \DUT|Add14~7\ ) + ( \DUT|Add14~6\ ))
-- \DUT|Add14~10\ = CARRY(( !\DUT|Add13~13_sumout\ $ (\DUT|Add10~13_sumout\) ) + ( \DUT|Add14~7\ ) + ( \DUT|Add14~6\ ))
-- \DUT|Add14~11\ = SHARE((!\DUT|Add13~13_sumout\ & \DUT|Add10~13_sumout\))
...
-- Equation(s):
-- \DUT|Add14~13_sumout\ = SUM(( !\DUT|Add10~25_sumout\ $ (\DUT|Add13~25_sumout\) ) + ( \DUT|Add14~11\ ) + ( \DUT|Add14~10\ ))
-- \DUT|Add14~14\ = CARRY(( !\DUT|Add10~25_sumout\ $ (\DUT|Add13~25_sumout\) ) + ( \DUT|Add14~11\ ) + ( \DUT|Add14~10\ ))
-- \DUT|Add14~15\ = SHARE((\DUT|Add10~25_sumout\ & !\DUT|Add13~25_sumout\))
...
-- Equation(s):
-- \DUT|Add14~17_sumout\ = SUM(( !\DUT|Add10~21_sumout\ $ (\DUT|Add13~21_sumout\) ) + ( \DUT|Add14~15\ ) + ( \DUT|Add14~14\ ))
-- \DUT|Add14~18\ = CARRY(( !\DUT|Add10~21_sumout\ $ (\DUT|Add13~21_sumout\) ) + ( \DUT|Add14~15\ ) + ( \DUT|Add14~14\ ))
-- \DUT|Add14~19\ = SHARE((\DUT|Add10~21_sumout\ & !\DUT|Add13~21_sumout\))
...
-- Equation(s):
-- \DUT|Add15~13_sumout\ = SUM(( \DUT|Add14~9_sumout\ ) + ( (\DUT|crit\(4)) # (\DUT|initx~q\) ) + ( \DUT|Add15~10\ ))
-- \DUT|Add15~14\ = CARRY(( \DUT|Add14~9_sumout\ ) + ( (\DUT|crit\(4)) # (\DUT|initx~q\) ) + ( \DUT|Add15~10\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000101010100000000000000000000000000011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datab => \DUT|ALT_INV_Add14~9_sumout\,
...
-- Equation(s):
-- \DUT|Add11~13_sumout\ = SUM(( (\DUT|crit[4]~DUPLICATE_q\) # (\DUT|initx~q\) ) + ( \DUT|Add10~13_sumout\ ) + ( \DUT|Add11~10\ ))
-- \DUT|Add11~14\ = CARRY(( (\DUT|crit[4]~DUPLICATE_q\) # (\DUT|initx~q\) ) + ( \DUT|Add10~13_sumout\ ) + ( \DUT|Add11~10\ ))
...
PORT MAP (
	...
	dataf => \DUT|ALT_INV_Add10~13_sumout\,
	cin => \DUT|Add11~10\,
...
-- Equation(s):
-- \DUT|crit~3_combout\ = ( \DUT|crit\(4) & ( \DUT|Add11~13_sumout\ & ( (!\DUT|current_state.10~q\) # ((!\DUT|LessThan0~3_combout\) # (\DUT|Add15~13_sumout\)) ) ) ) # ( !\DUT|crit\(4) & ( \DUT|Add11~13_sumout\ & ( (!\DUT|current_state.10~q\ & 
-- (((\DUT|initx~q\)))) # (\DUT|current_state.10~q\ & ((!\DUT|LessThan0~3_combout\) # ((\DUT|Add15~13_sumout\)))) ) ) ) # ( \DUT|crit\(4) & ( !\DUT|Add11~13_sumout\ & ( (!\DUT|current_state.10~q\) # ((\DUT|LessThan0~3_combout\ & \DUT|Add15~13_sumout\)) ) ) ) 
-- # ( !\DUT|crit\(4) & ( !\DUT|Add11~13_sumout\ & ( (!\DUT|current_state.10~q\ & (((\DUT|initx~q\)))) # (\DUT|current_state.10~q\ & (\DUT|LessThan0~3_combout\ & ((\DUT|Add15~13_sumout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000101000011011101010101011101101001110010111111110111011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	dataf => \DUT|ALT_INV_Add11~13_sumout\,
...
-- Equation(s):
-- \DUT|Add11~17_sumout\ = SUM(( \DUT|Add10~25_sumout\ ) + ( (!\DUT|initx~q\ & \DUT|crit[5]~DUPLICATE_q\) ) + ( \DUT|Add11~14\ ))
-- \DUT|Add11~18\ = CARRY(( \DUT|Add10~25_sumout\ ) + ( (!\DUT|initx~q\ & \DUT|crit[5]~DUPLICATE_q\) ) + ( \DUT|Add11~14\ ))
...
PORT MAP (
	...
	dataf => \DUT|ALT_INV_crit[5]~DUPLICATE_q\,
	cin => \DUT|Add11~14\,
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111100001111000000110011010101010011001101010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add15~17_sumout\,
...
-- Equation(s):
-- \DUT|Add15~21_sumout\ = SUM(( \DUT|Add14~17_sumout\ ) + ( (\DUT|crit\(6)) # (\DUT|initx~q\) ) + ( \DUT|Add15~18\ ))
-- \DUT|Add15~22\ = CARRY(( \DUT|Add14~17_sumout\ ) + ( (\DUT|crit\(6)) # (\DUT|initx~q\) ) + ( \DUT|Add15~18\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000100010001000100000000000000000000000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datab => \DUT|ALT_INV_crit\(6),
...
-- Equation(s):
-- \DUT|Add11~21_sumout\ = SUM(( (\DUT|crit[6]~DUPLICATE_q\) # (\DUT|initx~q\) ) + ( \DUT|Add10~21_sumout\ ) + ( \DUT|Add11~18\ ))
-- \DUT|Add11~22\ = CARRY(( (\DUT|crit[6]~DUPLICATE_q\) # (\DUT|initx~q\) ) + ( \DUT|Add10~21_sumout\ ) + ( \DUT|Add11~18\ ))
...
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datac => \DUT|ALT_INV_crit[6]~DUPLICATE_q\,
	dataf => \DUT|ALT_INV_Add10~21_sumout\,
	cin => \DUT|Add11~18\,
...
PORT MAP (
	...
	datac => \DUT|ALT_INV_Add11~21_sumout\,
	datad => \DUT|ALT_INV_LessThan0~3_combout\,
...
-- Equation(s):
-- \DUT|offset_x~8_combout\ = ( \DUT|offset_x\(6) & ( (!\DUT|initx~q\) # (!\DUT|loady~q\) ) )
...
-- Equation(s):
-- \DUT|offset_x~9_combout\ = ( \DUT|LessThan0~1_combout\ & ( (!\DUT|LessThan0~0_combout\ & (((\DUT|offset_x~8_combout\)))) # (\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~2_combout\ & (\DUT|Add13~17_sumout\)) # (\DUT|LessThan0~2_combout\ & 
-- ((\DUT|offset_x~8_combout\))))) ) ) # ( !\DUT|LessThan0~1_combout\ & ( (!\DUT|LessThan0~0_combout\ & ((\DUT|offset_x~8_combout\))) # (\DUT|LessThan0~0_combout\ & (\DUT|Add13~17_sumout\)) ) )
...
PORT MAP (
	dataa => \DUT|ALT_INV_LessThan0~0_combout\,
	datab => \DUT|ALT_INV_LessThan0~2_combout\,
	datac => \DUT|ALT_INV_Add13~17_sumout\,
...
-- Equation(s):
-- \DUT|offset_y~5_combout\ = ( \DUT|offset_y\(6) & ( (!\DUT|initx~q\) # (!\DUT|loady~q\) ) )
...
-- Equation(s):
-- \DUT|Add14~21_sumout\ = SUM(( !\DUT|Add13~17_sumout\ $ (\DUT|Add10~17_sumout\) ) + ( \DUT|Add14~19\ ) + ( \DUT|Add14~18\ ))
-- \DUT|Add14~22\ = CARRY(( !\DUT|Add13~17_sumout\ $ (\DUT|Add10~17_sumout\) ) + ( \DUT|Add14~19\ ) + ( \DUT|Add14~18\ ))
-- \DUT|Add14~23\ = SHARE((!\DUT|Add13~17_sumout\ & \DUT|Add10~17_sumout\))
...
-- Equation(s):
-- \DUT|Add11~25_sumout\ = SUM(( (\DUT|crit\(7)) # (\DUT|initx~q\) ) + ( \DUT|Add10~17_sumout\ ) + ( \DUT|Add11~22\ ))
-- \DUT|Add11~26\ = CARRY(( (\DUT|crit\(7)) # (\DUT|initx~q\) ) + ( \DUT|Add10~17_sumout\ ) + ( \DUT|Add11~22\ ))
...
PORT MAP (
	...
	dataf => \DUT|ALT_INV_Add10~17_sumout\,
	cin => \DUT|Add11~22\,
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101111111111111111100000011110011110000001111001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datab => \DUT|ALT_INV_LessThan0~3_combout\,
	datac => \DUT|ALT_INV_Add15~25_sumout\,
...
-- Equation(s):
-- \DUT|LessThan0~1_combout\ = ( !\DUT|crit[4]~DUPLICATE_q\ & ( !\DUT|crit\(0) & ( (!\DUT|crit[6]~DUPLICATE_q\ & (!\DUT|crit[5]~DUPLICATE_q\ & (!\DUT|crit\(3) & !\DUT|crit\(7)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_crit[6]~DUPLICATE_q\,
	datab => \DUT|ALT_INV_crit[5]~DUPLICATE_q\,
	datac => \DUT|ALT_INV_crit\(3),
	datad => \DUT|ALT_INV_crit\(7),
	datae => \DUT|ALT_INV_crit[4]~DUPLICATE_q\,
	dataf => \DUT|ALT_INV_crit\(0),
	combout => \DUT|LessThan0~1_combout\);

-- Location: LABCELL_X30_Y78_N27
\DUT|offset_x~14\ : cyclonev_lcell_comb
-- Equation(s):
-- \DUT|offset_x~14_combout\ = ( \DUT|offset_x\(7) & ( (!\DUT|loady~q\) # (!\DUT|initx~q\) ) )
...
-- Equation(s):
-- \DUT|offset_x~15_combout\ = ( \DUT|LessThan0~0_combout\ & ( (!\DUT|LessThan0~1_combout\ & (((\DUT|Add13~29_sumout\)))) # (\DUT|LessThan0~1_combout\ & ((!\DUT|LessThan0~2_combout\ & (\DUT|Add13~29_sumout\)) # (\DUT|LessThan0~2_combout\ & 
-- ((\DUT|offset_x~14_combout\))))) ) ) # ( !\DUT|LessThan0~0_combout\ & ( \DUT|offset_x~14_combout\ ) )
...
-- Equation(s):
-- \DUT|Add13~29_sumout\ = SUM(( VCC ) + ( (\DUT|offset_x\(7) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add13~18\ ))
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add13~29_sumout\,
	cin => \DUT|Add14~22\,
...
-- Equation(s):
-- \DUT|Add15~1_sumout\ = SUM(( (\DUT|crit\(8)) # (\DUT|initx~q\) ) + ( \DUT|Add14~1_sumout\ ) + ( \DUT|Add15~26\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111100001111000000000000000000000111011101110111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
	datab => \DUT|ALT_INV_crit\(8),
...
-- Equation(s):
-- \DUT|crit~0_combout\ = ( \DUT|current_state.10~q\ & ( (!\DUT|LessThan0~3_combout\ & ((\DUT|Add11~1_sumout\))) # (\DUT|LessThan0~3_combout\ & (\DUT|Add15~1_sumout\)) ) ) # ( !\DUT|current_state.10~q\ & ( (!\DUT|LessThan0~3_combout\ & 
-- !\DUT|LessThan0~0_combout\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110000000000110011000000000000011101000111010001110100011101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add15~1_sumout\,
	datab => \DUT|ALT_INV_LessThan0~3_combout\,
	datac => \DUT|ALT_INV_Add11~1_sumout\,
	datad => \DUT|ALT_INV_LessThan0~0_combout\,
	dataf => \DUT|ALT_INV_current_state.10~q\,
...
-- Equation(s):
-- \DUT|LessThan0~0_combout\ = ( !\DUT|crit\(8) & ( !\DUT|initx~q\ ) )
...
-- Equation(s):
-- \DUT|offset_x~7_combout\ = ( \DUT|LessThan0~1_combout\ & ( (!\DUT|LessThan0~0_combout\ & (((\DUT|offset_x~3_combout\)))) # (\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~2_combout\ & (\DUT|Add13~13_sumout\)) # (\DUT|LessThan0~2_combout\ & 
-- ((\DUT|offset_x~3_combout\))))) ) ) # ( !\DUT|LessThan0~1_combout\ & ( (!\DUT|LessThan0~0_combout\ & ((\DUT|offset_x~3_combout\))) # (\DUT|LessThan0~0_combout\ & (\DUT|Add13~13_sumout\)) ) )
...
-- Equation(s):
-- \DUT|offset_x~3_combout\ = ( \DUT|offset_x[3]~DUPLICATE_q\ ) # ( !\DUT|offset_x[3]~DUPLICATE_q\ & ( (\DUT|initx~q\ & \DUT|loady~q\) ) )
...
-- Equation(s):
-- \DUT|LessThan1~5_combout\ = ( \DUT|Add10~9_sumout\ & ( \DUT|offset_x~6_combout\ & ( (\DUT|Add10~13_sumout\ & ((!\DUT|LessThan0~3_combout\ & (!\DUT|offset_x~3_combout\)) # (\DUT|LessThan0~3_combout\ & ((!\DUT|Add13~13_sumout\))))) ) ) ) # ( 
-- !\DUT|Add10~9_sumout\ & ( \DUT|offset_x~6_combout\ & ( (\DUT|Add10~13_sumout\ & ((!\DUT|LessThan0~3_combout\ & (!\DUT|offset_x~3_combout\)) # (\DUT|LessThan0~3_combout\ & ((!\DUT|Add13~13_sumout\))))) ) ) ) # ( \DUT|Add10~9_sumout\ & ( 
-- !\DUT|offset_x~6_combout\ & ( ((!\DUT|LessThan0~3_combout\ & (!\DUT|offset_x~3_combout\)) # (\DUT|LessThan0~3_combout\ & ((!\DUT|Add13~13_sumout\)))) # (\DUT|Add10~13_sumout\) ) ) ) # ( !\DUT|Add10~9_sumout\ & ( !\DUT|offset_x~6_combout\ & ( 
-- (\DUT|Add10~13_sumout\ & ((!\DUT|LessThan0~3_combout\ & (!\DUT|offset_x~3_combout\)) # (\DUT|LessThan0~3_combout\ & ((!\DUT|Add13~13_sumout\))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000101000001100101011111100111100001010000011000000101000001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_offset_x~3_combout\,
	datab => \DUT|ALT_INV_Add13~13_sumout\,
	datac => \DUT|ALT_INV_Add10~13_sumout\,
	datad => \DUT|ALT_INV_LessThan0~3_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~2_combout\ = ( \DUT|offset_x~3_combout\ & ( \DUT|LessThan0~0_combout\ & ( !\DUT|Add10~13_sumout\ $ (((!\DUT|Add13~13_sumout\ & ((!\DUT|LessThan0~1_combout\) # (!\DUT|LessThan0~2_combout\))))) ) ) ) # ( !\DUT|offset_x~3_combout\ & ( 
-- \DUT|LessThan0~0_combout\ & ( !\DUT|Add10~13_sumout\ $ (((!\DUT|Add13~13_sumout\) # ((\DUT|LessThan0~1_combout\ & \DUT|LessThan0~2_combout\)))) ) ) ) # ( \DUT|offset_x~3_combout\ & ( !\DUT|LessThan0~0_combout\ & ( !\DUT|Add10~13_sumout\ ) ) ) # ( 
-- !\DUT|offset_x~3_combout\ & ( !\DUT|LessThan0~0_combout\ & ( \DUT|Add10~13_sumout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110011110011001100110001100110011000110110011001101100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \DUT|ALT_INV_offset_x~3_combout\,
	dataf => \DUT|ALT_INV_LessThan0~0_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~3_combout\ = ( \DUT|offset_x~0_combout\ & ( \DUT|LessThan0~1_combout\ & ( (!\DUT|Add13~1_sumout\ & (\DUT|Add10~1_sumout\ & (\DUT|LessThan0~0_combout\ & !\DUT|LessThan0~2_combout\))) ) ) ) # ( !\DUT|offset_x~0_combout\ & ( 
-- \DUT|LessThan0~1_combout\ & ( (\DUT|Add10~1_sumout\ & ((!\DUT|Add13~1_sumout\) # ((!\DUT|LessThan0~0_combout\) # (\DUT|LessThan0~2_combout\)))) ) ) ) # ( \DUT|offset_x~0_combout\ & ( !\DUT|LessThan0~1_combout\ & ( (!\DUT|Add13~1_sumout\ & 
-- (\DUT|Add10~1_sumout\ & \DUT|LessThan0~0_combout\)) ) ) ) # ( !\DUT|offset_x~0_combout\ & ( !\DUT|LessThan0~1_combout\ & ( (\DUT|Add10~1_sumout\ & ((!\DUT|Add13~1_sumout\) # (!\DUT|LessThan0~0_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001000110010000000100000001000110010001100110000001000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add13~1_sumout\,
...
-- Equation(s):
-- \DUT|LessThan1~4_combout\ = ( \DUT|Add10~9_sumout\ & ( \DUT|offset_x~6_combout\ & ( (!\DUT|LessThan1~2_combout\ & ((!\DUT|LessThan1~3_combout\ & (\DUT|Add10~5_sumout\ & !\DUT|offset_x~5_combout\)) # (\DUT|LessThan1~3_combout\ & 
-- ((!\DUT|offset_x~5_combout\) # (\DUT|Add10~5_sumout\))))) ) ) ) # ( !\DUT|Add10~9_sumout\ & ( !\DUT|offset_x~6_combout\ & ( (!\DUT|LessThan1~2_combout\ & ((!\DUT|LessThan1~3_combout\ & (\DUT|Add10~5_sumout\ & !\DUT|offset_x~5_combout\)) # 
-- (\DUT|LessThan1~3_combout\ & ((!\DUT|offset_x~5_combout\) # (\DUT|Add10~5_sumout\))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010101000000010000000000000000000000000000000000010101000000010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \DUT|ALT_INV_offset_x~5_combout\,
	datae => \DUT|ALT_INV_Add10~9_sumout\,
	dataf => \DUT|ALT_INV_offset_x~6_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~6_combout\ = ( !\DUT|offset_x~10_combout\ & ( \DUT|Add13~21_sumout\ & ( (\DUT|Add10~21_sumout\ & ((!\DUT|LessThan0~0_combout\) # ((\DUT|LessThan0~2_combout\ & \DUT|LessThan0~1_combout\)))) ) ) ) # ( \DUT|offset_x~10_combout\ & ( 
-- !\DUT|Add13~21_sumout\ & ( (\DUT|LessThan0~0_combout\ & (\DUT|Add10~21_sumout\ & ((!\DUT|LessThan0~2_combout\) # (!\DUT|LessThan0~1_combout\)))) ) ) ) # ( !\DUT|offset_x~10_combout\ & ( !\DUT|Add13~21_sumout\ & ( \DUT|Add10~21_sumout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011111111000000000101010000000000101010110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_LessThan0~0_combout\,
	...
	datae => \DUT|ALT_INV_offset_x~10_combout\,
	dataf => \DUT|ALT_INV_Add13~21_sumout\,
...
-- Equation(s):
-- \DUT|LessThan1~7_combout\ = ( \DUT|offset_x~9_combout\ & ( \DUT|offset_x~14_combout\ & ( (!\DUT|Add13~29_sumout\ & (\DUT|LessThan1~6_combout\ & (\DUT|Add10~17_sumout\ & \DUT|LessThan0~3_combout\))) ) ) ) # ( !\DUT|offset_x~9_combout\ & ( 
-- \DUT|offset_x~14_combout\ & ( (!\DUT|Add13~29_sumout\ & (\DUT|LessThan0~3_combout\ & ((\DUT|Add10~17_sumout\) # (\DUT|LessThan1~6_combout\)))) ) ) ) # ( \DUT|offset_x~9_combout\ & ( !\DUT|offset_x~14_combout\ & ( (\DUT|LessThan1~6_combout\ & 
-- (\DUT|Add10~17_sumout\ & ((!\DUT|Add13~29_sumout\) # (!\DUT|LessThan0~3_combout\)))) ) ) ) # ( !\DUT|offset_x~9_combout\ & ( !\DUT|offset_x~14_combout\ & ( (!\DUT|Add13~29_sumout\ & (((\DUT|Add10~17_sumout\)) # (\DUT|LessThan1~6_combout\))) # 
-- (\DUT|Add13~29_sumout\ & (!\DUT|LessThan0~3_combout\ & ((\DUT|Add10~17_sumout\) # (\DUT|LessThan1~6_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011111100101010000000110000001000000000001010100000000000000010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add13~29_sumout\,
	datab => \DUT|ALT_INV_LessThan1~6_combout\,
	datac => \DUT|ALT_INV_Add10~17_sumout\,
	datad => \DUT|ALT_INV_LessThan0~3_combout\,
	datae => \DUT|ALT_INV_offset_x~9_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~0_combout\ = ( \DUT|offset_x~10_combout\ & ( \DUT|Add13~21_sumout\ & ( !\DUT|Add10~21_sumout\ ) ) ) # ( !\DUT|offset_x~10_combout\ & ( \DUT|Add13~21_sumout\ & ( !\DUT|Add10~21_sumout\ $ (((!\DUT|LessThan0~0_combout\) # 
-- ((\DUT|LessThan0~2_combout\ & \DUT|LessThan0~1_combout\)))) ) ) ) # ( \DUT|offset_x~10_combout\ & ( !\DUT|Add13~21_sumout\ & ( !\DUT|Add10~21_sumout\ $ (((\DUT|LessThan0~0_combout\ & ((!\DUT|LessThan0~2_combout\) # (!\DUT|LessThan0~1_combout\))))) ) ) ) # 
-- ( !\DUT|offset_x~10_combout\ & ( !\DUT|Add13~21_sumout\ & ( \DUT|Add10~21_sumout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011111111101010110101010001010100101010111111111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_LessThan0~0_combout\,
...
-- Equation(s):
-- \DUT|LessThan1~1_combout\ = ( \DUT|offset_x~9_combout\ & ( \DUT|offset_x~14_combout\ & ( (!\DUT|Add13~29_sumout\ & (!\DUT|LessThan1~0_combout\ & (\DUT|Add10~17_sumout\ & \DUT|LessThan0~3_combout\))) ) ) ) # ( !\DUT|offset_x~9_combout\ & ( 
-- \DUT|offset_x~14_combout\ & ( (!\DUT|Add13~29_sumout\ & (!\DUT|LessThan1~0_combout\ & (!\DUT|Add10~17_sumout\ & \DUT|LessThan0~3_combout\))) ) ) ) # ( \DUT|offset_x~9_combout\ & ( !\DUT|offset_x~14_combout\ & ( (!\DUT|LessThan1~0_combout\ & 
-- (\DUT|Add10~17_sumout\ & ((!\DUT|Add13~29_sumout\) # (!\DUT|LessThan0~3_combout\)))) ) ) ) # ( !\DUT|offset_x~9_combout\ & ( !\DUT|offset_x~14_combout\ & ( (!\DUT|LessThan1~0_combout\ & (!\DUT|Add10~17_sumout\ & ((!\DUT|Add13~29_sumout\) # 
-- (!\DUT|LessThan0~3_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100000010000000000011000000100000000000100000000000000000001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add13~29_sumout\,
...
-- Equation(s):
-- \DUT|LessThan1~8_combout\ = ( \DUT|Add10~25_sumout\ & ( \DUT|offset_x~13_combout\ & ( ((\DUT|LessThan1~1_combout\ & ((\DUT|LessThan1~4_combout\) # (\DUT|LessThan1~5_combout\)))) # (\DUT|LessThan1~7_combout\) ) ) ) # ( !\DUT|Add10~25_sumout\ & ( 
-- \DUT|offset_x~13_combout\ & ( \DUT|LessThan1~7_combout\ ) ) ) # ( \DUT|Add10~25_sumout\ & ( !\DUT|offset_x~13_combout\ & ( (\DUT|LessThan1~1_combout\) # (\DUT|LessThan1~7_combout\) ) ) ) # ( !\DUT|Add10~25_sumout\ & ( !\DUT|offset_x~13_combout\ & ( 
-- ((\DUT|LessThan1~1_combout\ & ((\DUT|LessThan1~4_combout\) # (\DUT|LessThan1~5_combout\)))) # (\DUT|LessThan1~7_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111101111111000011111111111100001111000011110000111101111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_LessThan1~5_combout\,
	datab => \DUT|ALT_INV_LessThan1~4_combout\,
	datac => \DUT|ALT_INV_LessThan1~7_combout\,
	datad => \DUT|ALT_INV_LessThan1~1_combout\,
	datae => \DUT|ALT_INV_Add10~25_sumout\,
	dataf => \DUT|ALT_INV_offset_x~13_combout\,
	combout => \DUT|LessThan1~8_combout\);

-- Location: FF_X29_Y79_N1
\DUT|done\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Equation(s):
-- \DUT|Selector0~0_combout\ = ( \DUT|drawdone~DUPLICATE_q\ & ( (!\DUT|current_state.00~q\) # ((!\DUT|done~q\ & \DUT|current_state.10~q\)) ) ) # ( !\DUT|drawdone~DUPLICATE_q\ & ( (!\DUT|current_state.00~q\) # (((!\DUT|done~q\ & \DUT|current_state.10~q\)) # 
-- (\DUT|current_state.01~q\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010111111101111101011111110111110101010111011101010101011101110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_current_state.00~q\,
	datab => \DUT|ALT_INV_done~q\,
	datac => \DUT|ALT_INV_current_state.01~q\,
	datad => \DUT|ALT_INV_current_state.10~q\,
	dataf => \DUT|ALT_INV_drawdone~DUPLICATE_q\,
...
-- Equation(s):
-- \DUT|Add5~17_sumout\ = SUM(( (\DUT|offset_y\(2) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( !VCC ))
-- \DUT|Add5~18\ = CARRY(( (\DUT|offset_y\(2) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|Add5~13_sumout\ = SUM(( (\DUT|offset_y\(3) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( \DUT|Add5~18\ ))
-- \DUT|Add5~14\ = CARRY(( (\DUT|offset_y\(3) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( \DUT|Add5~18\ ))
...
-- Equation(s):
-- \DUT|Add6~17_sumout\ = SUM(( VCC ) + ( (\DUT|offset_x\(2) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( !VCC ))
-- \DUT|Add6~18\ = CARRY(( VCC ) + ( (\DUT|offset_x\(2) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|Add6~13_sumout\ = SUM(( VCC ) + ( ((\DUT|loady~q\ & \DUT|initx~q\)) # (\DUT|offset_x[3]~DUPLICATE_q\) ) + ( \DUT|Add6~18\ ))
-- \DUT|Add6~14\ = CARRY(( VCC ) + ( ((\DUT|loady~q\ & \DUT|initx~q\)) # (\DUT|offset_x[3]~DUPLICATE_q\) ) + ( \DUT|Add6~18\ ))
...
-- Equation(s):
-- \DUT|Add8~25_sumout\ = SUM(( (!\DUT|offset_x\(1)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add8~22\ ))
-- \DUT|Add8~26\ = CARRY(( (!\DUT|offset_x\(1)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add8~22\ ))
...
-- Equation(s):
-- \DUT|Add8~17_sumout\ = SUM(( VCC ) + ( (!\DUT|offset_x\(2)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( \DUT|Add8~26\ ))
-- \DUT|Add8~18\ = CARRY(( VCC ) + ( (!\DUT|offset_x\(2)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( \DUT|Add8~26\ ))
...
-- Equation(s):
-- \DUT|Add8~13_sumout\ = SUM(( VCC ) + ( (!\DUT|offset_x[3]~DUPLICATE_q\ & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( \DUT|Add8~18\ ))
-- \DUT|Add8~14\ = CARRY(( VCC ) + ( (!\DUT|offset_x[3]~DUPLICATE_q\ & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( \DUT|Add8~18\ ))
...
-- Equation(s):
-- \DUT|Add7~25_sumout\ = SUM(( GND ) + ( (!\DUT|offset_y\(1)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add7~22\ ))
-- \DUT|Add7~26\ = CARRY(( GND ) + ( (!\DUT|offset_y\(1)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add7~22\ ))
...
-- Equation(s):
-- \DUT|Add7~17_sumout\ = SUM(( (!\DUT|offset_y\(2)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( VCC ) + ( \DUT|Add7~26\ ))
-- \DUT|Add7~18\ = CARRY(( (!\DUT|offset_y\(2)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( VCC ) + ( \DUT|Add7~26\ ))
...
-- Equation(s):
-- \DUT|Add7~13_sumout\ = SUM(( (!\DUT|offset_y\(3)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( VCC ) + ( \DUT|Add7~18\ ))
-- \DUT|Add7~14\ = CARRY(( (!\DUT|offset_y\(3)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( VCC ) + ( \DUT|Add7~18\ ))
...
-- Equation(s):
-- \DUT|Mux11~0_combout\ = ( \DUT|Add7~13_sumout\ & ( \DUT|octant~0_combout\ & ( (!\DUT|octant~1_combout\) # (\DUT|Add8~13_sumout\) ) ) ) # ( !\DUT|Add7~13_sumout\ & ( \DUT|octant~0_combout\ & ( (\DUT|octant~1_combout\ & \DUT|Add8~13_sumout\) ) ) ) # ( 
-- \DUT|Add7~13_sumout\ & ( !\DUT|octant~0_combout\ & ( (!\DUT|octant~1_combout\ & (\DUT|Add5~13_sumout\)) # (\DUT|octant~1_combout\ & ((\DUT|Add6~13_sumout\))) ) ) ) # ( !\DUT|Add7~13_sumout\ & ( !\DUT|octant~0_combout\ & ( (!\DUT|octant~1_combout\ & 
-- (\DUT|Add5~13_sumout\)) # (\DUT|octant~1_combout\ & ((\DUT|Add6~13_sumout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add5~13_sumout\,
	datab => \DUT|ALT_INV_octant~1_combout\,
	datac => \DUT|ALT_INV_Add6~13_sumout\,
	datad => \DUT|ALT_INV_Add8~13_sumout\,
	datae => \DUT|ALT_INV_Add7~13_sumout\,
...
-- Equation(s):
-- \DUT|Add5~9_sumout\ = SUM(( VCC ) + ( (\DUT|offset_y\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add5~14\ ))
-- \DUT|Add5~10\ = CARRY(( VCC ) + ( (\DUT|offset_y\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add5~14\ ))
...
-- Equation(s):
-- \DUT|Add7~9_sumout\ = SUM(( VCC ) + ( (!\DUT|offset_y\(4)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add7~14\ ))
-- \DUT|Add7~10\ = CARRY(( VCC ) + ( (!\DUT|offset_y\(4)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add7~14\ ))
...
-- Equation(s):
-- \DUT|Mux10~0_combout\ = ( \DUT|Add5~9_sumout\ & ( \DUT|Add7~9_sumout\ & ( (!\DUT|octant~1_combout\) # ((!\DUT|octant~0_combout\ & (\DUT|Add6~9_sumout\)) # (\DUT|octant~0_combout\ & ((\DUT|Add8~9_sumout\)))) ) ) ) # ( !\DUT|Add5~9_sumout\ & ( 
-- \DUT|Add7~9_sumout\ & ( (!\DUT|octant~0_combout\ & (\DUT|Add6~9_sumout\ & (\DUT|octant~1_combout\))) # (\DUT|octant~0_combout\ & (((!\DUT|octant~1_combout\) # (\DUT|Add8~9_sumout\)))) ) ) ) # ( \DUT|Add5~9_sumout\ & ( !\DUT|Add7~9_sumout\ & ( 
-- (!\DUT|octant~0_combout\ & (((!\DUT|octant~1_combout\)) # (\DUT|Add6~9_sumout\))) # (\DUT|octant~0_combout\ & (((\DUT|octant~1_combout\ & \DUT|Add8~9_sumout\)))) ) ) ) # ( !\DUT|Add5~9_sumout\ & ( !\DUT|Add7~9_sumout\ & ( (\DUT|octant~1_combout\ & 
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_octant~0_combout\,
	datac => \DUT|ALT_INV_octant~1_combout\,
	datad => \DUT|ALT_INV_Add8~9_sumout\,
	datae => \DUT|ALT_INV_Add5~9_sumout\,
	dataf => \DUT|ALT_INV_Add7~9_sumout\,
...
-- Equation(s):
-- \DUT|Add5~5_sumout\ = SUM(( VCC ) + ( (\DUT|offset_y\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add5~10\ ))
-- \DUT|Add5~6\ = CARRY(( VCC ) + ( (\DUT|offset_y\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add5~10\ ))
...
-- Equation(s):
-- \DUT|Add8~5_sumout\ = SUM(( VCC ) + ( (!\DUT|offset_x[5]~DUPLICATE_q\ & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( \DUT|Add8~10\ ))
-- \DUT|Add8~6\ = CARRY(( VCC ) + ( (!\DUT|offset_x[5]~DUPLICATE_q\ & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( \DUT|Add8~10\ ))
...
-- Equation(s):
-- \DUT|Add6~5_sumout\ = SUM(( VCC ) + ( ((\DUT|loady~q\ & \DUT|initx~q\)) # (\DUT|offset_x[5]~DUPLICATE_q\) ) + ( \DUT|Add6~10\ ))
-- \DUT|Add6~6\ = CARRY(( VCC ) + ( ((\DUT|loady~q\ & \DUT|initx~q\)) # (\DUT|offset_x[5]~DUPLICATE_q\) ) + ( \DUT|Add6~10\ ))
...
-- Equation(s):
-- \DUT|Add7~5_sumout\ = SUM(( VCC ) + ( (!\DUT|offset_y\(5)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add7~10\ ))
-- \DUT|Add7~6\ = CARRY(( VCC ) + ( (!\DUT|offset_y\(5)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add7~10\ ))
...
-- Equation(s):
-- \DUT|Mux9~0_combout\ = ( \DUT|Add7~5_sumout\ & ( \DUT|octant~1_combout\ & ( (!\DUT|octant~0_combout\ & ((\DUT|Add6~5_sumout\))) # (\DUT|octant~0_combout\ & (\DUT|Add8~5_sumout\)) ) ) ) # ( !\DUT|Add7~5_sumout\ & ( \DUT|octant~1_combout\ & ( 
-- (!\DUT|octant~0_combout\ & ((\DUT|Add6~5_sumout\))) # (\DUT|octant~0_combout\ & (\DUT|Add8~5_sumout\)) ) ) ) # ( \DUT|Add7~5_sumout\ & ( !\DUT|octant~1_combout\ & ( (\DUT|octant~0_combout\) # (\DUT|Add5~5_sumout\) ) ) ) # ( !\DUT|Add7~5_sumout\ & ( 
-- !\DUT|octant~1_combout\ & ( (\DUT|Add5~5_sumout\ & !\DUT|octant~0_combout\) ) ) )
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_Add8~5_sumout\,
	datac => \DUT|ALT_INV_octant~0_combout\,
	datad => \DUT|ALT_INV_Add6~5_sumout\,
...
-- Equation(s):
-- \DUT|Add7~1_sumout\ = SUM(( (!\DUT|offset_y\(6)) # ((\DUT|loady~q\ & \DUT|initx~q\)) ) + ( GND ) + ( \DUT|Add7~6\ ))
...
-- Equation(s):
-- \DUT|Add8~1_sumout\ = SUM(( (!\DUT|offset_x\(6)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( GND ) + ( \DUT|Add8~6\ ))
...
-- Equation(s):
-- \DUT|Add6~1_sumout\ = SUM(( (\DUT|offset_x\(6) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add6~6\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111111111111100000000000000000101010001010100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_offset_x\(6),
...
-- Equation(s):
-- \DUT|Add5~1_sumout\ = SUM(( (\DUT|offset_y\(6) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( GND ) + ( \DUT|Add5~6\ ))
...
-- Equation(s):
-- \DUT|Mux8~0_combout\ = ( \DUT|Add6~1_sumout\ & ( \DUT|Add5~1_sumout\ & ( (!\DUT|octant~0_combout\) # ((!\DUT|octant~1_combout\ & (\DUT|Add7~1_sumout\)) # (\DUT|octant~1_combout\ & ((\DUT|Add8~1_sumout\)))) ) ) ) # ( !\DUT|Add6~1_sumout\ & ( 
-- \DUT|Add5~1_sumout\ & ( (!\DUT|octant~0_combout\ & (((!\DUT|octant~1_combout\)))) # (\DUT|octant~0_combout\ & ((!\DUT|octant~1_combout\ & (\DUT|Add7~1_sumout\)) # (\DUT|octant~1_combout\ & ((\DUT|Add8~1_sumout\))))) ) ) ) # ( \DUT|Add6~1_sumout\ & ( 
-- !\DUT|Add5~1_sumout\ & ( (!\DUT|octant~0_combout\ & (((\DUT|octant~1_combout\)))) # (\DUT|octant~0_combout\ & ((!\DUT|octant~1_combout\ & (\DUT|Add7~1_sumout\)) # (\DUT|octant~1_combout\ & ((\DUT|Add8~1_sumout\))))) ) ) ) # ( !\DUT|Add6~1_sumout\ & ( 
-- !\DUT|Add5~1_sumout\ & ( (\DUT|octant~0_combout\ & ((!\DUT|octant~1_combout\ & (\DUT|Add7~1_sumout\)) # (\DUT|octant~1_combout\ & ((\DUT|Add8~1_sumout\))))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add7~1_sumout\,
	datab => \DUT|ALT_INV_octant~0_combout\,
	datac => \DUT|ALT_INV_octant~1_combout\,
	datad => \DUT|ALT_INV_Add8~1_sumout\,
	datae => \DUT|ALT_INV_Add6~1_sumout\,
	dataf => \DUT|ALT_INV_Add5~1_sumout\,
...
-- Equation(s):
-- \DUT|vga_u0|LessThan3~0_combout\ = ( \DUT|y\(6) & ( (\DUT|y\(3) & (\DUT|y\(4) & \DUT|y\(5))) ) )
...
-- Equation(s):
-- \DUT|Add4~13_sumout\ = SUM(( (\DUT|offset_y\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( !VCC ))
-- \DUT|Add4~14\ = CARRY(( (\DUT|offset_y\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( VCC ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|Add4~9_sumout\ = SUM(( (\DUT|offset_y\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add4~14\ ))
-- \DUT|Add4~10\ = CARRY(( (\DUT|offset_y\(5) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( GND ) + ( \DUT|Add4~14\ ))
...
-- Equation(s):
-- \DUT|Add4~5_sumout\ = SUM(( VCC ) + ( (\DUT|offset_y\(6) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( \DUT|Add4~10\ ))
-- \DUT|Add4~6\ = CARRY(( VCC ) + ( (\DUT|offset_y\(6) & ((!\DUT|loady~q\) # (!\DUT|initx~q\))) ) + ( \DUT|Add4~10\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111110000001100000000000000001111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \DUT|ALT_INV_loady~q\,
...
-- Equation(s):
-- \DUT|Add1~17_sumout\ = SUM(( (!\DUT|offset_x\(1)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( GND ) + ( \DUT|Add1~14\ ))
-- \DUT|Add1~18\ = CARRY(( (!\DUT|offset_x\(1)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( GND ) + ( \DUT|Add1~14\ ))
...
-- Equation(s):
-- \DUT|Add1~29_sumout\ = SUM(( VCC ) + ( (!\DUT|offset_x\(4)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add1~26\ ))
-- \DUT|Add1~30\ = CARRY(( VCC ) + ( (!\DUT|offset_x\(4)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add1~26\ ))
...
-- Equation(s):
-- \DUT|Add3~13_sumout\ = SUM(( VCC ) + ( (\DUT|offset_x\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( !VCC ))
-- \DUT|Add3~14\ = CARRY(( VCC ) + ( (\DUT|offset_x\(4) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( !VCC ))
...
-- Equation(s):
-- \DUT|Add2~17_sumout\ = SUM(( (!\DUT|offset_y\(1)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( GND ) + ( \DUT|Add2~14\ ))
-- \DUT|Add2~18\ = CARRY(( (!\DUT|offset_y\(1)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( GND ) + ( \DUT|Add2~14\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111111111111100000000000000001111111100000101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
...
-- Equation(s):
-- \DUT|Add2~21_sumout\ = SUM(( GND ) + ( (!\DUT|offset_y\(2)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add2~18\ ))
-- \DUT|Add2~22\ = CARRY(( GND ) + ( (!\DUT|offset_y\(2)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add2~18\ ))
...
-- Equation(s):
-- \DUT|Add2~25_sumout\ = SUM(( (!\DUT|offset_y\(3)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( GND ) + ( \DUT|Add2~22\ ))
-- \DUT|Add2~26\ = CARRY(( (!\DUT|offset_y\(3)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( GND ) + ( \DUT|Add2~22\ ))
...
-- Equation(s):
-- \DUT|Add2~29_sumout\ = SUM(( (!\DUT|offset_y\(4)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( VCC ) + ( \DUT|Add2~26\ ))
-- \DUT|Add2~30\ = CARRY(( (!\DUT|offset_y\(4)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( VCC ) + ( \DUT|Add2~26\ ))
...
-- Equation(s):
-- \DUT|Add2~9_sumout\ = SUM(( GND ) + ( (!\DUT|offset_y\(5)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add2~30\ ))
-- \DUT|Add2~10\ = CARRY(( GND ) + ( (!\DUT|offset_y\(5)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add2~30\ ))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000001111101000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_initx~q\,
...
-- Equation(s):
-- \DUT|Mux1~0_combout\ = ( \DUT|octant~1_combout\ & ( \DUT|Add2~5_sumout\ & ( (\DUT|x[5]~1_combout\) # (\DUT|Add4~5_sumout\) ) ) ) # ( !\DUT|octant~1_combout\ & ( \DUT|Add2~5_sumout\ & ( (!\DUT|x[5]~1_combout\ & ((\DUT|Add3~5_sumout\))) # 
-- (\DUT|x[5]~1_combout\ & (\DUT|Add1~5_sumout\)) ) ) ) # ( \DUT|octant~1_combout\ & ( !\DUT|Add2~5_sumout\ & ( (\DUT|Add4~5_sumout\ & !\DUT|x[5]~1_combout\) ) ) ) # ( !\DUT|octant~1_combout\ & ( !\DUT|Add2~5_sumout\ & ( (!\DUT|x[5]~1_combout\ & 
...
-- Equation(s):
-- \DUT|Mux2~0_combout\ = ( \DUT|Add4~9_sumout\ & ( \DUT|Add2~9_sumout\ & ( ((!\DUT|x[5]~1_combout\ & ((\DUT|Add3~9_sumout\))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~9_sumout\))) # (\DUT|octant~1_combout\) ) ) ) # ( !\DUT|Add4~9_sumout\ & ( \DUT|Add2~9_sumout\ 
-- & ( (!\DUT|x[5]~1_combout\ & (((!\DUT|octant~1_combout\ & \DUT|Add3~9_sumout\)))) # (\DUT|x[5]~1_combout\ & (((\DUT|octant~1_combout\)) # (\DUT|Add1~9_sumout\))) ) ) ) # ( \DUT|Add4~9_sumout\ & ( !\DUT|Add2~9_sumout\ & ( (!\DUT|x[5]~1_combout\ & 
-- (((\DUT|Add3~9_sumout\) # (\DUT|octant~1_combout\)))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~9_sumout\ & (!\DUT|octant~1_combout\))) ) ) ) # ( !\DUT|Add4~9_sumout\ & ( !\DUT|Add2~9_sumout\ & ( (!\DUT|octant~1_combout\ & ((!\DUT|x[5]~1_combout\ & 
-- ((\DUT|Add3~9_sumout\))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~9_sumout\)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add1~9_sumout\,
	datab => \DUT|ALT_INV_x[5]~1_combout\,
	datac => \DUT|ALT_INV_octant~1_combout\,
	datad => \DUT|ALT_INV_Add3~9_sumout\,
	datae => \DUT|ALT_INV_Add4~9_sumout\,
...
-- Equation(s):
-- \DUT|Add1~1_sumout\ = SUM(( GND ) + ( (!\DUT|offset_x\(7)) # ((\DUT|initx~q\ & \DUT|loady~q\)) ) + ( \DUT|Add1~6\ ))
...
-- Equation(s):
-- \DUT|Add3~1_sumout\ = SUM(( GND ) + ( (\DUT|offset_x\(7) & ((!\DUT|initx~q\) # (!\DUT|loady~q\))) ) + ( \DUT|Add3~6\ ))
...
-- Equation(s):
-- \DUT|Mux0~0_combout\ = ( \DUT|x[5]~1_combout\ & ( \DUT|Add4~1_sumout\ & ( (!\DUT|octant~1_combout\ & (\DUT|Add1~1_sumout\)) # (\DUT|octant~1_combout\ & ((\DUT|Add2~1_sumout\))) ) ) ) # ( !\DUT|x[5]~1_combout\ & ( \DUT|Add4~1_sumout\ & ( 
-- (\DUT|octant~1_combout\) # (\DUT|Add3~1_sumout\) ) ) ) # ( \DUT|x[5]~1_combout\ & ( !\DUT|Add4~1_sumout\ & ( (!\DUT|octant~1_combout\ & (\DUT|Add1~1_sumout\)) # (\DUT|octant~1_combout\ & ((\DUT|Add2~1_sumout\))) ) ) ) # ( !\DUT|x[5]~1_combout\ & ( 
-- !\DUT|Add4~1_sumout\ & ( (\DUT|Add3~1_sumout\ & !\DUT|octant~1_combout\) ) ) )
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_Add3~1_sumout\,
	datac => \DUT|ALT_INV_octant~1_combout\,
	datad => \DUT|ALT_INV_Add2~1_sumout\,
...
-- Equation(s):
-- \DUT|vga_u0|writeEn~0_combout\ = ( \DUT|x\(7) & ( (!\DUT|x\(6) & (!\DUT|x\(5) & \DUT|plot~q\)) ) ) # ( !\DUT|x\(7) & ( \DUT|plot~q\ ) )
...
-- Equation(s):
-- \DUT|Mux12~0_combout\ = ( \DUT|octant~1_combout\ & ( \DUT|Add5~17_sumout\ & ( (!\DUT|octant~0_combout\ & ((\DUT|Add6~17_sumout\))) # (\DUT|octant~0_combout\ & (\DUT|Add8~17_sumout\)) ) ) ) # ( !\DUT|octant~1_combout\ & ( \DUT|Add5~17_sumout\ & ( 
-- (!\DUT|octant~0_combout\) # (\DUT|Add7~17_sumout\) ) ) ) # ( \DUT|octant~1_combout\ & ( !\DUT|Add5~17_sumout\ & ( (!\DUT|octant~0_combout\ & ((\DUT|Add6~17_sumout\))) # (\DUT|octant~0_combout\ & (\DUT|Add8~17_sumout\)) ) ) ) # ( !\DUT|octant~1_combout\ & 
-- ( !\DUT|Add5~17_sumout\ & ( (\DUT|octant~0_combout\ & \DUT|Add7~17_sumout\) ) ) )
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_Add7~17_sumout\,
	datac => \DUT|ALT_INV_Add8~17_sumout\,
	datad => \DUT|ALT_INV_Add6~17_sumout\,
	datae => \DUT|ALT_INV_octant~1_combout\,
	dataf => \DUT|ALT_INV_Add5~17_sumout\,
...
-- Equation(s):
-- \rtl~1_combout\ = ( \DUT|offset_x~1_combout\ & ( \DUT|Add7~25_sumout\ & ( (!\DUT|octant~1_combout\ & (((\DUT|offset_y~2_combout\) # (\DUT|octant~0_combout\)))) # (\DUT|octant~1_combout\ & (((!\DUT|octant~0_combout\)) # (\DUT|Add8~25_sumout\))) ) ) ) # ( 
-- !\DUT|offset_x~1_combout\ & ( \DUT|Add7~25_sumout\ & ( (!\DUT|octant~1_combout\ & (((\DUT|offset_y~2_combout\) # (\DUT|octant~0_combout\)))) # (\DUT|octant~1_combout\ & (\DUT|Add8~25_sumout\ & (\DUT|octant~0_combout\))) ) ) ) # ( \DUT|offset_x~1_combout\ 
-- & ( !\DUT|Add7~25_sumout\ & ( (!\DUT|octant~1_combout\ & (((!\DUT|octant~0_combout\ & \DUT|offset_y~2_combout\)))) # (\DUT|octant~1_combout\ & (((!\DUT|octant~0_combout\)) # (\DUT|Add8~25_sumout\))) ) ) ) # ( !\DUT|offset_x~1_combout\ & ( 
-- !\DUT|Add7~25_sumout\ & ( (!\DUT|octant~1_combout\ & (((!\DUT|octant~0_combout\ & \DUT|offset_y~2_combout\)))) # (\DUT|octant~1_combout\ & (\DUT|Add8~25_sumout\ & (\DUT|octant~0_combout\))) ) ) )
...
PORT MAP (
	...
	datac => \DUT|ALT_INV_octant~0_combout\,
	datad => \DUT|ALT_INV_offset_y~2_combout\,
...
-- \DUT|offset_y~1_combout\ & ( (!\DUT|octant~0_combout\ & (((!\DUT|octant~1_combout\) # (\DUT|offset_x~0_combout\)))) # (\DUT|octant~0_combout\ & (\DUT|Add8~21_sumout\ & (\DUT|octant~1_combout\))) ) ) ) # ( \DUT|Add7~21_sumout\ & ( !\DUT|offset_y~1_combout\ 
...
PORT MAP (
	dataa => \DUT|ALT_INV_octant~0_combout\,
	datab => \DUT|ALT_INV_Add8~21_sumout\,
	datac => \DUT|ALT_INV_octant~1_combout\,
	datad => \DUT|ALT_INV_offset_x~0_combout\,
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|x[5]~DUPLICATE_q\);

-- Location: LABCELL_X31_Y80_N30
\DUT|vga_u0|user_input_translator|Add1~9\ : cyclonev_lcell_comb
-- Equation(s):
-- \DUT|vga_u0|user_input_translator|Add1~9_sumout\ = SUM(( !\DUT|y\(0) $ (!\DUT|x[5]~DUPLICATE_q\) ) + ( !VCC ) + ( !VCC ))
-- \DUT|vga_u0|user_input_translator|Add1~10\ = CARRY(( !\DUT|y\(0) $ (!\DUT|x[5]~DUPLICATE_q\) ) + ( !VCC ) + ( !VCC ))
-- \DUT|vga_u0|user_input_translator|Add1~11\ = SHARE((\DUT|y\(0) & \DUT|x[5]~DUPLICATE_q\))
...
PORT MAP (
	...
	datac => \DUT|ALT_INV_x[5]~DUPLICATE_q\,
	cin => GND,
	sharein => GND,
...
-- Equation(s):
-- \DUT|vga_u0|user_input_translator|Add1~13_sumout\ = SUM(( !\DUT|x\(6) $ (!\DUT|y\(1)) ) + ( \DUT|vga_u0|user_input_translator|Add1~11\ ) + ( \DUT|vga_u0|user_input_translator|Add1~10\ ))
-- \DUT|vga_u0|user_input_translator|Add1~14\ = CARRY(( !\DUT|x\(6) $ (!\DUT|y\(1)) ) + ( \DUT|vga_u0|user_input_translator|Add1~11\ ) + ( \DUT|vga_u0|user_input_translator|Add1~10\ ))
-- \DUT|vga_u0|user_input_translator|Add1~15\ = SHARE((\DUT|x\(6) & \DUT|y\(1)))
...
-- Equation(s):
-- \DUT|vga_u0|user_input_translator|Add1~17_sumout\ = SUM(( !\DUT|y\(2) $ (!\DUT|y\(0) $ (\DUT|x\(7))) ) + ( \DUT|vga_u0|user_input_translator|Add1~15\ ) + ( \DUT|vga_u0|user_input_translator|Add1~14\ ))
-- \DUT|vga_u0|user_input_translator|Add1~18\ = CARRY(( !\DUT|y\(2) $ (!\DUT|y\(0) $ (\DUT|x\(7))) ) + ( \DUT|vga_u0|user_input_translator|Add1~15\ ) + ( \DUT|vga_u0|user_input_translator|Add1~14\ ))
-- \DUT|vga_u0|user_input_translator|Add1~19\ = SHARE((!\DUT|y\(2) & (\DUT|y\(0) & \DUT|x\(7))) # (\DUT|y\(2) & ((\DUT|x\(7)) # (\DUT|y\(0)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_y\(2),
	datab => \DUT|ALT_INV_y\(0),
	datac => \DUT|ALT_INV_x\(7),
...
-- Equation(s):
-- \DUT|vga_u0|user_input_translator|Add1~25_sumout\ = SUM(( !\DUT|y\(4) $ (!\DUT|y\(2)) ) + ( \DUT|vga_u0|user_input_translator|Add1~23\ ) + ( \DUT|vga_u0|user_input_translator|Add1~22\ ))
-- \DUT|vga_u0|user_input_translator|Add1~26\ = CARRY(( !\DUT|y\(4) $ (!\DUT|y\(2)) ) + ( \DUT|vga_u0|user_input_translator|Add1~23\ ) + ( \DUT|vga_u0|user_input_translator|Add1~22\ ))
-- \DUT|vga_u0|user_input_translator|Add1~27\ = SHARE((\DUT|y\(4) & \DUT|y\(2)))
...
-- Equation(s):
-- \DUT|vga_u0|VideoMemory|auto_generated|decode2|w_anode105w\(2) = ( !\DUT|vga_u0|user_input_translator|Add1~1_sumout\ & ( (!\DUT|vga_u0|LessThan3~0_combout\ & (\DUT|vga_u0|writeEn~0_combout\ & !\DUT|vga_u0|user_input_translator|Add1~5_sumout\)) ) )
...
PORT MAP (
	...
	datab => \DUT|vga_u0|ALT_INV_writeEn~0_combout\,
	datac => \DUT|vga_u0|user_input_translator|ALT_INV_Add1~5_sumout\,
	dataf => \DUT|vga_u0|user_input_translator|ALT_INV_Add1~1_sumout\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|Equal0~0_combout\ = ( \DUT|vga_u0|controller|xCounter\(3) & ( (\DUT|vga_u0|controller|xCounter\(8) & (\DUT|vga_u0|controller|xCounter\(9) & (\DUT|vga_u0|controller|xCounter\(2) & \DUT|vga_u0|controller|xCounter\(4)))) ) )
...
-- Equation(s):
-- \DUT|vga_u0|controller|Equal0~2_combout\ = ( !\DUT|vga_u0|controller|xCounter\(7) & ( (\DUT|vga_u0|controller|Equal0~0_combout\ & \DUT|vga_u0|controller|Equal0~1_combout\) ) )
...
PORT MAP (
	...
	datad => \DUT|vga_u0|controller|ALT_INV_Equal0~1_combout\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|always1~1_combout\ = ( !\DUT|vga_u0|controller|yCounter\(4) & ( (!\DUT|vga_u0|controller|yCounter\(0) & (\DUT|vga_u0|controller|yCounter\(3) & (!\DUT|vga_u0|controller|yCounter\(1) & \DUT|vga_u0|controller|yCounter\(2)))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|vga_u0|controller|ALT_INV_yCounter\(0),
...
\DUT|vga_u0|controller|yCounter[5]~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|vga_u0|controller|yCounter[5]~DUPLICATE_q\);
...
-- Equation(s):
-- \DUT|vga_u0|controller|always1~0_combout\ = ( !\DUT|vga_u0|controller|yCounter\(6) & ( (\DUT|vga_u0|controller|yCounter\(9) & (!\DUT|vga_u0|controller|yCounter[5]~DUPLICATE_q\ & (!\DUT|vga_u0|controller|yCounter[7]~DUPLICATE_q\ & 
-- !\DUT|vga_u0|controller|yCounter\(8)))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|vga_u0|controller|ALT_INV_yCounter\(9),
	datab => \DUT|vga_u0|controller|ALT_INV_yCounter[5]~DUPLICATE_q\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|always1~2_combout\ = ( \DUT|vga_u0|controller|Equal0~1_combout\ & ( (!\DUT|vga_u0|controller|xCounter\(7) & (\DUT|vga_u0|controller|Equal0~0_combout\ & (\DUT|vga_u0|controller|always1~1_combout\ & 
...
PORT MAP (
	...
	datab => \DUT|vga_u0|controller|ALT_INV_Equal0~0_combout\,
	datac => \DUT|vga_u0|controller|ALT_INV_always1~1_combout\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|controller_translator|Add1~13_sumout\ = SUM(( !\DUT|vga_u0|controller|yCounter\(3) $ (!\DUT|vga_u0|controller|xCounter\(8)) ) + ( \DUT|vga_u0|controller|controller_translator|Add1~11\ ) + ( 
-- \DUT|vga_u0|controller|controller_translator|Add1~10\ ))
-- \DUT|vga_u0|controller|controller_translator|Add1~14\ = CARRY(( !\DUT|vga_u0|controller|yCounter\(3) $ (!\DUT|vga_u0|controller|xCounter\(8)) ) + ( \DUT|vga_u0|controller|controller_translator|Add1~11\ ) + ( 
-- \DUT|vga_u0|controller|controller_translator|Add1~10\ ))
-- \DUT|vga_u0|controller|controller_translator|Add1~15\ = SHARE((\DUT|vga_u0|controller|yCounter\(3) & \DUT|vga_u0|controller|xCounter\(8)))
...
PORT MAP (
	...
	datac => \DUT|vga_u0|controller|ALT_INV_xCounter\(8),
...
-- Equation(s):
-- \DUT|vga_u0|controller|controller_translator|Add1~29_sumout\ = SUM(( !\DUT|vga_u0|controller|yCounter[7]~DUPLICATE_q\ $ (!\DUT|vga_u0|controller|yCounter\(5)) ) + ( \DUT|vga_u0|controller|controller_translator|Add1~27\ ) + ( 
-- \DUT|vga_u0|controller|controller_translator|Add1~26\ ))
-- \DUT|vga_u0|controller|controller_translator|Add1~30\ = CARRY(( !\DUT|vga_u0|controller|yCounter[7]~DUPLICATE_q\ $ (!\DUT|vga_u0|controller|yCounter\(5)) ) + ( \DUT|vga_u0|controller|controller_translator|Add1~27\ ) + ( 
-- \DUT|vga_u0|controller|controller_translator|Add1~26\ ))
-- \DUT|vga_u0|controller|controller_translator|Add1~31\ = SHARE((\DUT|vga_u0|controller|yCounter[7]~DUPLICATE_q\ & \DUT|vga_u0|controller|yCounter\(5)))
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|vga_u0|controller|ALT_INV_yCounter[7]~DUPLICATE_q\,
	datad => \DUT|vga_u0|controller|ALT_INV_yCounter\(5),
...
-- Equation(s):
-- \DUT|vga_u0|controller|controller_translator|Add1~33_sumout\ = SUM(( !\DUT|vga_u0|controller|yCounter\(8) $ (!\DUT|vga_u0|controller|yCounter\(6)) ) + ( \DUT|vga_u0|controller|controller_translator|Add1~31\ ) + ( 
-- \DUT|vga_u0|controller|controller_translator|Add1~30\ ))
-- \DUT|vga_u0|controller|controller_translator|Add1~34\ = CARRY(( !\DUT|vga_u0|controller|yCounter\(8) $ (!\DUT|vga_u0|controller|yCounter\(6)) ) + ( \DUT|vga_u0|controller|controller_translator|Add1~31\ ) + ( 
-- \DUT|vga_u0|controller|controller_translator|Add1~30\ ))
-- \DUT|vga_u0|controller|controller_translator|Add1~35\ = SHARE((\DUT|vga_u0|controller|yCounter\(8) & \DUT|vga_u0|controller|yCounter\(6)))
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|vga_u0|controller|controller_translator|ALT_INV_Add1~5_sumout\,
...
-- Equation(s):
-- \DUT|Mux7~0_combout\ = ( \DUT|offset_y~1_combout\ & ( \DUT|octant~1_combout\ & ( (!\DUT|x[5]~1_combout\) # (\DUT|Add2~13_sumout\) ) ) ) # ( !\DUT|offset_y~1_combout\ & ( \DUT|octant~1_combout\ & ( (\DUT|x[5]~1_combout\ & \DUT|Add2~13_sumout\) ) ) ) # ( 
-- \DUT|offset_y~1_combout\ & ( !\DUT|octant~1_combout\ & ( (!\DUT|x[5]~1_combout\ & ((\DUT|offset_x~0_combout\))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~13_sumout\)) ) ) ) # ( !\DUT|offset_y~1_combout\ & ( !\DUT|octant~1_combout\ & ( (!\DUT|x[5]~1_combout\ & 
-- ((\DUT|offset_x~0_combout\))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~13_sumout\)) ) ) )
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_x[5]~1_combout\,
	datac => \DUT|ALT_INV_Add2~13_sumout\,
	datad => \DUT|ALT_INV_offset_x~0_combout\,
	datae => \DUT|ALT_INV_offset_y~1_combout\,
	dataf => \DUT|ALT_INV_octant~1_combout\,
	combout => \DUT|Mux7~0_combout\);

-- Location: FF_X31_Y78_N55
\DUT|x[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Equation(s):
-- \DUT|Mux6~0_combout\ = ( \DUT|offset_y~2_combout\ & ( \DUT|octant~1_combout\ & ( (!\DUT|x[5]~1_combout\) # (\DUT|Add2~17_sumout\) ) ) ) # ( !\DUT|offset_y~2_combout\ & ( \DUT|octant~1_combout\ & ( (\DUT|x[5]~1_combout\ & \DUT|Add2~17_sumout\) ) ) ) # ( 
-- \DUT|offset_y~2_combout\ & ( !\DUT|octant~1_combout\ & ( (!\DUT|x[5]~1_combout\ & ((\DUT|offset_x~1_combout\))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~17_sumout\)) ) ) ) # ( !\DUT|offset_y~2_combout\ & ( !\DUT|octant~1_combout\ & ( (!\DUT|x[5]~1_combout\ & 
-- ((\DUT|offset_x~1_combout\))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~17_sumout\)) ) ) )
...
PORT MAP (
	...
	datab => \DUT|ALT_INV_offset_x~1_combout\,
	datac => \DUT|ALT_INV_x[5]~1_combout\,
	datad => \DUT|ALT_INV_Add2~17_sumout\,
...
-- Equation(s):
-- \DUT|Mux5~0_combout\ = ( \DUT|offset_y~3_combout\ & ( \DUT|octant~1_combout\ & ( (!\DUT|x[5]~1_combout\) # (\DUT|Add2~21_sumout\) ) ) ) # ( !\DUT|offset_y~3_combout\ & ( \DUT|octant~1_combout\ & ( (\DUT|x[5]~1_combout\ & \DUT|Add2~21_sumout\) ) ) ) # ( 
-- \DUT|offset_y~3_combout\ & ( !\DUT|octant~1_combout\ & ( (!\DUT|x[5]~1_combout\ & ((\DUT|offset_x~2_combout\))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~21_sumout\)) ) ) ) # ( !\DUT|offset_y~3_combout\ & ( !\DUT|octant~1_combout\ & ( (!\DUT|x[5]~1_combout\ & 
-- ((\DUT|offset_x~2_combout\))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~21_sumout\)) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|ALT_INV_Add1~21_sumout\,
	datab => \DUT|ALT_INV_x[5]~1_combout\,
	datac => \DUT|ALT_INV_offset_x~2_combout\,
	datad => \DUT|ALT_INV_Add2~21_sumout\,
...
-- Equation(s):
-- \DUT|Mux4~0_combout\ = ( \DUT|offset_x~3_combout\ & ( \DUT|offset_y~4_combout\ & ( (!\DUT|x[5]~1_combout\) # ((!\DUT|octant~1_combout\ & (\DUT|Add1~25_sumout\)) # (\DUT|octant~1_combout\ & ((\DUT|Add2~25_sumout\)))) ) ) ) # ( !\DUT|offset_x~3_combout\ & ( 
-- \DUT|offset_y~4_combout\ & ( (!\DUT|octant~1_combout\ & (\DUT|x[5]~1_combout\ & (\DUT|Add1~25_sumout\))) # (\DUT|octant~1_combout\ & ((!\DUT|x[5]~1_combout\) # ((\DUT|Add2~25_sumout\)))) ) ) ) # ( \DUT|offset_x~3_combout\ & ( !\DUT|offset_y~4_combout\ & ( 
-- (!\DUT|octant~1_combout\ & ((!\DUT|x[5]~1_combout\) # ((\DUT|Add1~25_sumout\)))) # (\DUT|octant~1_combout\ & (\DUT|x[5]~1_combout\ & ((\DUT|Add2~25_sumout\)))) ) ) ) # ( !\DUT|offset_x~3_combout\ & ( !\DUT|offset_y~4_combout\ & ( (\DUT|x[5]~1_combout\ & 
-- ((!\DUT|octant~1_combout\ & (\DUT|Add1~25_sumout\)) # (\DUT|octant~1_combout\ & ((\DUT|Add2~25_sumout\))))) ) ) )
...
PORT MAP (
	dataa => \DUT|ALT_INV_octant~1_combout\,
	datab => \DUT|ALT_INV_x[5]~1_combout\,
	datac => \DUT|ALT_INV_Add1~25_sumout\,
...
-- Equation(s):
-- \DUT|Mux3~0_combout\ = ( \DUT|Add3~13_sumout\ & ( \DUT|Add2~29_sumout\ & ( (!\DUT|x[5]~1_combout\ & (((!\DUT|octant~1_combout\) # (\DUT|Add4~13_sumout\)))) # (\DUT|x[5]~1_combout\ & (((\DUT|octant~1_combout\)) # (\DUT|Add1~29_sumout\))) ) ) ) # ( 
-- !\DUT|Add3~13_sumout\ & ( \DUT|Add2~29_sumout\ & ( (!\DUT|x[5]~1_combout\ & (((\DUT|Add4~13_sumout\ & \DUT|octant~1_combout\)))) # (\DUT|x[5]~1_combout\ & (((\DUT|octant~1_combout\)) # (\DUT|Add1~29_sumout\))) ) ) ) # ( \DUT|Add3~13_sumout\ & ( 
-- !\DUT|Add2~29_sumout\ & ( (!\DUT|x[5]~1_combout\ & (((!\DUT|octant~1_combout\) # (\DUT|Add4~13_sumout\)))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~29_sumout\ & ((!\DUT|octant~1_combout\)))) ) ) ) # ( !\DUT|Add3~13_sumout\ & ( !\DUT|Add2~29_sumout\ & ( 
-- (!\DUT|x[5]~1_combout\ & (((\DUT|Add4~13_sumout\ & \DUT|octant~1_combout\)))) # (\DUT|x[5]~1_combout\ & (\DUT|Add1~29_sumout\ & ((!\DUT|octant~1_combout\)))) ) ) )
...
\DUT|vga_u0|controller|xCounter[6]~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|vga_u0|controller|xCounter[6]~DUPLICATE_q\);
...
-- Equation(s):
-- \DUT|vga_u0|controller|LessThan7~0_combout\ = ( \DUT|vga_u0|controller|yCounter\(6) & ( (!\DUT|vga_u0|controller|yCounter\(9) & ((!\DUT|vga_u0|controller|yCounter[5]~DUPLICATE_q\) # ((!\DUT|vga_u0|controller|yCounter\(7)) # 
-- (!\DUT|vga_u0|controller|yCounter\(8))))) ) ) # ( !\DUT|vga_u0|controller|yCounter\(6) & ( !\DUT|vga_u0|controller|yCounter\(9) ) )
...
-- Equation(s):
-- \DUT|vga_u0|controller|on_screen~1_combout\ = ( \DUT|vga_u0|controller|xCounter\(7) & ( (\DUT|vga_u0|controller|LessThan7~0_combout\ & ((!\DUT|vga_u0|controller|xCounter\(9)) # ((!\DUT|vga_u0|controller|xCounter\(8) & 
-- \DUT|vga_u0|controller|on_screen~0_combout\)))) ) ) # ( !\DUT|vga_u0|controller|xCounter\(7) & ( (\DUT|vga_u0|controller|LessThan7~0_combout\ & ((!\DUT|vga_u0|controller|xCounter\(8)) # (!\DUT|vga_u0|controller|xCounter\(9)))) ) )
...
-- Equation(s):
-- \DUT|vga_u0|VideoMemory|auto_generated|decode2|w_anode118w\(2) = ( !\DUT|vga_u0|user_input_translator|Add1~1_sumout\ & ( (\DUT|vga_u0|writeEn~0_combout\ & (!\DUT|vga_u0|LessThan3~0_combout\ & \DUT|vga_u0|user_input_translator|Add1~5_sumout\)) ) )
...
-- Equation(s):
-- \DUT|vga_u0|VideoMemory|auto_generated|decode2|w_anode126w\(2) = (!\DUT|vga_u0|user_input_translator|Add1~5_sumout\ & (\DUT|vga_u0|writeEn~0_combout\ & (\DUT|vga_u0|user_input_translator|Add1~1_sumout\ & !\DUT|vga_u0|LessThan3~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|vga_u0|user_input_translator|ALT_INV_Add1~5_sumout\,
	datab => \DUT|vga_u0|ALT_INV_writeEn~0_combout\,
	datac => \DUT|vga_u0|user_input_translator|ALT_INV_Add1~1_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \DUT|vga_u0|controller|controller_translator|ALT_INV_Add1~5_sumout\,
	dataf => \DUT|vga_u0|controller|controller_translator|ALT_INV_Add1~1_sumout\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|VGA_R[0]~0_combout\ = ( \DUT|vga_u0|VideoMemory|auto_generated|ram_block1a5~portbdataout\ & ( \DUT|vga_u0|VideoMemory|auto_generated|ram_block1a8\ & ( (\DUT|vga_u0|controller|on_screen~1_combout\ & 
-- (((\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1)) # (\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0))) # (\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a2~portbdataout\))) ) ) ) # ( 
-- !\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a5~portbdataout\ & ( \DUT|vga_u0|VideoMemory|auto_generated|ram_block1a8\ & ( (\DUT|vga_u0|controller|on_screen~1_combout\ & (((\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a2~portbdataout\ & 
-- !\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0))) # (\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1)))) ) ) ) # ( \DUT|vga_u0|VideoMemory|auto_generated|ram_block1a5~portbdataout\ & ( 
...
-- (\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a2~portbdataout\)))) ) ) ) # ( !\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a5~portbdataout\ & ( !\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a8\ & ( 
-- (\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a2~portbdataout\ & (!\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0) & (!\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & \DUT|vga_u0|controller|on_screen~1_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DUT|vga_u0|VideoMemory|auto_generated|ALT_INV_ram_block1a2~portbdataout\,
	datab => \DUT|vga_u0|VideoMemory|auto_generated|ALT_INV_out_address_reg_b\(0),
	datac => \DUT|vga_u0|VideoMemory|auto_generated|ALT_INV_out_address_reg_b\(1),
	datad => \DUT|vga_u0|controller|ALT_INV_on_screen~1_combout\,
...
-- !\DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(1) & ( !\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a1~portbdataout\ & ( (\DUT|vga_u0|controller|on_screen~1_combout\ & (\DUT|vga_u0|VideoMemory|auto_generated|ram_block1a4~portbdataout\ & 
-- \DUT|vga_u0|VideoMemory|auto_generated|out_address_reg_b\(0))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000100000001000000000101010101010001010100010000000001010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DUT|vga_u0|controller|ALT_INV_on_screen~1_combout\,
	datab => \DUT|vga_u0|VideoMemory|auto_generated|ALT_INV_ram_block1a4~portbdataout\,
	datac => \DUT|vga_u0|VideoMemory|auto_generated|ALT_INV_out_address_reg_b\(0),
	datad => \DUT|vga_u0|VideoMemory|auto_generated|ALT_INV_ram_block1a7~portbdataout\,
...
-- Equation(s):
-- \DUT|vga_u0|controller|VGA_HS1~1_combout\ = ( \DUT|vga_u0|controller|xCounter\(9) & ( \DUT|vga_u0|controller|xCounter\(7) & ( ((!\DUT|vga_u0|controller|xCounter\(5) & (!\DUT|vga_u0|controller|VGA_HS1~0_combout\ & 
-- !\DUT|vga_u0|controller|xCounter[6]~DUPLICATE_q\)) # (\DUT|vga_u0|controller|xCounter\(5) & (\DUT|vga_u0|controller|VGA_HS1~0_combout\ & \DUT|vga_u0|controller|xCounter[6]~DUPLICATE_q\))) # (\DUT|vga_u0|controller|xCounter\(8)) ) ) ) # ( 
-- !\DUT|vga_u0|controller|xCounter\(9) & ( \DUT|vga_u0|controller|xCounter\(7) ) ) # ( \DUT|vga_u0|controller|xCounter\(9) & ( !\DUT|vga_u0|controller|xCounter\(7) ) ) # ( !\DUT|vga_u0|controller|xCounter\(9) & ( !\DUT|vga_u0|controller|xCounter\(7) ) )
...
PORT MAP (
	...
	datad => \DUT|vga_u0|controller|ALT_INV_xCounter[6]~DUPLICATE_q\,
...
\DUT|vga_u0|controller|yCounter[0]~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \DUT|vga_u0|controller|yCounter[0]~DUPLICATE_q\);

-- Location: MLABCELL_X34_Y80_N6
\DUT|vga_u0|controller|VGA_VS1~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \DUT|vga_u0|controller|VGA_VS1~0_combout\ = ( \DUT|vga_u0|controller|yCounter\(2) & ( !\DUT|vga_u0|controller|yCounter\(4) & ( (!\DUT|vga_u0|controller|yCounter\(9) & (\DUT|vga_u0|controller|yCounter\(3) & (!\DUT|vga_u0|controller|yCounter[0]~DUPLICATE_q\ 
...
PORT MAP (
	dataa => \DUT|vga_u0|controller|ALT_INV_yCounter\(9),
	datab => \DUT|vga_u0|controller|ALT_INV_yCounter[0]~DUPLICATE_q\,
	datac => \DUT|vga_u0|controller|ALT_INV_yCounter\(1),
	datad => \DUT|vga_u0|controller|ALT_INV_yCounter\(3),
...
-- Equation(s):
-- \DUT|vga_u0|controller|VGA_VS1~1_combout\ = ( \DUT|vga_u0|controller|yCounter\(8) & ( (!\DUT|vga_u0|controller|yCounter\(6)) # ((!\DUT|vga_u0|controller|yCounter[5]~DUPLICATE_q\) # ((!\DUT|vga_u0|controller|VGA_VS1~0_combout\) # 
-- (!\DUT|vga_u0|controller|yCounter\(7)))) ) ) # ( !\DUT|vga_u0|controller|yCounter\(8) )
...
PORT MAP (
	...
	datad => \DUT|vga_u0|controller|ALT_INV_yCounter\(7),
	datae => \DUT|vga_u0|controller|ALT_INV_yCounter\(8),
